...
try {
		Debug.PushSubsStack("B4XPage_Created (b4xpage4) ","b4xpage4",5,__ref.getField(false, "ba"),__ref,14);
...
b4xpage4._navbar1 = RemoteObject.createNew ("b4a.example.navbar");__ref.setField("_navbar1",b4xpage4._navbar1);
 //BA.debugLineNum = 6;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _initialize(RemoteObject __ref,RemoteObject _ba) throws Exception{
try {
		Debug.PushSubsStack("Initialize (b4xpage4) ","b4xpage4",5,__ref.getField(false, "ba"),__ref,9);
