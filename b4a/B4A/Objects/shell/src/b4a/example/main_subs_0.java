...
details.myClass = BA.getDeviceClass ("b4a.example.details");
starter.myClass = BA.getDeviceClass ("b4a.example.starter");
b4xpage2.myClass = BA.getDeviceClass ("b4a.example.b4xpage2");
b4xpage4.myClass = BA.getDeviceClass ("b4a.example.b4xpage4");
navbar.myClass = BA.getDeviceClass ("b4a.example.navbar");
...
bctoast.myClass = BA.getDeviceClass ("b4a.example.bctoast");
bbcodeparser.myClass = BA.getDeviceClass ("b4a.example.bbcodeparser");
bbcodeview.myClass = BA.getDeviceClass ("b4a.example.bbcodeview");
bblabel.myClass = BA.getDeviceClass ("b4a.example.bblabel");
bctextengine.myClass = BA.getDeviceClass ("b4a.example.bctextengine");
