...
public static RemoteObject _bb1 = RemoteObject.declareNull("b4a.example.bblabel");
public static RemoteObject _te = RemoteObject.declareNull("b4a.example.bctextengine");
