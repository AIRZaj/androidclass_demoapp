...
bctoast._bb1 = RemoteObject.createNew ("b4a.example.bblabel");__ref.setField("_bb1",bctoast._bb1);
 //BA.debugLineNum = 6;BA.debugLine="Private te As BCTextEngine";
bctoast._te = RemoteObject.createNew ("b4a.example.bctextengine");__ref.setField("_te",bctoast._te);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_te" /*RemoteObject*/ ).runClassMethod (b4a.example.bctextengine.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_pnl" /*RemoteObject*/ )));
...
public ResumableSub_Show(b4a.example.bctoast parent,RemoteObject __ref,RemoteObject _message) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bb1" /*RemoteObject*/ ).runClassMethod (b4a.example.bblabel.class, "_settext" /*RemoteObject*/ ,_message);
