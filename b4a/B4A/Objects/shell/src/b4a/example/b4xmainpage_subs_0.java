...
try {
		Debug.PushSubsStack("AddClickEvent (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,64);
...
Debug.locals.put("v", _v);
 BA.debugLineNum = 64;BA.debugLine="Private Sub AddClickEvent(v As B4XView)";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 65;BA.debugLine="Dim jo As JavaObject = v";
Debug.ShouldStop(1);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _v.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 66;BA.debugLine="jo.RunMethod(\"setOnClickListener\", Array As Objec";
Debug.ShouldStop(2);
...
RemoteObject _mockperson = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
...
__ref.runClassMethod (b4a.example.b4xmainpage.class, "_fetchdata" /*RemoteObject*/ );
 BA.debugLineNum = 48;BA.debugLine="Dim mockPerson As Map";
Debug.ShouldStop(32768);
_mockperson = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("mockPerson", _mockperson);
 BA.debugLineNum = 49;BA.debugLine="mockPerson.Initialize";
Debug.ShouldStop(65536);
_mockperson.runVoidMethod ("Initialize");
 BA.debugLineNum = 50;BA.debugLine="mockPerson.Put(\"tytul\", \"dr\")";
Debug.ShouldStop(131072);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("tytul"))),(Object)((RemoteObject.createImmutable("dr"))));
 BA.debugLineNum = 51;BA.debugLine="mockPerson.Put(\"imie\", \"Jan\")";
Debug.ShouldStop(262144);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("imie"))),(Object)((RemoteObject.createImmutable("Jan"))));
 BA.debugLineNum = 52;BA.debugLine="mockPerson.Put(\"nazwisko\", \"Kowalski\")";
Debug.ShouldStop(524288);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("nazwisko"))),(Object)((RemoteObject.createImmutable("Kowalski"))));
 BA.debugLineNum = 53;BA.debugLine="mockPerson.Put(\"pokoj\", \"101\")";
Debug.ShouldStop(1048576);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("pokoj"))),(Object)((RemoteObject.createImmutable("101"))));
 BA.debugLineNum = 54;BA.debugLine="mockPerson.Put(\"zaklad\", \"Zakład Testowy\")";
Debug.ShouldStop(2097152);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("zaklad"))),(Object)((RemoteObject.createImmutable("Zakład Testowy"))));
 BA.debugLineNum = 55;BA.debugLine="mockPerson.Put(\"numer_telefonu\", \"123-456-789\")";
Debug.ShouldStop(4194304);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("numer_telefonu"))),(Object)((RemoteObject.createImmutable("123-456-789"))));
 BA.debugLineNum = 56;BA.debugLine="mockPerson.Put(\"mail\", \"jankowalski@amu.edu.pl\")";
Debug.ShouldStop(8388608);
_mockperson.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("mail"))),(Object)((RemoteObject.createImmutable("jankowalski@amu.edu.pl"))));
 BA.debugLineNum = 58;BA.debugLine="B4XPages.ShowPage(\"Details\")";
Debug.ShouldStop(33554432);
b4xmainpage._b4xpages.runVoidMethod ("_showpage" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("Details")));
 BA.debugLineNum = 59;BA.debugLine="B4XPages.GetPage(\"Details\").As(details).LoadPerso";
Debug.ShouldStop(67108864);
((b4xmainpage._b4xpages.runMethod(false,"_getpage" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("Details"))))).runClassMethod (b4a.example.details.class, "_loadperson" /*RemoteObject*/ ,(Object)(_mockperson));
...
try {
		Debug.PushSubsStack("card_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,149);
...
RemoteObject _persondata = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 149;BA.debugLine="Sub card_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="Dim clickedPanel As Panel = Sender";
Debug.ShouldStop(2097152);
...
_clickedpanel = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), b4xmainpage.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("clickedPanel", _clickedpanel);Debug.locals.put("clickedPanel", _clickedpanel);
 BA.debugLineNum = 151;BA.debugLine="Dim personData As Map = clickedPanel.Tag";
Debug.ShouldStop(4194304);
...
_persondata = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _clickedpanel.runMethod(false,"getTag"));Debug.locals.put("personData", _persondata);Debug.locals.put("personData", _persondata);
 BA.debugLineNum = 152;BA.debugLine="B4XPages.ShowPage(\"Details\")";
Debug.ShouldStop(8388608);
b4xmainpage._b4xpages.runVoidMethod ("_showpage" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("Details")));
 BA.debugLineNum = 153;BA.debugLine="B4XPages.GetPage(\"Details\").As(details).LoadPerso";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("CreateCard (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,157);
...
Debug.locals.put("idx", _idx);
 BA.debugLineNum = 157;BA.debugLine="Private Sub CreateCard(item As Map, idx As Int) As";
...
_pnl = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("pnl", _pnl);Debug.locals.put("pnl", _pnl);
 BA.debugLineNum = 159;BA.debugLine="pnl.Color = xui.Color_White";
Debug.ShouldStop(1073741824);
_pnl.runMethod(true,"setColor",__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White"));
 BA.debugLineNum = 160;BA.debugLine="pnl.Tag = idx";
Debug.ShouldStop(-2147483648);
_pnl.runMethod(false,"setTag",(_idx));
 BA.debugLineNum = 161;BA.debugLine="AddClickEvent(pnl)";
Debug.ShouldStop(1);
__ref.runClassMethod (b4a.example.b4xmainpage.class, "_addclickevent" /*RemoteObject*/ ,(Object)(_pnl));
 BA.debugLineNum = 163;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(4);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 164;BA.debugLine="cd.Initialize(xui.Color_White, 10dip)";
Debug.ShouldStop(8);
_cd.runVoidMethod ("Initialize",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_White")),(Object)(b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))));
 BA.debugLineNum = 166;BA.debugLine="pnl.SetColorAndBorder(Colors.Black, 0, 0, 10dip)";
Debug.ShouldStop(32);
...
_lbl2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Pokój: "),_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("pokoj")))),RemoteObject.createImmutable(" | Zakład: "),_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("zaklad")))))));
 BA.debugLineNum = 179;BA.debugLine="lbl2.TextSize = 14";
Debug.ShouldStop(262144);
_lbl2.runMethod(true,"setTextSize",BA.numberCast(float.class, 14));
 BA.debugLineNum = 180;BA.debugLine="lbl2.TextColor = Colors.Gray";
Debug.ShouldStop(524288);
_lbl2.runMethod(true,"setTextColor",b4xmainpage.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 181;BA.debugLine="pnl.AddView(lbl2, 10dip, 45dip, 80%x, 20dip)";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("FetchData (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,81);
if (RapidSub.canDelegate("fetchdata")) { return __ref.runUserSub(false, "b4xmainpage","fetchdata", __ref);}
 BA.debugLineNum = 81;BA.debugLine="Sub FetchData";
Debug.ShouldStop(65536);
 BA.debugLineNum = 82;BA.debugLine="xHttp.Initialize(\"Job1\", Me)";
Debug.ShouldStop(131072);
__ref.getField(false,"_xhttp" /*RemoteObject*/ ).runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Job1")),(Object)(__ref));
 BA.debugLineNum = 83;BA.debugLine="xHttp.Download(\"https://grupa2.android.mzelent.pl";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("HandleClick (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,69);
...
Debug.locals.put("ViewTag", _viewtag);
 BA.debugLineNum = 69;BA.debugLine="Sub HandleClick (ViewTag As Object)";
Debug.ShouldStop(16);
 BA.debugLineNum = 70;BA.debugLine="If ViewTag = \"update\" Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",_viewtag,RemoteObject.createImmutable(("update")))) { 
 BA.debugLineNum = 71;BA.debugLine="FetchData";
Debug.ShouldStop(64);
__ref.runClassMethod (b4a.example.b4xmainpage.class, "_fetchdata" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 74;BA.debugLine="Dim idx As Int = ViewTag";
Debug.ShouldStop(512);
_idx = BA.numberCast(int.class, _viewtag);Debug.locals.put("idx", _idx);Debug.locals.put("idx", _idx);
 BA.debugLineNum = 75;BA.debugLine="Dim person As Map = personsList.Get(idx)";
Debug.ShouldStop(1024);
...
_person = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), __ref.getField(false,"_personslist" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(_idx)));Debug.locals.put("person", _person);Debug.locals.put("person", _person);
 BA.debugLineNum = 76;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"Details";
Debug.ShouldStop(2048);
b4xmainpage._b4xpages.runVoidMethod ("_showpageandremovepreviouspages" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("DetailsPage")));
 BA.debugLineNum = 77;BA.debugLine="B4XPages.GetPage(\"Details\").As(details).LoadPers";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("JobDone (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,86);
...
if (_job.getField(true,"_success" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 88;BA.debugLine="ParseJSON(Job.GetString)";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4a.example.b4xmainpage.class, "_parsejson" /*RemoteObject*/ ,(Object)(_job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 90;BA.debugLine="xui.MsgboxAsync(\"Błąd: \" & Job.ErrorMessage, \"Bł";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("ParseJSON (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,95);
...
__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(false,"getPanel").runMethod(true,"setHeight",RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_personslist" /*RemoteObject*/ ).runMethod(true,"getSize"),b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 130)))}, "*",0, 1));
 BA.debugLineNum = 103;BA.debugLine="For i = 0 To personsList.Size - 1";
Debug.ShouldStop(64);
{
final int step7 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 104;BA.debugLine="Dim item As Map = personsList.Get(i)";
Debug.ShouldStop(128);
...
_lblphone.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("📞 "),_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("numer_telefonu")))))));
 BA.debugLineNum = 132;BA.debugLine="lblPhone.TextSize = 14";
Debug.ShouldStop(8);
_lblphone.runMethod(true,"setTextSize",BA.numberCast(float.class, 14));
 BA.debugLineNum = 133;BA.debugLine="lblPhone.TextColor = Colors.Blue";
Debug.ShouldStop(16);
_lblphone.runMethod(true,"setTextColor",b4xmainpage.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 134;BA.debugLine="lblPhone.Tag = item.Get(\"numer_telefonu\")";
Debug.ShouldStop(32);
_lblphone.runMethod(false,"setTag",_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("numer_telefonu")))));
 BA.debugLineNum = 135;BA.debugLine="card.AddView(lblPhone, 10dip, 70dip, 80%x, 20di";
Debug.ShouldStop(64);
_card.runVoidMethod ("AddView",(Object)((_lblphone.getObject())),(Object)(b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 70)))),(Object)(b4xmainpage.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 80)),__ref.getField(false, "ba"))),(Object)(b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))));
 BA.debugLineNum = 138;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(512);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 139;BA.debugLine="cd.Initialize(Colors.White, 10dip)";
Debug.ShouldStop(1024);
_cd.runVoidMethod ("Initialize",(Object)(b4xmainpage.__c.getField(false,"Colors").getField(true,"White")),(Object)(b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))));
 BA.debugLineNum = 140;BA.debugLine="card.Background = cd";
Debug.ShouldStop(2048);
_card.runMethod(false,"setBackground",(_cd.getObject()));
 BA.debugLineNum = 141;BA.debugLine="card.Elevation = 5dip";
Debug.ShouldStop(4096);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e40.toString()); BA.debugLineNum = 144;BA.debugLine="xui.MsgboxAsync(\"Błąd przetwarzania JSON!\", \"Błą";
Debug.ShouldStop(32768);
