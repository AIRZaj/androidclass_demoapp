...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","911010051",_s,bbcodeparser.__c.getField(false,"Colors").getField(true,"Red"));
...
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _j.runClassMethod (b4a.example.httpjob.class, "_getbitmap" /*RemoteObject*/ ).getObject());Debug.locals.put("bmp", _bmp);
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","911272253",RemoteObject.concat(RemoteObject.createImmutable("Font missing from TextEngine.CustomFonts: "),_name),0);
 }else {
