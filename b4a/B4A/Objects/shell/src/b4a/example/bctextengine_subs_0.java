...
bctextengine._arabicnonlinkedletters = RemoteObject.createNew ("b4a.example.b4xset");__ref.setField("_arabicnonlinkedletters",bctextengine._arabicnonlinkedletters);
 //BA.debugLineNum = 68;BA.debugLine="Private ArabicCharsConnectedPrev As B4XSet";
bctextengine._arabiccharsconnectedprev = RemoteObject.createNew ("b4a.example.b4xset");__ref.setField("_arabiccharsconnectedprev",bctextengine._arabiccharsconnectedprev);
...
__ref.runClassMethod (b4a.example.bctextengine.class, "_loadarabicdata" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.bctextengine.class, "_preprocessarabic" /*RemoteObject*/ ,(Object)(_chars),(Object)(_i));
 };
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.example.bctextengine.class, "_recoloredgesofconnectedcharacters" /*RemoteObject*/ ,(Object)(_c),(Object)(_r2));};
...
Debug.JustUpdateDeviceLine();
_unbreakable.setField ("Anchor" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.bctextengine.class, "_getrunanchorifcurrentnotset" /*RemoteObject*/ ,(Object)(_run),(Object)(RemoteObject.createImmutable(""))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(_par.getField(true,"Width" /*RemoteObject*/ )),(Object)(_par.getField(true,"Height" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1129;BA.debugLine="ArabicCharsConnectedPrev.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))));
 }else {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(((BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))))))));
 };
 };
 }
}Debug.locals.put("line", _line);
...
Debug.JustUpdateDeviceLine();
_un1.setField ("Anchor" /*RemoteObject*/ ,__ref.runClassMethod (b4a.example.bctextengine.class, "_getrunanchorifcurrentnotset" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )),(Object)(_un1.getField(true,"Anchor" /*RemoteObject*/ ))));
 }
}Debug.locals.put("single", _single);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(_par.getField(true,"Width" /*RemoteObject*/ )),(Object)(_maxheight));
...
RemoteObject _arabicchars = RemoteObject.declareNull("b4a.example.b4xbitset");
RemoteObject _arabicnonlinked = RemoteObject.declareNull("b4a.example.b4xbitset");
...
Debug.JustUpdateDeviceLine();
_arabicchars = RemoteObject.createNew ("b4a.example.b4xbitset");Debug.locals.put("ArabicChars", _arabicchars);
_arabicnonlinked = RemoteObject.createNew ("b4a.example.b4xbitset");Debug.locals.put("ArabicNonLinked", _arabicnonlinked);
...
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4a.example.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 BA.debugLineNum = 1161;BA.debugLine="ArabicNonLinked.Initialize(Length)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4a.example.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 };
 BA.debugLineNum = 1163;BA.debugLine="ArabicChars.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4a.example.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 BA.debugLineNum = 1164;BA.debugLine="If ArabicNonLinkedLetters.Contains(chars(i)) Th";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1165;BA.debugLine="ArabicNonLinked.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4a.example.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 };
 };
 }
}Debug.locals.put("i", _i);
...
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i)))));};
 };
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
bctextengine.__c.runVoidMethod ("LogImpl","917956870",_sb.runMethod(true,"ToString"),0);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.example.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_c))).<Boolean>get().booleanValue()) { 
