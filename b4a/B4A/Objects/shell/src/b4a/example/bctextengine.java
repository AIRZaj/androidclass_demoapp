...
public static RemoteObject _arabicnonlinkedletters = RemoteObject.declareNull("b4a.example.b4xset");
public static RemoteObject _arabiccharsconnectedprev = RemoteObject.declareNull("b4a.example.b4xset");
