...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xpages");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("b4xpages"), "b4a.B4APagesNavBar.b4xpages");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.B4APagesNavBar.b4xpages"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static RemoteObject _delegate = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xpagesdelegator");
...
public static b4a.B4APagesNavBar.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.B4APagesNavBar.b4xcollections.class),"DateUtils",b4xpages.mostCurrent._dateutils,"Delegate",b4xpages._delegate,"GlobalContext",b4xpages._globalcontext,"HttpUtils2Service",Debug.moduleToString(b4a.B4APagesNavBar.httputils2service.class),"Main",Debug.moduleToString(b4a.B4APagesNavBar.main.class),"mPM",b4xpages._mpm,"Starter",Debug.moduleToString(b4a.B4APagesNavBar.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.B4APagesNavBar.xuiviewsutils.class)};
}
}