...
try {
		Debug.PushSubsStack("Base_Resize (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bblabel.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 57;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bblabel.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bblabel._style = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraphstyle");__ref.setField("_style",bblabel._style);
 //BA.debugLineNum = 8;BA.debugLine="Private mTextEngine As BCTextEngine";
bblabel._mtextengine = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine");__ref.setField("_mtextengine",bblabel._mtextengine);
...
bblabel._paragraph = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraph");__ref.setField("_paragraph",bblabel._paragraph);
...
bblabel._parsedata = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bblabel._parsedata);
...
try {
		Debug.PushSubsStack("DesignerCreateView (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("getText (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("getTextEngine (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("Initialize (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("ParseAndDraw (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,85);
...
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).setField ("_rtlaware" /*RemoteObject*/ ,bblabel.__c.getField(true,"True"));};
...
try {
		Debug.PushSubsStack("Redraw (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,98);
...
Debug.JustUpdateDeviceLine();
bblabel._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bblabel._style);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawtext" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ )),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), bblabel.__c.getField(false,"Null"))));
...
_v = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), group10.runMethod(false,"Get",index10));Debug.locals.put("v", _v);
...
try {
		Debug.PushSubsStack("setText (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("setTextEngine (bblabel) ","bblabel",20,__ref.getField(false, "ba"),__ref,62);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bblabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
