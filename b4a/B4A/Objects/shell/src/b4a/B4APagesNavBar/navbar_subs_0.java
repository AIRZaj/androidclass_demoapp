...
try {
		Debug.PushSubsStack("btnNavBar_Click (navbar) ","navbar",5,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("Initialize (navbar) ","navbar",5,__ref.getField(false, "ba"),__ref,11);
