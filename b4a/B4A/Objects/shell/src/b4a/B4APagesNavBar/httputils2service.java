...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("httputils2service"), "b4a.B4APagesNavBar.httputils2service");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("b4a.B4APagesNavBar.httputils2service");
...
public static b4a.B4APagesNavBar.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.B4APagesNavBar.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.B4APagesNavBar.b4xpages.class),"DateUtils",httputils2service.mostCurrent._dateutils,"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.B4APagesNavBar.main.class),"Receiver",httputils2service.mostCurrent._receiver,"Starter",Debug.moduleToString(b4a.B4APagesNavBar.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"XUIViewsUtils",Debug.moduleToString(b4a.B4APagesNavBar.xuiviewsutils.class)};
}
}