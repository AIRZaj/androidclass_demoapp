...
public static RemoteObject _bb1 = RemoteObject.declareNull("b4a.B4APagesNavBar.bblabel");
public static RemoteObject _te = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine");
