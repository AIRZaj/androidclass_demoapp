...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("starter"), "b4a.B4APagesNavBar.starter");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("b4a.B4APagesNavBar.starter");
...
public static b4a.B4APagesNavBar.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.B4APagesNavBar.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.B4APagesNavBar.b4xpages.class),"DateUtils",starter.mostCurrent._dateutils,"HttpUtils2Service",Debug.moduleToString(b4a.B4APagesNavBar.httputils2service.class),"Main",Debug.moduleToString(b4a.B4APagesNavBar.main.class),"Service",starter.mostCurrent._service,"XUIViewsUtils",Debug.moduleToString(b4a.B4APagesNavBar.xuiviewsutils.class)};
}
}