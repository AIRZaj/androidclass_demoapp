...
bbcodeparser._allowedtags = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_allowedtags",bbcodeparser._allowedtags);
...
bbcodeparser._mtextengine = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine");__ref.setField("_mtextengine",bbcodeparser._mtextengine);
...
bbcodeparser._urlcolor = BA.numberCast(int.class, ((int)0xff003fff));__ref.setField("_urlcolor",bbcodeparser._urlcolor);
...
try {
		Debug.PushSubsStack("CreateRuns (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,182);
...
RemoteObject _textnode = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_texttorun" /*RemoteObject*/ ,(Object)(_textnode),(Object)(_runs),(Object)(_data));
 }
}Debug.locals.put("TextNode", _textnode);
;
...
try {
		Debug.PushSubsStack("CreateTagNode (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,174);
if (RapidSub.canDelegate("createtagnode")) { return __ref.runUserSub(false, "bbcodeparser","createtagnode", __ref, _tag);}
RemoteObject _n = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("CreateTextNode (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,164);
if (RapidSub.canDelegate("createtextnode")) { return __ref.runUserSub(false, "bbcodeparser","createtextnode", __ref, _text);}
RemoteObject _n = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetextnode");
...
Debug.JustUpdateDeviceLine();
_n = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeparser._bbcodetextnode");Debug.locals.put("n", _n);
...
try {
		Debug.PushSubsStack("Error (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,154);
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","912124163",_s,bbcodeparser.__c.getField(false,"Colors").getField(true,"Red"));
...
try {
		Debug.PushSubsStack("GetDimensionFromTag (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,374);
...
Debug.locals.put("Data", _data);
 BA.debugLineNum = 374;BA.debugLine="Private Sub GetDimensionFromTag (Tag As BBCodeTagN";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 375;BA.debugLine="Dim s As String = Tag.Extra.GetDefault(Key, \"\")";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetView (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,441);
...
Debug.locals.put("Tag", _tag);
Debug.locals.put("Data", _data);
 BA.debugLineNum = 441;BA.debugLine="Private Sub GetView (Tag As BBCodeTagNode, Data As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 442;BA.debugLine="Dim id As String = Tag.Extra.Get(\"view\")";
Debug.JustUpdateDeviceLine();
_id = BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("view")))));Debug.locals.put("id", _id);Debug.locals.put("id", _id);
 BA.debugLineNum = 443;BA.debugLine="If Data.Views.ContainsKey(id) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_data.getField(false,"Views" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_id))),bbcodeparser.__c.getField(true,"False"))) { 
 BA.debugLineNum = 444;BA.debugLine="Error(\"Missing view: \" & id)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Missing view: "),_id)));
 };
 BA.debugLineNum = 446;BA.debugLine="Dim v As B4XView = Data.Views.Get(id)";
Debug.JustUpdateDeviceLine();
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_v = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _data.getField(false,"Views" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_id))));Debug.locals.put("v", _v);Debug.locals.put("v", _v);
 BA.debugLineNum = 447;BA.debugLine="Return v";
Debug.JustUpdateDeviceLine();
if (true) return _v;
...
try {
		Debug.PushSubsStack("HandleListElement (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,347);
if (RapidSub.canDelegate("handlelistelement")) { return __ref.runUserSub(false, "bbcodeparser","handlelistelement", __ref, _text, _run);}
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
...
Debug.locals.put("Run", _run);
 BA.debugLineNum = 347;BA.debugLine="Private Sub HandleListElement (Text As BBCodeTextN";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 348;BA.debugLine="For i = Text.Tags.Size - 1 To 0 Step -1";
Debug.JustUpdateDeviceLine();
{
final int step1 = -1;
final int limit1 = 0;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 349;BA.debugLine="Dim tag As BBCodeTagNode = Text.Tags.Get(i)";
Debug.JustUpdateDeviceLine();
_tag = (_text.getField(false,"Tags" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("tag", _tag);Debug.locals.put("tag", _tag);
 BA.debugLineNum = 350;BA.debugLine="If tag.Tag = \"list\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_tag.getField(true,"Tag" /*RemoteObject*/ ),BA.ObjectToString("list"))) { 
 BA.debugLineNum = 351;BA.debugLine="Dim liststyle As String";
Debug.JustUpdateDeviceLine();
_liststyle = RemoteObject.createImmutable("");Debug.locals.put("liststyle", _liststyle);
 BA.debugLineNum = 352;BA.debugLine="If tag.extra.IsInitialized Then liststyle = tag";
Debug.JustUpdateDeviceLine();
...
_liststyle = BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("style"))),(Object)((RemoteObject.createImmutable("unordered")))));Debug.locals.put("liststyle", _liststyle);};
 BA.debugLineNum = 353;BA.debugLine="If liststyle = \"\" Or liststyle.ToLowerCase = \"u";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_liststyle,BA.ObjectToString("")) || RemoteObject.solveBoolean("=",_liststyle.runMethod(true,"toLowerCase"),BA.ObjectToString("unordered"))) { 
 BA.debugLineNum = 354;BA.debugLine="Run.TextChars =  mTextEngine.CreateBCTextChars";
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.concat(bbcodeparser.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0x2022)))),RemoteObject.createImmutable(" ")))));
 }else {
 BA.debugLineNum = 356;BA.debugLine="Dim count As Int = tag.Extra.GetDefault(\"count";
Debug.JustUpdateDeviceLine();
_count = BA.numberCast(int.class, _tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("count"))),(Object)(RemoteObject.createImmutable((1)))));Debug.locals.put("count", _count);Debug.locals.put("count", _count);
 BA.debugLineNum = 357;BA.debugLine="Dim parent As BCTextRun = mTextEngine.CreateCo";
Debug.JustUpdateDeviceLine();
_parent = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createconnectedparent" /*RemoteObject*/ );Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
 BA.debugLineNum = 358;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.concat((_count),RemoteObject.createImmutable(". ")))));
 BA.debugLineNum = 359;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 371;BA.debugLine="Return Run";
Debug.JustUpdateDeviceLine();
if (true) return _run;
...
try {
		Debug.PushSubsStack("Initialize (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,18);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_allowedtags" /*RemoteObject*/ ,bbcodeparser._b4xcollections.runMethod(false,"_createset2" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(bbcodeparser.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("Object",new int[] {20},new Object[] {RemoteObject.createImmutable(("b")),RemoteObject.createImmutable(("u")),RemoteObject.createImmutable(("url")),RemoteObject.createImmutable(("plain")),RemoteObject.createImmutable(("color")),RemoteObject.createImmutable(("img")),RemoteObject.createImmutable(("view")),RemoteObject.createImmutable(("vertical")),RemoteObject.createImmutable(("textsize")),RemoteObject.createImmutable(("alignment")),RemoteObject.createImmutable(("span")),RemoteObject.createImmutable(("indent")),RemoteObject.createImmutable(("list")),RemoteObject.createImmutable(("*")),RemoteObject.createImmutable(("fontawesome")),RemoteObject.createImmutable(("materialicons")),RemoteObject.createImmutable(("e")),RemoteObject.createImmutable(("font")),RemoteObject.createImmutable(("direction")),(RemoteObject.createImmutable("a"))}))))));
...
try {
		Debug.PushSubsStack("Parse (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,37);
...
RemoteObject _t = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
RemoteObject _n = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
Debug.locals.put("Data", _data);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_stack" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("noop"))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(__ref.getField(true,"_start" /*RemoteObject*/ ))))))));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"Tag" /*RemoteObject*/ ),_tag)) { 
 BA.debugLineNum = 55;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ ).getField(true,"CanHaveNestedTags" /*RemoteObject*/ ),bbcodeparser.__c.getField(true,"False"))) { 
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Closing tag does not match: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_stackpop" /*RemoteObject*/ );
...
{ BA.debugLineNum = 74;BA.debugLine="Else If tag = \"*\" Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
_t = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_parsetag" /*RemoteObject*/ ,(Object)(_tag));Debug.locals.put("t", _t);Debug.locals.put("t", _t);
 BA.debugLineNum = 79;BA.debugLine="If AllowedTags.Contains(t.Tag) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_allowedtags" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_t.getField(true,"Tag" /*RemoteObject*/ )))),bbcodeparser.__c.getField(true,"False"))) { 
 BA.debugLineNum = 80;BA.debugLine="Error(\"Invalid tag: \" & tag)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid tag: "),_tag)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_stackpush" /*RemoteObject*/ ,(Object)(_t));
...
Debug.JustUpdateDeviceLine();
_n = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_stackpeek" /*RemoteObject*/ );Debug.locals.put("n", _n);Debug.locals.put("n", _n);
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))))));
...
Debug.JustUpdateDeviceLine();
_parsedelements.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtextnode" /*RemoteObject*/ ,(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"substring",(Object)(_lastmatchend),(Object)(_data.getField(true,"Text" /*RemoteObject*/ ).runMethod(true,"length"))))))));
 };
...
try {
		Debug.PushSubsStack("ParseCodepoint (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,328);
...
Debug.locals.put("raw", _raw);
 BA.debugLineNum = 328;BA.debugLine="Private Sub ParseCodepoint (raw As String) As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 329;BA.debugLine="If raw.StartsWith(\"0x\") Then raw = raw.SubString(";
Debug.JustUpdateDeviceLine();
...
_raw = _raw.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("raw", _raw);};
 BA.debugLineNum = 330;BA.debugLine="Return Bit.ParseInt(raw, 16)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ParseColorString (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,333);
if (RapidSub.canDelegate("parsecolorstring")) { return __ref.runUserSub(false, "bbcodeparser","parsecolorstring", __ref, _clr);}
Debug.locals.put("clr", _clr);
 BA.debugLineNum = 333;BA.debugLine="Private Sub ParseColorString(clr As String) As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 334;BA.debugLine="clr = clr.ToLowerCase";
Debug.JustUpdateDeviceLine();
_clr = _clr.runMethod(true,"toLowerCase");Debug.locals.put("clr", _clr);
 BA.debugLineNum = 335;BA.debugLine="If clr.StartsWith(\"#\") Then";
Debug.JustUpdateDeviceLine();
if (_clr.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("#"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 336;BA.debugLine="Return Bit.Or(0xff000000, Bit.ParseInt(clr.SubSt";
Debug.JustUpdateDeviceLine();
if (true) return bbcodeparser.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0xff000000))),(Object)(bbcodeparser.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_clr.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 1)))),(Object)(BA.numberCast(int.class, 16)))));
 }else 
{ BA.debugLineNum = 337;BA.debugLine="Else If clr.StartsWith(\"0x\") Then";
Debug.JustUpdateDeviceLine();
if (_clr.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("0x"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 338;BA.debugLine="Return Bit.Or(0xff000000, Bit.ParseInt(clr.SubSt";
Debug.JustUpdateDeviceLine();
if (true) return bbcodeparser.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0xff000000))),(Object)(bbcodeparser.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_clr.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 4)))),(Object)(BA.numberCast(int.class, 16)))));
 }else 
{ BA.debugLineNum = 339;BA.debugLine="Else If ColorsMap.ContainsKey(clr) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_colorsmap" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_clr))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 340;BA.debugLine="Return ColorsMap.Get(clr)";
Debug.JustUpdateDeviceLine();
if (true) return BA.numberCast(int.class, __ref.getField(false,"_colorsmap" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_clr))));
 }else {
 BA.debugLineNum = 342;BA.debugLine="Error(\"Invalid color value: \" & clr)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_error" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Invalid color value: "),_clr)));
 BA.debugLineNum = 343;BA.debugLine="Return xui.Color_Black";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ParseTag (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("parsetag")) { return __ref.runUserSub(false, "bbcodeparser","parsetag", __ref, _tag);}
RemoteObject _res = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
RemoteObject _i = RemoteObject.createImmutable(0);
...
if (true) return __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(_tag.runMethod(true,"toLowerCase")));};
 BA.debugLineNum = 107;BA.debugLine="Dim res As BBCodeTagNode = CreateTagNode(\"\")";
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createtagnode" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("SetImageView (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,395);
...
public ResumableSub_SetImageView(b4a.B4APagesNavBar.bbcodeparser parent,RemoteObject __ref,RemoteObject _tag,RemoteObject _run,RemoteObject _data) {
this.parent = parent;
this.__ref = __ref;
this._tag = _tag;
this._run = _run;
...
RemoteObject _j = RemoteObject.declareNull("b4a.B4APagesNavBar.httpjob");
...
Debug.locals.put("run", _run);
Debug.locals.put("data", _data);
 BA.debugLineNum = 396;BA.debugLine="Dim url As String = Tag.Extra.GetDefault(\"url\", \"";
Debug.JustUpdateDeviceLine();
_url = BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("url"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("url", _url);Debug.locals.put("url", _url);
 BA.debugLineNum = 397;BA.debugLine="Dim dir As String = Tag.Extra.GetDefault(\"dir\", F";
Debug.JustUpdateDeviceLine();
_dir = BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("dir"))),(Object)((parent.__c.getField(false,"File").runMethod(true,"getDirAssets")))));Debug.locals.put("dir", _dir);Debug.locals.put("dir", _dir);
 BA.debugLineNum = 398;BA.debugLine="Dim filename As String = Tag.Extra.GetDefault(\"fi";
Debug.JustUpdateDeviceLine();
_filename = BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("filename"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("filename", _filename);Debug.locals.put("filename", _filename);
 BA.debugLineNum = 399;BA.debugLine="Dim width As Int = GetDimensionFromTag(Tag, \"widt";
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data));Debug.locals.put("width", _width);Debug.locals.put("width", _width);
 BA.debugLineNum = 400;BA.debugLine="Dim height As Int = GetDimensionFromTag(Tag, \"hei";
Debug.JustUpdateDeviceLine();
_height = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data));Debug.locals.put("height", _height);Debug.locals.put("height", _height);
 BA.debugLineNum = 401;BA.debugLine="Dim iv As ImageView";
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 402;BA.debugLine="iv.Initialize(\"\")";
Debug.JustUpdateDeviceLine();
_iv.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 406;BA.debugLine="Dim xiv As B4XView = iv";
Debug.JustUpdateDeviceLine();
_xiv = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_xiv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _iv.getObject());Debug.locals.put("xiv", _xiv);Debug.locals.put("xiv", _xiv);
 BA.debugLineNum = 407;BA.debugLine="run.View = xiv";
Debug.JustUpdateDeviceLine();
_run.setField ("View" /*RemoteObject*/ ,_xiv);
 BA.debugLineNum = 408;BA.debugLine="Dim bmp As B4XBitmap";
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper");Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 409;BA.debugLine="If url <> \"\" Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 410;BA.debugLine="xiv.SetLayoutAnimated(0, 0, 0, width, height)";
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_width),(Object)(_height));
 BA.debugLineNum = 411;BA.debugLine="If data.ImageCache.ContainsKey(url) Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 13;
 BA.debugLineNum = 412;BA.debugLine="xiv.SetBitmap(data.ImageCache.Get(url))";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 9;
 BA.debugLineNum = 414;BA.debugLine="Dim j As HttpJob";
Debug.JustUpdateDeviceLine();
_j = RemoteObject.createNew ("b4a.B4APagesNavBar.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 415;BA.debugLine="j.Initialize(\"\", Me)";
Debug.JustUpdateDeviceLine();
_j.runClassMethod (b4a.B4APagesNavBar.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 416;BA.debugLine="j.Download(url)";
Debug.JustUpdateDeviceLine();
_j.runClassMethod (b4a.B4APagesNavBar.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_url));
 BA.debugLineNum = 417;BA.debugLine="Wait For (j) JobDone (j As HttpJob)";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 418;BA.debugLine="If j.Success Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 12;
 BA.debugLineNum = 419;BA.debugLine="bmp = j.GetBitmap";
Debug.JustUpdateDeviceLine();
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), _j.runClassMethod (b4a.B4APagesNavBar.httpjob.class, "_getbitmap" /*RemoteObject*/ ).getObject());Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 420;BA.debugLine="bmp = bmp.Resize(width, height, True)";
Debug.JustUpdateDeviceLine();
_bmp = _bmp.runMethod(false,"Resize",(Object)(_width),(Object)(_height),(Object)(parent.__c.getField(true,"True")));Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 421;BA.debugLine="data.ImageCache.Put(url, bmp)";
Debug.JustUpdateDeviceLine();
_data.getField(false,"ImageCache" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_url)),(Object)((_bmp.getObject())));
 BA.debugLineNum = 422;BA.debugLine="xiv.SetBitmap(bmp)";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (b4a.B4APagesNavBar.httpjob.class, "_release" /*RemoteObject*/ );
 if (true) break;
...
//C
this.state = 16;
 BA.debugLineNum = 427;BA.debugLine="If width = -1 And height = -1 Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
{ BA.debugLineNum = 429;BA.debugLine="Else if width > -1 And height > -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_width,BA.numberCast(double.class, -(double) (0 + 1))) && RemoteObject.solveBoolean(">",_height,BA.numberCast(double.class, -(double) (0 + 1)))) { 
this.state = 20;
}else 
{ BA.debugLineNum = 431;BA.debugLine="Else if width > -1 Then";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 25;
 BA.debugLineNum = 428;BA.debugLine="bmp = xui.LoadBitmap(dir, filename)";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 25;
 BA.debugLineNum = 430;BA.debugLine="bmp = xui.LoadBitmapResize(dir, filename, width";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 25;
 BA.debugLineNum = 432;BA.debugLine="bmp = xui.LoadBitmapResize(dir, filename, width";
Debug.JustUpdateDeviceLine();
...
//C
this.state = 25;
 BA.debugLineNum = 434;BA.debugLine="bmp = xui.LoadBitmapResize(dir, filename, 10000";
Debug.JustUpdateDeviceLine();
...
this.state = 26;
;
 BA.debugLineNum = 436;BA.debugLine="xiv.SetBitmap(bmp)";
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("SetBitmap",(Object)((_bmp.getObject())));
 BA.debugLineNum = 437;BA.debugLine="xiv.SetLayoutAnimated(0, 0, 0, bmp.Width, bmp.He";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("StackPeek (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,150);
...
try {
		Debug.PushSubsStack("StackPop (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("StackPush (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,146);
...
try {
		Debug.PushSubsStack("TextToRun (bbcodeparser) ","bbcodeparser",18,__ref.getField(false, "ba"),__ref,191);
...
int _i = 0;
RemoteObject _tag = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeparser._bbcodetagnode");
RemoteObject _uu = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcstyledunderline");
RemoteObject _url = RemoteObject.createImmutable("");
...
Debug.JustUpdateDeviceLine();
_run = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(_text.getField(true,"Text" /*RemoteObject*/ )));Debug.locals.put("Run", _run);Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
switch (BA.switchObjectToInt(_tag.getField(true,"Tag" /*RemoteObject*/ ),BA.ObjectToString("u"),BA.ObjectToString("b"),BA.ObjectToString("url"),BA.ObjectToString("color"),BA.ObjectToString("img"),BA.ObjectToString("view"),BA.ObjectToString("vertical"),BA.ObjectToString("textsize"),BA.ObjectToString("font"),BA.ObjectToString("alignment"),BA.ObjectToString("span"),BA.ObjectToString("indent"),BA.ObjectToString("list"),BA.ObjectToString("*"),BA.ObjectToString("e"),BA.ObjectToString("direction"),BA.ObjectToString("fontawesome"),BA.ObjectToString("materialicons"),BA.ObjectToString("a"))) {
case 0: {
...
Debug.JustUpdateDeviceLine();
_uu = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcstyledunderline");Debug.locals.put("uu", _uu);
...
_uu.setField ("Clr" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("color"))))))));}
else {
...
Debug.JustUpdateDeviceLine();
_run.setField ("AutoUnderline" /*RemoteObject*/ ,bbcodeparser.__c.getField(true,"True"));
 BA.debugLineNum = 228;BA.debugLine="Run.TextColor = Bit.Or(0xff000000, UrlColor)";
Debug.JustUpdateDeviceLine();
_run.setField ("TextColor" /*RemoteObject*/ ,bbcodeparser.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0xff000000))),(Object)(__ref.getField(true,"_urlcolor" /*RemoteObject*/ ))));
 break; }
case 3: {
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextColor" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_parsecolorstring" /*RemoteObject*/ ,(Object)(_clr)));
 break; }
case 4: {
 BA.debugLineNum = 233;BA.debugLine="SetImageView(tag, Run, Data)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_setimageview" /*void*/ ,(Object)(_tag),(Object)(_run),(Object)(_data));
...
Debug.JustUpdateDeviceLine();
_run.setField ("VerticalOffset" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("vertical")),(Object)(_data)));
 };
...
Debug.JustUpdateDeviceLine();
_run.setField ("View" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getview" /*RemoteObject*/ ,(Object)(_tag),(Object)(_data)));
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setWidth",__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("width")),(Object)(_data)));};
...
_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"setHeight",__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("height")),(Object)(_data)));};
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","912386365",RemoteObject.concat(RemoteObject.createImmutable("Font missing from TextEngine.CustomFonts: "),_name),0);
 }else {
...
Debug.JustUpdateDeviceLine();
_cr.setField ("ConnectedWidth" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_getdimensionfromtag" /*RemoteObject*/ ,(Object)(_tag),(Object)(BA.ObjectToString("minwidth")),(Object)(_data)));
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_tag.getField(true,"Tag" /*RemoteObject*/ )))))})),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 1))));
...
Debug.JustUpdateDeviceLine();
_run.setField ("TextChars" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(BA.ObjectToString(bbcodeparser.__c.runMethod(true,"Chr",(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_parsecodepoint" /*RemoteObject*/ ,(Object)(BA.ObjectToString(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_tag.getField(true,"Tag" /*RemoteObject*/ )))))))))))));
...
_fontsize = BA.numberCast(int.class, _tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("size")))));Debug.locals.put("FontSize", _fontsize);};
 break; }
case 18: {
 BA.debugLineNum = 302;BA.debugLine="If Run.Extra.IsInitialized = False Then Run.Ex";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_run.getField(false,"Extra" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),bbcodeparser.__c.getField(true,"False"))) { 
_run.getField(false,"Extra" /*RemoteObject*/ ).runVoidMethod ("Initialize");};
 BA.debugLineNum = 303;BA.debugLine="Run.Extra.Put(\"a\", tag.Extra.Get(\"a\"))";
Debug.JustUpdateDeviceLine();
_run.getField(false,"Extra" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("a"))),(Object)(_tag.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((RemoteObject.createImmutable("a"))))));
 break; }
}
;
 }
...
;
 BA.debugLineNum = 306;BA.debugLine="If IsListElement Then";
Debug.JustUpdateDeviceLine();
if (_islistelement.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 307;BA.debugLine="Run = HandleListElement(Text, Run)";
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_handlelistelement" /*RemoteObject*/ ,(Object)(_text),(Object)(_run));Debug.locals.put("Run", _run);
 };
 BA.debugLineNum = 309;BA.debugLine="If customfont Or FontSize <> Data.DefaultFont.Siz";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_customfont) || RemoteObject.solveBoolean("!",_fontsize,BA.numberCast(double.class, _data.getField(false,"DefaultFont" /*RemoteObject*/ ).runMethod(true,"getSize")))) { 
 BA.debugLineNum = 322;BA.debugLine="Run.TextFont = xui.CreateFont2(CurrentFont, Font";
Debug.JustUpdateDeviceLine();
_run.setField ("TextFont" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateFont2",(Object)(_currentfont),(Object)(BA.numberCast(float.class, _fontsize))));
 ...
 BA.debugLineNum = 325;BA.debugLine="list.Add(Run)";
Debug.JustUpdateDeviceLine();
