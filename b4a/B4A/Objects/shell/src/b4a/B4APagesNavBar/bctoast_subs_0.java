...
bctoast._bb1 = RemoteObject.createNew ("b4a.B4APagesNavBar.bblabel");__ref.setField("_bb1",bctoast._bb1);
 //BA.debugLineNum = 6;BA.debugLine="Private te As BCTextEngine";
bctoast._te = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine");__ref.setField("_te",bctoast._te);
...
try {
		Debug.PushSubsStack("Initialize (bctoast) ","bctoast",17,__ref.getField(false, "ba"),__ref,16);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_te" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_pnl" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("Show (bctoast) ","bctoast",17,__ref.getField(false, "ba"),__ref,33);
...
public ResumableSub_Show(b4a.B4APagesNavBar.bctoast parent,RemoteObject __ref,RemoteObject _message) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_bb1" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bblabel.class, "_settext" /*RemoteObject*/ ,_message);
