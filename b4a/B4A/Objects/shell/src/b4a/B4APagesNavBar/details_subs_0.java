...
try {
		Debug.PushSubsStack("B4XPage_Created (details) ","details",3,__ref.getField(false, "ba"),__ref,27);
...
__ref.getField(false,"_imgavatar" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4ximageview.class, "_load" /*RemoteObject*/ ,(Object)(details.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("avatar.png")));
...
details._imgavatar = RemoteObject.createNew ("b4a.B4APagesNavBar.b4ximageview");__ref.setField("_imgavatar",details._imgavatar);
 //BA.debugLineNum = 15;BA.debugLine="Private ImgView1 As B4XImageView";
details._imgview1 = RemoteObject.createNew ("b4a.B4APagesNavBar.b4ximageview");__ref.setField("_imgview1",details._imgview1);
 //BA.debugLineNum = 16;BA.debugLine="Private ImgView2 As B4XImageView";
details._imgview2 = RemoteObject.createNew ("b4a.B4APagesNavBar.b4ximageview");__ref.setField("_imgview2",details._imgview2);
 //BA.debugLineNum = 17;BA.debugLine="Private ImgView3 As B4XImageView";
details._imgview3 = RemoteObject.createNew ("b4a.B4APagesNavBar.b4ximageview");__ref.setField("_imgview3",details._imgview3);
...
try {
		Debug.PushSubsStack("Initialize (details) ","details",3,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("LoadPerson (details) ","details",3,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("MailButton_Click (details) ","details",3,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("MessageButton_Click (details) ","details",3,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("Phone_Click (details) ","details",3,__ref.getField(false, "ba"),__ref,72);
...
details.__c.runVoidMethod ("LogImpl","61966082",__ref.getField(true,"_phonenumber" /*RemoteObject*/ ),0);
