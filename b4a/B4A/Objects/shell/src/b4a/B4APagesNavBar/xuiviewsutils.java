...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.B4APagesNavBar.xuiviewsutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("xuiviewsutils"), "b4a.B4APagesNavBar.xuiviewsutils");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.B4APagesNavBar.xuiviewsutils"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
