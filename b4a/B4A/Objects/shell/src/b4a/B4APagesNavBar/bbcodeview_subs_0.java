...
try {
		Debug.PushSubsStack("Base_Resize (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,105);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_parseanddraw" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 113;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_redraw" /*RemoteObject*/ );
 };
 };
...
bbcodeview._style = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraphstyle");__ref.setField("_style",bbcodeview._style);
 //BA.debugLineNum = 12;BA.debugLine="Private mTextEngine As BCTextEngine";
bbcodeview._mtextengine = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine");__ref.setField("_mtextengine",bbcodeview._mtextengine);
...
bbcodeview._paragraph = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraph");__ref.setField("_paragraph",bbcodeview._paragraph);
...
bbcodeview._parsedata = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeparser._bbcodeparsedata");__ref.setField("_parsedata",bbcodeview._parsedata);
...
bbcodeview._usedimageviews = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xorderedmap");__ref.setField("_usedimageviews",bbcodeview._usedimageviews);
...
try {
		Debug.PushSubsStack("CleanExistingImageViews (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,205);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 205;BA.debugLine="Private Sub CleanExistingImageViews (InvisibleOnly";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 206;BA.debugLine="For Each Line As BCTextLine In Existing";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("Line", _line);
 BA.debugLineNum = 207;BA.debugLine="If InvisibleOnly = False Or LineIsVisible(Line,";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_invisibleonly,bbcodeview.__c.getField(true,"False")) || RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offset),(Object)(_height)),bbcodeview.__c.getField(true,"False"))) { 
 BA.debugLineNum = 208;BA.debugLine="Dim xiv As B4XView = UsedImageViews.Get(Line)";
Debug.JustUpdateDeviceLine();
_xiv = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_xiv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_line))));Debug.locals.put("xiv", _xiv);Debug.locals.put("xiv", _xiv);
 BA.debugLineNum = 209;BA.debugLine="xiv.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("RemoveViewFromParent");
 BA.debugLineNum = 210;BA.debugLine="xiv.SetBitmap(Null)";
Debug.JustUpdateDeviceLine();
_xiv.runVoidMethod ("SetBitmap",(Object)((bbcodeview.__c.getField(false,"Null"))));
 BA.debugLineNum = 211;BA.debugLine="ImageViewsCache.Add(xiv)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_imageviewscache" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_xiv.getObject())));
 BA.debugLineNum = 212;BA.debugLine="If InvisibleOnly = True Then UsedImageViews.Rem";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_invisibleonly,bbcodeview.__c.getField(true,"True"))) { 
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_line)));};
 };
 }
}Debug.locals.put("Line", _line);
;
...
try {
		Debug.PushSubsStack("CollectURLs (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,327);
...
RemoteObject _st = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
RemoteObject _extra = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeview._internalbbviewurl");
 BA.debugLineNum = 327;BA.debugLine="Private Sub CollectURLs";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 328;BA.debugLine="For Each line As BCTextLine In Paragraph.TextLine";
Debug.JustUpdateDeviceLine();
{
...
_line = (group1.runMethod(false,"Get",index1));Debug.locals.put("line", _line);
Debug.locals.put("line", _line);
 BA.debugLineNum = 329;BA.debugLine="For Each un As BCUnbreakableText In line.Unbreak";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("un", _un);
 BA.debugLineNum = 330;BA.debugLine="For Each st As BCSingleStyleSection In un.Singl";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("st", _st);
 BA.debugLineNum = 331;BA.debugLine="If ParseData.URLs.ContainsKey(st.Run) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"URLs" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_st.getField(false,"Run" /*RemoteObject*/ )))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 332;BA.debugLine="Dim extra As InternalBBViewURL";
Debug.JustUpdateDeviceLine();
_extra = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeview._internalbbviewurl");Debug.locals.put("extra", _extra);
 BA.debugLineNum = 333;BA.debugLine="If URLToLines.ContainsKey(st.Run) = False The";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_st.getField(false,"Run" /*RemoteObject*/ )))),bbcodeview.__c.getField(true,"False"))) { 
 BA.debugLineNum = 334;BA.debugLine="extra = CreateBCURLExtraData";
Debug.JustUpdateDeviceLine();
_extra = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_createbcurlextradata" /*RemoteObject*/ );Debug.locals.put("extra", _extra);
 BA.debugLineNum = 335;BA.debugLine="URLToLines.Put(st.Run, extra)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_st.getField(false,"Run" /*RemoteObject*/ ))),(Object)((_extra)));
 }else {
 BA.debugLineNum = 337;BA.debugLine="extra = URLToLines.Get(st.Run)";
Debug.JustUpdateDeviceLine();
_extra = (__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_st.getField(false,"Run" /*RemoteObject*/ )))));Debug.locals.put("extra", _extra);
 ...
 BA.debugLineNum = 339;BA.debugLine="If extra.Lines.IndexOf(line) = -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_extra.getField(false,"Lines" /*RemoteObject*/ ).runMethod(true,"IndexOf",(Object)((_line))),BA.numberCast(double.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 340;BA.debugLine="extra.Lines.Add(line)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateBCURLExtraData (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,348);
if (RapidSub.canDelegate("createbcurlextradata")) { return __ref.runUserSub(false, "bbcodeview","createbcurlextradata", __ref);}
RemoteObject _t1 = RemoteObject.declareNull("b4a.B4APagesNavBar.bbcodeview._internalbbviewurl");
 BA.debugLineNum = 348;BA.debugLine="Private Sub CreateBCURLExtraData  As InternalBBVie";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 349;BA.debugLine="Dim t1 As InternalBBViewURL";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeview._internalbbviewurl");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 350;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 351;BA.debugLine="t1.Lines.Initialize";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DesignerCreateView (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("DrawVisibleRegion (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("FindTouchedRun (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,292);
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 292;BA.debugLine="Private Sub FindTouchedRun(x As Float, y As Float)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 293;BA.debugLine="For Each offsetx As Int In Array(0, -5dip, 5dip)";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("offsetx", _offsetx);
 BA.debugLineNum = 294;BA.debugLine="For Each offsety As Int In Array(0, -3dip, 3dip)";
Debug.JustUpdateDeviceLine();
{
...
public static RemoteObject  _getanchorline(RemoteObject __ref,RemoteObject _anchor) throws Exception{
try {
		Debug.PushSubsStack("GetAnchorLine (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,196);
if (RapidSub.canDelegate("getanchorline")) { return __ref.runUserSub(false, "bbcodeview","getanchorline", __ref, _anchor);}
Debug.locals.put("Anchor", _anchor);
 BA.debugLineNum = 196;BA.debugLine="Private Sub GetAnchorLine (Anchor As String) As BC";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 197;BA.debugLine="If Paragraph.Anchors.IsInitialized = False Then R";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_paragraph" /*RemoteObject*/ ).getField(false,"Anchors" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),bbcodeview.__c.getField(true,"False"))) { 
if (true) return (bbcodeview.__c.getField(false,"Null"));};
 BA.debugLineNum = 198;BA.debugLine="Return Paragraph.Anchors.Get(Anchor)";
Debug.JustUpdateDeviceLine();
if (true) return (__ref.getField(false,"_paragraph" /*RemoteObject*/ ).getField(false,"Anchors" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_anchor))));
...
try {
		Debug.PushSubsStack("getText (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("getTextEngine (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,128);
...
try {
		Debug.PushSubsStack("getViews (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("Initialize (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("LineIsVisible (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,201);
if (RapidSub.canDelegate("lineisvisible")) { return __ref.runUserSub(false, "bbcodeview","lineisvisible", __ref, _line, _offset, _height);}
Debug.locals.put("line", _line);
Debug.locals.put("offset", _offset);
Debug.locals.put("height", _height);
 BA.debugLineNum = 201;BA.debugLine="Private Sub LineIsVisible(line As BCTextLine, offs";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 202;BA.debugLine="Return line.BaselineY + line.MaxHeightBelowBaseLi";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("MarkURL (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,304);
...
Debug.locals.put("Run", _run);
 BA.debugLineNum = 304;BA.debugLine="Private Sub MarkURL (Run As BCTextRun)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 314;BA.debugLine="For Each r As BCTextRun In URLToLines.Keys";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("r", _r);
 BA.debugLineNum = 315;BA.debugLine="If r.Underline <> (r = Run) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_r.getField(true,"Underline" /*RemoteObject*/ ),BA.ObjectToBoolean((RemoteObject.solveBoolean("=",_r,_run))))) { 
 BA.debugLineNum = 316;BA.debugLine="r.Underline = r = Run";
Debug.JustUpdateDeviceLine();
_r.setField ("Underline" /*RemoteObject*/ ,BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_r,_run)));
 BA.debugLineNum = 317;BA.debugLine="Dim extra As InternalBBViewURL = URLToLines.Get";
Debug.JustUpdateDeviceLine();
_extra = (__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_r))));Debug.locals.put("extra", _extra);Debug.locals.put("extra", _extra);
 BA.debugLineNum = 318;BA.debugLine="For Each line As BCTextLine In extra.Lines";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("line", _line);
 BA.debugLineNum = 319;BA.debugLine="If UsedImageViews.ContainsKey(line) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_line))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 320;BA.debugLine="mTextEngine.DrawSingleLine(line, UsedImageVie";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawsingleline" /*RemoteObject*/ ,(Object)(_line),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), __ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_line)))),(Object)(__ref.getField(false,"_paragraph" /*RemoteObject*/ )));
 };
 }
}Debug.locals.put("line", _line);
;
...
try {
		Debug.PushSubsStack("ParseAndDraw (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,218);
...
RemoteObject _pe = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 218;BA.debugLine="Public Sub ParseAndDraw";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 219;BA.debugLine="ParseData.NeedToReparseWhenResize = False";
Debug.JustUpdateDeviceLine();
...
__ref.getField(false,"_parsedata" /*RemoteObject*/ ).setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, (RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"),__ref.getField(false,"_padding" /*RemoteObject*/ ).runMethod(true,"getLeft"),__ref.getField(false,"_padding" /*RemoteObject*/ ).runMethod(true,"getRight")}, "--",2, 0))));
 BA.debugLineNum = 223;BA.debugLine="If RTL Then mTextEngine.RTLAware = True";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtl" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).setField ("_rtlaware" /*RemoteObject*/ ,bbcodeview.__c.getField(true,"True"));};
 BA.debugLineNum = 224;BA.debugLine="Dim pe As List = mTextEngine.TagParser.Parse(Pars";
Debug.JustUpdateDeviceLine();
_pe = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_pe = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_parse" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ )));Debug.locals.put("pe", _pe);Debug.locals.put("pe", _pe);
 BA.debugLineNum = 225;BA.debugLine="sv.ScrollViewInnerPanel.RemoveAllViews";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(false,"getScrollViewInnerPanel").runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 226;BA.debugLine="If TouchPanel.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 227;BA.debugLine="sv.ScrollViewInnerPanel.AddView(TouchPanel, 0, 0";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(false,"getScrollViewInnerPanel").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 ...
 BA.debugLineNum = 229;BA.debugLine="sv.ScrollViewInnerPanel.AddView(ForegroundImageVi";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(false,"getScrollViewInnerPanel").runVoidMethod ("AddView",(Object)((__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(bbcodeview.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(bbcodeview.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))));
 BA.debugLineNum = 230;BA.debugLine="If ExternalRuns.IsInitialized And ExternalRuns.Si";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_externalruns" /*RemoteObject*/ ).runMethod(true,"IsInitialized")) && RemoteObject.solveBoolean(">",__ref.getField(false,"_externalruns" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 231;BA.debugLine="Runs = ExternalRuns";
Debug.JustUpdateDeviceLine();
__ref.setField ("_runs" /*RemoteObject*/ ,__ref.getField(false,"_externalruns" /*RemoteObject*/ ));
 }else {
 BA.debugLineNum = 233;BA.debugLine="Runs = mTextEngine.TagParser.CreateRuns(pe, Pars";
Debug.JustUpdateDeviceLine();
__ref.setField ("_runs" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_createruns" /*RemoteObject*/ ,(Object)(_pe),(Object)(__ref.getField(false,"_parsedata" /*RemoteObject*/ ))));
 };
 BA.debugLineNum = 236;BA.debugLine="Redraw";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_redraw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Redraw (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,239);
if (RapidSub.canDelegate("redraw")) { return __ref.runUserSub(false, "bbcodeview","redraw", __ref);}
 BA.debugLineNum = 239;BA.debugLine="Public Sub Redraw";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 240;BA.debugLine="Dim Style As BCParagraphStyle = mTextEngine.Creat";
Debug.JustUpdateDeviceLine();
bbcodeview._style = __ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createstyle" /*RemoteObject*/ );__ref.setField("_style",bbcodeview._style);
 BA.debugLineNum = 241;BA.debugLine="Style.Padding = Padding";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_style" /*RemoteObject*/ ).setField ("Padding" /*RemoteObject*/ ,__ref.getField(false,"_padding" /*RemoteObject*/ ));
 BA.debugLineNum = 242;BA.debugLine="Style.MaxWidth = mBase.Width";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_style" /*RemoteObject*/ ).setField ("MaxWidth" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"));
 BA.debugLineNum = 243;BA.debugLine="Style.ResizeHeightAutomatically = True";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_style" /*RemoteObject*/ ).setField ("ResizeHeightAutomatically" /*RemoteObject*/ ,bbcodeview.__c.getField(true,"True"));
 BA.debugLineNum = 244;BA.debugLine="Style.RTL = RTL";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_style" /*RemoteObject*/ ).setField ("RTL" /*RemoteObject*/ ,__ref.getField(true,"_rtl" /*RemoteObject*/ ));
 BA.debugLineNum = 245;BA.debugLine="URLToLines.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 246;BA.debugLine="If LazyLoading Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_lazyloading" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 247;BA.debugLine="CleanExistingImageViews(False, UsedImageViews.Ke";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_cleanexistingimageviews" /*RemoteObject*/ ,(Object)(bbcodeview.__c.getField(true,"False")),(Object)(__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 248;BA.debugLine="UsedImageViews.Clear";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_clear" /*RemoteObject*/ );
 BA.debugLineNum = 249;BA.debugLine="Paragraph = mTextEngine.PrepareForLazyDrawing(Ru";
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_prepareforlazydrawing" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_sv" /*RemoteObject*/ ))));
 BA.debugLineNum = 250;BA.debugLine="ForegroundImageView.SetLayoutAnimated(0, Style.P";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, __ref.getField(false,"_style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"))),(Object)(BA.numberCast(int.class, __ref.getField(false,"_style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(true,"getScrollViewContentWidth"),__ref.getField(false,"_style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getWidth")}, "-",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_sv" /*RemoteObject*/ ).runMethod(true,"getScrollViewContentHeight"),__ref.getField(false,"_style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getHeight")}, "-",1, 0))));
 BA.debugLineNum = 251;BA.debugLine="If AutoUnderlineURLs And ParseData.URLs.Size > 0";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(true,"_autounderlineurls" /*RemoteObject*/ )) && RemoteObject.solveBoolean(">",__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"URLs" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 252;BA.debugLine="CollectURLs";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_collecturls" /*RemoteObject*/ );
 };
 BA.debugLineNum = 254;BA.debugLine="DrawVisibleRegion";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_drawvisibleregion" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 256;BA.debugLine="Paragraph = mTextEngine.DrawText(Runs, Style, Fo";
Debug.JustUpdateDeviceLine();
__ref.setField ("_paragraph" /*RemoteObject*/ ,__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawtext" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_runs" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_style" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_foregroundimageview" /*RemoteObject*/ )),(Object)(__ref.getField(false,"_sv" /*RemoteObject*/ ))));
 };
 BA.debugLineNum = 258;BA.debugLine="If TouchPanel.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_touchpanel" /*RemoteObject*/ ).runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 259;BA.debugLine="TouchPanel.SetLayoutAnimated(0, ForegroundImageV";
Debug.JustUpdateDeviceLine();
...
public static RemoteObject  _scrolltoanchor(RemoteObject __ref,RemoteObject _anchor) throws Exception{
try {
		Debug.PushSubsStack("ScrollToAnchor (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,178);
if (RapidSub.canDelegate("scrolltoanchor")) { return __ref.runUserSub(false, "bbcodeview","scrolltoanchor", __ref, _anchor);}
RemoteObject _line = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextline");
...
Debug.locals.put("Anchor", _anchor);
 BA.debugLineNum = 178;BA.debugLine="Public Sub ScrollToAnchor(Anchor As String)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 179;BA.debugLine="Dim line As BCTextLine = GetAnchorLine(Anchor)";
Debug.JustUpdateDeviceLine();
_line = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_getanchorline" /*RemoteObject*/ ,(Object)(_anchor));Debug.locals.put("line", _line);Debug.locals.put("line", _line);
 BA.debugLineNum = 180;BA.debugLine="If line <> Null Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_line)) { 
 BA.debugLineNum = 181;BA.debugLine="Dim top As Int = line.BaselineY - line.MaxHeight";
Debug.JustUpdateDeviceLine();
_top = RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "-",1, 1);Debug.locals.put("top", _top);Debug.locals.put("top", _top);
 BA.debugLineNum = 190;BA.debugLine="Dim nsv As ScrollView = sv";
Debug.JustUpdateDeviceLine();
_nsv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ScrollViewWrapper");
_nsv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ScrollViewWrapper"), __ref.getField(false,"_sv" /*RemoteObject*/ ).getObject());Debug.locals.put("nsv", _nsv);Debug.locals.put("nsv", _nsv);
 BA.debugLineNum = 191;BA.debugLine="nsv.ScrollPosition = top";
Debug.JustUpdateDeviceLine();
_nsv.runMethod(true,"setScrollPosition",_top);
 };
...
try {
		Debug.PushSubsStack("setText (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("setTextEngine (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,118);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("setViews (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("sv_ScrollChanged (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,362);
...
Debug.locals.put("Position", _position);
 BA.debugLineNum = 362;BA.debugLine="Private Sub sv_ScrollChanged(Position As Int)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 363;BA.debugLine="If LazyLoading Then DrawVisibleRegion";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_lazyloading" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_drawvisibleregion" /*RemoteObject*/ );};
...
try {
		Debug.PushSubsStack("TouchPanel_Touch (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,263);
...
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 263;BA.debugLine="Private Sub TouchPanel_Touch (Action As Int, X As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 264;BA.debugLine="Dim run As BCTextRun = Null";
Debug.JustUpdateDeviceLine();
_run = (bbcodeview.__c.getField(false,"Null"));Debug.locals.put("run", _run);Debug.locals.put("run", _run);
 BA.debugLineNum = 265;BA.debugLine="If URLToLines.Size > 0 Or Action = TouchPanel.TOU";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",__ref.getField(false,"_urltolines" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, __ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_UP")))) { 
 BA.debugLineNum = 266;BA.debugLine="run = FindTouchedRun(X, Y)";
Debug.JustUpdateDeviceLine();
_run = __ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_findtouchedrun" /*RemoteObject*/ ,(Object)(_x),(Object)(_y));Debug.locals.put("run", _run);
 };
 BA.debugLineNum = 268;BA.debugLine="If run <> Null And ParseData.URLs.ContainsKey(run";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_run) && RemoteObject.solveBoolean(".",__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"URLs" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)((_run))))) { 
 BA.debugLineNum = 269;BA.debugLine="If Action = TouchPanel.TOUCH_ACTION_UP Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_action,BA.numberCast(double.class, __ref.getField(false,"_touchpanel" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_UP")))) { 
 BA.debugLineNum = 270;BA.debugLine="Dim url As String = ParseData.Urls.Get(run)";
Debug.JustUpdateDeviceLine();
_url = BA.ObjectToString(__ref.getField(false,"_parsedata" /*RemoteObject*/ ).getField(false,"URLs" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_run))));Debug.locals.put("url", _url);Debug.locals.put("url", _url);
 BA.debugLineNum = 271;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_LinkC";
Debug.JustUpdateDeviceLine();
bbcodeview.__c.runVoidMethod ("CallSubDelayed2",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_LinkClicked"))),(Object)((_url)));
 BA.debugLineNum = 272;BA.debugLine="MarkURL(Null)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)((bbcodeview.__c.getField(false,"Null"))));
 }else 
{ BA.debugLineNum = 273;BA.debugLine="Else If (xui.IsB4i And Action = 4) Or (xui.IsB4A";
Debug.JustUpdateDeviceLine();
...
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)((bbcodeview.__c.getField(false,"Null"))));
 ...
 BA.debugLineNum = 277;BA.debugLine="MarkURL(run)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_markurl" /*RemoteObject*/ ,(Object)(_run));
 }}
;
...
try {
		Debug.PushSubsStack("UpdateVisibleRegion (bbcodeview) ","bbcodeview",19,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
_existing.runVoidMethod ("AddAll",(Object)(__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )));
 BA.debugLineNum = 152;BA.debugLine="CleanExistingImageViews(True, Existing, OffsetY,";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_cleanexistingimageviews" /*RemoteObject*/ ,(Object)(bbcodeview.__c.getField(true,"True")),(Object)(_existing),(Object)(_offsety),(Object)(_height));
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bbcodeview.class, "_lineisvisible" /*RemoteObject*/ ,(Object)(_line),(Object)(_offsety),(Object)(_height)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextengine" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawsingleline" /*RemoteObject*/ ,(Object)(_line),(Object)(_xiv),(Object)(__ref.getField(false,"_paragraph" /*RemoteObject*/ )));
 BA.debugLineNum = 171;BA.debugLine="UsedImageViews.Put(Line, xiv)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_usedimageviews" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_line)),(Object)((_xiv.getObject())));
 }else {
