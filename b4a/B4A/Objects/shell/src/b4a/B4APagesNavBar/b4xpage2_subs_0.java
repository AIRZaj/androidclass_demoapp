...
try {
		Debug.PushSubsStack("AddClickEvent (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("B4XPage_MenuClick (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("card_Click (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("CreateCard (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,166);
...
try {
		Debug.PushSubsStack("FetchData (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("HandleClick (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("JobDone (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("ParseJSON (b4xpage2) ","b4xpage2",2,__ref.getField(false, "ba"),__ref,80);
