...
try {
		Debug.PushSubsStack("AddLTRItems (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,341);
...
RemoteObject _lastun = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _prev = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
int _i = 0;
RemoteObject _un = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)))))).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_isunseparator" /*RemoteObject*/ ,(Object)((_ltrlist.runMethod(false,"Get",(Object)(_lastindex))))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("AddParagraphViews (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("BytesToInt (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,919);
...
Debug.locals.put("StartIndex", _startindex);
 BA.debugLineNum = 919;BA.debugLine="Private Sub BytesToInt (Bytes() As Byte, StartInde";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 920;BA.debugLine="Dim cp As Int";
Debug.JustUpdateDeviceLine();
_cp = RemoteObject.createImmutable(0);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 921;BA.debugLine="For i = 0 To 3";
Debug.JustUpdateDeviceLine();
{
final int step2 = 1;
final int limit2 = 3;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 922;BA.debugLine="cp = Bit.Or(cp, Bit.ShiftLeft(Bit.And(0xff, Byte";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 924;BA.debugLine="Return cp";
Debug.JustUpdateDeviceLine();
if (true) return _cp;
...
bctextengine._defaultunderlinestyle = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcstyledunderline");__ref.setField("_defaultunderlinestyle",bctextengine._defaultunderlinestyle);
...
bctextengine._defaultstyle = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraphstyle");__ref.setField("_defaultstyle",bctextengine._defaultstyle);
...
bctextengine._tagparser = RemoteObject.createNew ("b4a.B4APagesNavBar.bbcodeparser");__ref.setField("_tagparser",bctextengine._tagparser);
 //BA.debugLineNum = 52;BA.debugLine="Private EmptyTextChars As BCTextChars";
bctextengine._emptytextchars = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bctextchars");__ref.setField("_emptytextchars",bctextengine._emptytextchars);
 //BA.debugLineNum = 53;BA.debugLine="Private Emojis As B4XSet";
bctextengine._emojis = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_emojis",bctextengine._emojis);
...
bctextengine._vowelscodepoints = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_vowelscodepoints",bctextengine._vowelscodepoints);
 //BA.debugLineNum = 60;BA.debugLine="Private AsyncBCs As B4XOrderedMap";
bctextengine._asyncbcs = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xorderedmap");__ref.setField("_asyncbcs",bctextengine._asyncbcs);
...
bctextengine._rtlchars = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_rtlchars",bctextengine._rtlchars);
...
bctextengine._arabicnonlinkedletters = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_arabicnonlinkedletters",bctextengine._arabicnonlinkedletters);
 //BA.debugLineNum = 68;BA.debugLine="Private ArabicCharsConnectedPrev As B4XSet";
bctextengine._arabiccharsconnectedprev = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xset");__ref.setField("_arabiccharsconnectedprev",bctextengine._arabiccharsconnectedprev);
...
try {
		Debug.PushSubsStack("CreateBCTextChars (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1104);
...
RemoteObject _t1 = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextchars");
Debug.locals.put("Buffer", _buffer);
Debug.locals.put("StartIndex", _startindex);
Debug.locals.put("Length", _length);
 BA.debugLineNum = 1104;BA.debugLine="Public Sub CreateBCTextChars (Buffer() As String,";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1105;BA.debugLine="Dim t1 As BCTextChars";
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bctextchars");Debug.locals.put("t1", _t1);
 BA.debugLineNum = 1106;BA.debugLine="t1.Initialize";
Debug.JustUpdateDeviceLine();
_t1.runVoidMethod ("Initialize");
 BA.debugLineNum = 1107;BA.debugLine="t1.Buffer = Buffer";
Debug.JustUpdateDeviceLine();
_t1.setField ("Buffer" /*RemoteObject*/ ,_buffer);
 BA.debugLineNum = 1108;BA.debugLine="t1.StartIndex = StartIndex";
Debug.JustUpdateDeviceLine();
_t1.setField ("StartIndex" /*RemoteObject*/ ,_startindex);
 BA.debugLineNum = 1109;BA.debugLine="t1.Length = Length";
Debug.JustUpdateDeviceLine();
_t1.setField ("Length" /*RemoteObject*/ ,_length);
 BA.debugLineNum = 1110;BA.debugLine="Return t1";
Debug.JustUpdateDeviceLine();
if (true) return _t1;
...
try {
		Debug.PushSubsStack("CreateBCTextCharsFromString (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1051);
...
Debug.locals.put("s", _s);
 BA.debugLineNum = 1051;BA.debugLine="Public Sub CreateBCTextCharsFromString (s As Strin";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1052;BA.debugLine="If RTLAware Then LoadArabicData";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_loadarabicdata" /*RemoteObject*/ );};
 BA.debugLineNum = 1053;BA.debugLine="Dim b() As Byte = s.GetBytes(Charset)";
Debug.JustUpdateDeviceLine();
_b = _s.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
 BA.debugLineNum = 1054;BA.debugLine="Dim chars(b.Length / 4) As String";
Debug.JustUpdateDeviceLine();
_chars = RemoteObject.createNewArray ("String", new int[] {(int) (0 + RemoteObject.solve(new RemoteObject[] {_b.getField(true,"length"),RemoteObject.createImmutable(4)}, "/",0, 0).<Double>get().doubleValue())}, new Object[]{});Debug.locals.put("chars", _chars);
 BA.debugLineNum = 1055;BA.debugLine="Dim i, bi As Int = 0";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.createImmutable(0);Debug.locals.put("i", _i);
_bi = BA.numberCast(int.class, 0);Debug.locals.put("bi", _bi);Debug.locals.put("bi", _bi);
 BA.debugLineNum = 1056;BA.debugLine="Dim ShouldAddToPrevChar As Boolean";
Debug.JustUpdateDeviceLine();
_shouldaddtoprevchar = RemoteObject.createImmutable(false);Debug.locals.put("ShouldAddToPrevChar", _shouldaddtoprevchar);
 BA.debugLineNum = 1057;BA.debugLine="Dim ThereAreVowels As Boolean = VowelsCodePoints.";
Debug.JustUpdateDeviceLine();
_therearevowels = BA.ObjectToBoolean(RemoteObject.solveBoolean(">",__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_getsize" /*RemoteObject*/ ),BA.numberCast(double.class, 0)));Debug.locals.put("ThereAreVowels", _therearevowels);Debug.locals.put("ThereAreVowels", _therearevowels);
 BA.debugLineNum = 1058;BA.debugLine="Do While bi <= chars.Length - 1";
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("k",_bi,BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_chars.getField(true,"length"),RemoteObject.createImmutable(1)}, "-",1, 1)))) {
 BA.debugLineNum = 1059;BA.debugLine="chars(i) = BytesToString(b, bi * 4, 4, Charset)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (bctextengine.__c.runMethod(true,"BytesToString",(Object)(_b),(Object)(RemoteObject.solve(new RemoteObject[] {_bi,RemoteObject.createImmutable(4)}, "*",0, 1)),(Object)(BA.numberCast(int.class, 4)),(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ ))),_i);
 BA.debugLineNum = 1060;BA.debugLine="If LookForComplexCharacters Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_lookforcomplexcharacters" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1061;BA.debugLine="Dim cp As Int = BytesToInt(b, bi * 4)";
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_b),(Object)(RemoteObject.solve(new RemoteObject[] {_bi,RemoteObject.createImmutable(4)}, "*",0, 1)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 1062;BA.debugLine="If i > 0 And (cp = 0x200d Or (cp >= 0xFE00 And";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",_cp,BA.numberCast(double.class, ((int)0x200d))) || RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("g",_cp,BA.numberCast(double.class, ((int)0xfe00))) && RemoteObject.solveBoolean("k",_cp,BA.numberCast(double.class, ((int)0xfe0f)))))))))) { 
 BA.debugLineNum = 1063;BA.debugLine="chars(i - 1) = chars(i - 1) & chars(i)";
Debug.JustUpdateDeviceLine();
...
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("g",_cp,BA.numberCast(double.class, ((int)0x1f3fb))) && RemoteObject.solveBoolean("k",_cp,BA.numberCast(double.class, ((int)0x1f3ff))))))) { 
 BA.debugLineNum = 1067;BA.debugLine="chars(i - 1) = chars(i - 1) & chars(i)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (RemoteObject.concat(_chars.getArrayElement(true,RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1)),_chars.getArrayElement(true,_i)),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
 BA.debugLineNum = 1068;BA.debugLine="i = i - 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 1069;BA.debugLine="ShouldAddToPrevChar = False";
Debug.JustUpdateDeviceLine();
_shouldaddtoprevchar = bctextengine.__c.getField(true,"False");Debug.locals.put("ShouldAddToPrevChar", _shouldaddtoprevchar);
 }else 
{ BA.debugLineNum = 1070;BA.debugLine="Else If i > 0 And (ThereAreVowels And VowelsCod";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",_therearevowels) && RemoteObject.solveBoolean(".",__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_cp)))))))) { 
 BA.debugLineNum = 1071;BA.debugLine="chars(i - 1) = chars(i - 1) & chars(i)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (RemoteObject.concat(_chars.getArrayElement(true,RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1)),_chars.getArrayElement(true,_i)),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
...
{ BA.debugLineNum = 1074;BA.debugLine="Else If RTLAware And i > 0 And chars(i - 1) = \"";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(true,"_rtlaware" /*RemoteObject*/ )) && RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean("=",_chars.getArrayElement(true,RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1)),BA.ObjectToString("ل")) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",_cp,BA.numberCast(double.class, ((int)0x622))) || RemoteObject.solveBoolean("=",_cp,BA.numberCast(double.class, ((int)0x623))) || RemoteObject.solveBoolean("=",_cp,BA.numberCast(double.class, ((int)0x625))) || RemoteObject.solveBoolean("=",_cp,BA.numberCast(double.class, ((int)0x627))))))) { 
 BA.debugLineNum = 1075;BA.debugLine="Select cp";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 1077;BA.debugLine="chars(i - 1) = Chr(0xFEF5)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xfef5))))),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
 break; }
case 1: {
 BA.debugLineNum = 1079;BA.debugLine="chars(i - 1) = Chr(0xFEF7)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xfef7))))),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
 break; }
case 2: {
 BA.debugLineNum = 1081;BA.debugLine="chars(i - 1) = Chr(0xFEF9)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xfef9))))),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
 break; }
case 3: {
 BA.debugLineNum = 1083;BA.debugLine="chars(i - 1) = Chr(0xFEFB)";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 1085;BA.debugLine="i = i - 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 1086;BA.debugLine="ShouldAddToPrevChar = False";
Debug.JustUpdateDeviceLine();
_shouldaddtoprevchar = bctextengine.__c.getField(true,"False");Debug.locals.put("ShouldAddToPrevChar", _shouldaddtoprevchar);
 }else 
{ BA.debugLineNum = 1087;BA.debugLine="Else If i > 0 And ShouldAddToPrevChar Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_i,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",_shouldaddtoprevchar)) { 
 BA.debugLineNum = 1088;BA.debugLine="chars(i - 1) = chars(i - 1) & chars(i)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement (RemoteObject.concat(_chars.getArrayElement(true,RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1)),_chars.getArrayElement(true,_i)),RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1));
 BA.debugLineNum = 1089;BA.debugLine="i = i - 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 1090;BA.debugLine="ShouldAddToPrevChar = False";
Debug.JustUpdateDeviceLine();
_shouldaddtoprevchar = bctextengine.__c.getField(true,"False");Debug.locals.put("ShouldAddToPrevChar", _shouldaddtoprevchar);
 }else {
 BA.debugLineNum = 1092;BA.debugLine="ShouldAddToPrevChar = False";
Debug.JustUpdateDeviceLine();
_shouldaddtoprevchar = bctextengine.__c.getField(true,"False");Debug.locals.put("ShouldAddToPrevChar", _shouldaddtoprevchar);
 }}}}}
;
 };
 BA.debugLineNum = 1095;BA.debugLine="i = i + 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("i", _i);
 BA.debugLineNum = 1096;BA.debugLine="bi = bi + 1";
Debug.JustUpdateDeviceLine();
_bi = RemoteObject.solve(new RemoteObject[] {_bi,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("bi", _bi);
 }
;
 BA.debugLineNum = 1098;BA.debugLine="If RTLAware Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1099;BA.debugLine="PreprocessArabic(chars, i)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_preprocessarabic" /*RemoteObject*/ ,(Object)(_chars),(Object)(_i));
 };
 BA.debugLineNum = 1101;BA.debugLine="Return CreateBCTextChars(chars, 0, i)";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(_chars),(Object)(BA.numberCast(int.class, 0)),(Object)(_i));
...
try {
		Debug.PushSubsStack("CreateConnectedParent (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,159);
if (RapidSub.canDelegate("createconnectedparent")) { return __ref.runUserSub(false, "bctextengine","createconnectedparent", __ref);}
RemoteObject _connected = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcconnectedruns");
RemoteObject _parent = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextrun");
...
Debug.JustUpdateDeviceLine();
_connected = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcconnectedruns");Debug.locals.put("connected", _connected);
...
Debug.JustUpdateDeviceLine();
_parent = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createrun" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));Debug.locals.put("parent", _parent);Debug.locals.put("parent", _parent);
...
try {
		Debug.PushSubsStack("CreateGlyph (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,827);
...
RemoteObject _g = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyph");
...
Debug.locals.put("JustMeasure", _justmeasure);
 BA.debugLineNum = 827;BA.debugLine="Private Sub CreateGlyph (c As String, FontMetrics";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 828;BA.debugLine="Dim g As BCGlyph = FontMetrics.Glyphs.Get(c)";
Debug.JustUpdateDeviceLine();
_g = (_fontmetrics.getField(false,"Glyphs" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_c))));Debug.locals.put("g", _g);Debug.locals.put("g", _g);
 BA.debugLineNum = 829;BA.debugLine="If g <> Null Then Return g";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("N",_g)) { 
if (true) return _g;};
 BA.debugLineNum = 830;BA.debugLine="If FontMetrics.clr <> DefaultColor Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_fontmetrics.getField(true,"Clr" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_defaultcolor" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 831;BA.debugLine="Return CreateGlyphFromDefaultColor(c, FontMetric";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyphfromdefaultcolor" /*RemoteObject*/ ,(Object)(_c),(Object)(_fontmetrics.getField(false,"DefaultColorMetrics" /*RemoteObject*/ )),(Object)(_fontmetrics.getField(true,"Clr" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 833;BA.debugLine="cvs.ClearRect(cvs.TargetRect)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("ClearRect",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect")));
 BA.debugLineNum = 834;BA.debugLine="Dim r As B4XRect = cvs.MeasureText(c, FontMetric";
Debug.JustUpdateDeviceLine();
_r = __ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"MeasureText",(Object)(_c),(Object)(_fontmetrics.getField(false,"Fnt" /*RemoteObject*/ )));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 835;BA.debugLine="Dim BaseLine As Int = -r.Top + 5";
Debug.JustUpdateDeviceLine();
_baseline = BA.numberCast(int.class, -(double) (0 + _r.runMethod(true,"getTop").<Float>get().floatValue())+(double) (0 + 5));Debug.locals.put("BaseLine", _baseline);Debug.locals.put("BaseLine", _baseline);
 BA.debugLineNum = 836;BA.debugLine="r.Left = r.Left * mScale";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setLeft",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getLeft"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0)));
 BA.debugLineNum = 837;BA.debugLine="r.Top = r.Top * mScale";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setTop",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getTop"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0)));
 BA.debugLineNum = 838;BA.debugLine="r.Right = r.Right * mScale";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setRight",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getRight"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0)));
 BA.debugLineNum = 839;BA.debugLine="r.Bottom = r.Bottom * mScale";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setBottom",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getBottom"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0)));
 BA.debugLineNum = 840;BA.debugLine="If CharBC.mWidth < r.Width + 20 * mScale Or Char";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",__ref.getField(false,"_charbc" /*RemoteObject*/ ).getField(true,"_mwidth"),RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),RemoteObject.createImmutable(20),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+*",1, 0)) || RemoteObject.solveBoolean("<",__ref.getField(false,"_charbc" /*RemoteObject*/ ).getField(true,"_mheight"),RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),RemoteObject.createImmutable(20),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+*",1, 0))) { 
 BA.debugLineNum = 841;BA.debugLine="ResizeCharBC(r.Width + 30 * mScale, r.Height +";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_resizecharbc" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),RemoteObject.createImmutable(30),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+*",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),RemoteObject.createImmutable(30),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+*",1, 0))));
 };
 BA.debugLineNum = 844;BA.debugLine="Dim leftOffset As Int = 5";
Debug.JustUpdateDeviceLine();
_leftoffset = BA.numberCast(int.class, 5);Debug.locals.put("leftOffset", _leftoffset);Debug.locals.put("leftOffset", _leftoffset);
 BA.debugLineNum = 845;BA.debugLine="cvs.DrawText(c, leftOffset, BaseLine, FontMetric";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawText",__ref.getField(false, "ba"),(Object)(_c),(Object)(BA.numberCast(float.class, _leftoffset)),(Object)(BA.numberCast(float.class, _baseline)),(Object)(_fontmetrics.getField(false,"Fnt" /*RemoteObject*/ )),(Object)(_fontmetrics.getField(true,"Clr" /*RemoteObject*/ )),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Paint.Align"),RemoteObject.createImmutable("LEFT"))));
 BA.debugLineNum = 847;BA.debugLine="Dim bmp As B4XBitmap = cvs.CreateBitmap";
Debug.JustUpdateDeviceLine();
...
_bmp = __ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"CreateBitmap");Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 858;BA.debugLine="CharBC.CopyPixelsFromBitmap(bmp)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_charbc" /*RemoteObject*/ ).runVoidMethod ("_copypixelsfrombitmap",(Object)(_bmp));
 BA.debugLineNum = 859;BA.debugLine="Dim r2 As B4XRect = FindMinRect(leftOffset + r.R";
Debug.JustUpdateDeviceLine();
_r2 = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_findminrect" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_leftoffset,_r.runMethod(true,"getRight"),RemoteObject.createImmutable(20),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "++*",2, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),RemoteObject.createImmutable(20),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+*",1, 0))));Debug.locals.put("r2", _r2);Debug.locals.put("r2", _r2);
 BA.debugLineNum = 861;BA.debugLine="Dim g As BCGlyph";
Debug.JustUpdateDeviceLine();
_g = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcglyph");Debug.locals.put("g", _g);
 BA.debugLineNum = 862;BA.debugLine="g.Initialize";
Debug.JustUpdateDeviceLine();
_g.runVoidMethod ("Initialize");
 BA.debugLineNum = 863;BA.debugLine="g.baseline = BaseLine * mScale - r2.Top";
Debug.JustUpdateDeviceLine();
_g.setField ("baseline" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_baseline,__ref.getField(true,"_mscale" /*RemoteObject*/ ),_r2.runMethod(true,"getTop")}, "*-",1, 0)));
 BA.debugLineNum = 864;BA.debugLine="If r2.Width > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_r2.runMethod(true,"getWidth"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 865;BA.debugLine="r2.Left = Floor(r2.Left)";
Debug.JustUpdateDeviceLine();
_r2.runMethod(true,"setLeft",BA.numberCast(float.class, bctextengine.__c.runMethod(true,"Floor",(Object)(BA.numberCast(double.class, _r2.runMethod(true,"getLeft"))))));
 BA.debugLineNum = 866;BA.debugLine="r2.Right = Ceil(r2.Right)";
Debug.JustUpdateDeviceLine();
_r2.runMethod(true,"setRight",BA.numberCast(float.class, bctextengine.__c.runMethod(true,"Ceil",(Object)(BA.numberCast(double.class, _r2.runMethod(true,"getRight"))))));
 BA.debugLineNum = 867;BA.debugLine="If RTLAware Then RecolorEdgesOfConnectedCharact";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_rtlaware" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_recoloredgesofconnectedcharacters" /*RemoteObject*/ ,(Object)(_c),(Object)(_r2));};
 BA.debugLineNum = 873;BA.debugLine="Dim cbc As CompressedBC = CharBC.ExtractCompres";
Debug.JustUpdateDeviceLine();
_cbc = __ref.getField(false,"_charbc" /*RemoteObject*/ ).runMethod(false,"_extractcompressedbc",(Object)(_r2),(Object)(__ref.getField(false,"_cbccache" /*RemoteObject*/ )));Debug.locals.put("cbc", _cbc);Debug.locals.put("cbc", _cbc);
 BA.debugLineNum = 874;BA.debugLine="g.cbc = cbc";
Debug.JustUpdateDeviceLine();
_g.setField ("cbc" /*RemoteObject*/ ,_cbc);
 BA.debugLineNum = 875;BA.debugLine="g.width = cbc.mWidth";
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,_cbc.getField(true,"mWidth"));
 }else {
 BA.debugLineNum = 877;BA.debugLine="g.Empty = True";
Debug.JustUpdateDeviceLine();
_g.setField ("Empty" /*RemoteObject*/ ,bctextengine.__c.getField(true,"True"));
 BA.debugLineNum = 878;BA.debugLine="If c = TAB Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,bctextengine.__c.getField(true,"TAB"))) { 
 BA.debugLineNum = 879;BA.debugLine="g.Width = FontMetrics.xWidth * TabWidthMeasure";
Debug.JustUpdateDeviceLine();
...
{ BA.debugLineNum = 880;BA.debugLine="Else if c = \" \" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,BA.ObjectToString(" "))) { 
 BA.debugLineNum = 881;BA.debugLine="g.width = CreateGlyph(\"x x\", FontMetrics, True";
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("x x")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True"))).getField(true,"Width" /*RemoteObject*/ ),_fontmetrics.getField(true,"xWidth" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "-*",1, 1));
 }else 
{ BA.debugLineNum = 882;BA.debugLine="Else If c = \"x\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,BA.ObjectToString("x"))) { 
 BA.debugLineNum = 883;BA.debugLine="g = CreateGlyph(\"X\", FontMetrics, True)";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else 
{ BA.debugLineNum = 884;BA.debugLine="Else If c = \"x x\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_c,BA.ObjectToString("x x"))) { 
 BA.debugLineNum = 885;BA.debugLine="g = CreateGlyph(\"X X\", FontMetrics, True)";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("X X")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("g", _g);
 }else {
 BA.debugLineNum = 887;BA.debugLine="g.Width = CreateGlyph(\" \", FontMetrics, False)";
Debug.JustUpdateDeviceLine();
_g.setField ("Width" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString(" ")),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }}}}
;
 };
 BA.debugLineNum = 890;BA.debugLine="If xui.IsB4J = False And MightBeAnEmoji(c) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4J"),bctextengine.__c.getField(true,"False")) && RemoteObject.solveBoolean(".",__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_mightbeanemoji" /*RemoteObject*/ ,(Object)(_c)))) { 
 BA.debugLineNum = 891;BA.debugLine="If Emojis.IsInitialized = False Then LoadData(E";
Debug.JustUpdateDeviceLine();
...
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_emojis" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("emoji-data.txt")));};
 BA.debugLineNum = 892;BA.debugLine="g.Emoji = Emojis.Contains(BytesToInt(c.GetBytes";
Debug.JustUpdateDeviceLine();
_g.setField ("Emoji" /*RemoteObject*/ ,__ref.getField(false,"_emojis" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_c.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)))))));
 };
 BA.debugLineNum = 894;BA.debugLine="If JustMeasure = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_justmeasure,bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 895;BA.debugLine="FontMetrics.Glyphs.Put(c, g)";
Debug.JustUpdateDeviceLine();
_fontmetrics.getField(false,"Glyphs" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_c)),(Object)((_g)));
 };
 BA.debugLineNum = 897;BA.debugLine="Return g";
Debug.JustUpdateDeviceLine();
if (true) return _g;
 };
...
try {
		Debug.PushSubsStack("CreateGlyphFromDefaultColor (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,933);
...
RemoteObject _blackglyph = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyph");
RemoteObject _g = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyph");
...
Debug.locals.put("clr", _clr);
 BA.debugLineNum = 933;BA.debugLine="Private Sub CreateGlyphFromDefaultColor(c As Strin";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 934;BA.debugLine="Dim BlackGlyph As BCGlyph = CreateGlyph(c, Defaul";
Debug.JustUpdateDeviceLine();
_blackglyph = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_c),(Object)(_defaultcolormetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("BlackGlyph", _blackglyph);Debug.locals.put("BlackGlyph", _blackglyph);
 BA.debugLineNum = 935;BA.debugLine="If BlackGlyph.cbc.IsInitialized = False Or BlackG";
Debug.JustUpdateDeviceLine();
...
_g.getField(false,"cbc" /*RemoteObject*/ ).setField ("TargetRect",_blackglyph.getField(false,"cbc" /*RemoteObject*/ ).getField(false,"TargetRect"));
 BA.debugLineNum = 946;BA.debugLine="Dim buffer(BlackGlyph.cbc.mBuffer.Length) As Byte";
Debug.JustUpdateDeviceLine();
...
_bi = RemoteObject.createImmutable(0);Debug.locals.put("bi", _bi);
 BA.debugLineNum = 951;BA.debugLine="ai = 3";
Debug.JustUpdateDeviceLine();
_ai = BA.numberCast(int.class, 3);Debug.locals.put("ai", _ai);
 BA.debugLineNum = 952;BA.debugLine="ri = 0";
Debug.JustUpdateDeviceLine();
_ri = BA.numberCast(int.class, 0);Debug.locals.put("ri", _ri);
 BA.debugLineNum = 953;BA.debugLine="gi = 1";
Debug.JustUpdateDeviceLine();
_gi = BA.numberCast(int.class, 1);Debug.locals.put("gi", _gi);
 BA.debugLineNum = 954;BA.debugLine="bi = 2";
Debug.JustUpdateDeviceLine();
_bi = BA.numberCast(int.class, 2);Debug.locals.put("bi", _bi);
 BA.debugLineNum = 961;BA.debugLine="For i = 0 To buffer.Length - 1 Step 4";
Debug.JustUpdateDeviceLine();
{
final int step21 = 4;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 970;BA.debugLine="Dim a As Int = Bit.And(0xff, BlackGlyph.cbc.mBuf";
Debug.JustUpdateDeviceLine();
_a = bctextengine.__c.getField(false,"Bit").runMethod(true,"And",(Object)(BA.numberCast(int.class, ((int)0xff))),(Object)(BA.numberCast(int.class, _blackglyph.getField(false,"cbc" /*RemoteObject*/ ).getField(false,"mBuffer").getArrayElement(true,RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_ai}, "+",1, 1)))));Debug.locals.put("a", _a);Debug.locals.put("a", _a);
 BA.debugLineNum = 971;BA.debugLine="Dim af As Float = a / 255";
Debug.JustUpdateDeviceLine();
_af = BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_a,RemoteObject.createImmutable(255)}, "/",0, 0));Debug.locals.put("af", _af);Debug.locals.put("af", _af);
 BA.debugLineNum = 972;BA.debugLine="buffer(i + ai) = a";
Debug.JustUpdateDeviceLine();
_buffer.setArrayElement (BA.numberCast(byte.class, _a),RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_ai}, "+",1, 1));
 BA.debugLineNum = 973;BA.debugLine="buffer(i + ri) = argb.r * af";
Debug.JustUpdateDeviceLine();
_buffer.setArrayElement (BA.numberCast(byte.class, RemoteObject.solve(new RemoteObject[] {_argb.getField(true,"r"),_af}, "*",0, 0)),RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_ri}, "+",1, 1));
 BA.debugLineNum = 974;BA.debugLine="buffer(i + gi) = argb.g * af";
Debug.JustUpdateDeviceLine();
_buffer.setArrayElement (BA.numberCast(byte.class, RemoteObject.solve(new RemoteObject[] {_argb.getField(true,"g"),_af}, "*",0, 0)),RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_gi}, "+",1, 1));
 BA.debugLineNum = 975;BA.debugLine="buffer(i + bi) = argb.b * af";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 978;BA.debugLine="g.cbc.mBuffer = buffer";
Debug.JustUpdateDeviceLine();
_g.getField(false,"cbc" /*RemoteObject*/ ).setField ("mBuffer",_buffer);
 BA.debugLineNum = 979;BA.debugLine="Return g";
Debug.JustUpdateDeviceLine();
if (true) return _g;
...
try {
		Debug.PushSubsStack("CreateLine (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,399);
if (RapidSub.canDelegate("createline")) { return __ref.runUserSub(false, "bctextengine","createline", __ref, _p);}
RemoteObject _line = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextline");
...
Debug.JustUpdateDeviceLine();
_line = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bctextline");Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("CreateRun (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,147);
if (RapidSub.canDelegate("createrun")) { return __ref.runUserSub(false, "bctextengine","createrun", __ref, _text);}
RemoteObject _r = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextrun");
...
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bctextrun");Debug.locals.put("r", _r);
...
Debug.JustUpdateDeviceLine();
_r.setField ("TextChars" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(_text)));
...
try {
		Debug.PushSubsStack("CreateSingleSection (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,568);
...
RemoteObject _single = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
RemoteObject _prevchar = RemoteObject.createImmutable("");
RemoteObject _prevgo = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyphandoffset");
int _i = 0;
RemoteObject _s = RemoteObject.createImmutable("");
RemoteObject _go = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyphandoffset");
RemoteObject _g = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcglyph");
RemoteObject _u = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcstyledunderline");
Debug.locals.put("Run", _run);
Debug.locals.put("TextChars", _textchars);
Debug.locals.put("FontMetrics", _fontmetrics);
 BA.debugLineNum = 568;BA.debugLine="Private Sub CreateSingleSection (Run As BCTextRun,";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 569;BA.debugLine="Dim single As BCSingleStyleSection";
Debug.JustUpdateDeviceLine();
_single = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");Debug.locals.put("single", _single);
 BA.debugLineNum = 570;BA.debugLine="single.Initialize";
Debug.JustUpdateDeviceLine();
_single.runVoidMethod ("Initialize");
 BA.debugLineNum = 571;BA.debugLine="single.GlyphsAndOffsets.Initialize";
Debug.JustUpdateDeviceLine();
_single.getField(false,"GlyphsAndOffsets" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 572;BA.debugLine="single.Run = Run";
Debug.JustUpdateDeviceLine();
_single.setField ("Run" /*RemoteObject*/ ,_run);
 BA.debugLineNum = 573;BA.debugLine="single.fm = FontMetrics";
Debug.JustUpdateDeviceLine();
_single.setField ("fm" /*RemoteObject*/ ,_fontmetrics);
 BA.debugLineNum = 574;BA.debugLine="Dim PrevChar As String";
Debug.JustUpdateDeviceLine();
_prevchar = RemoteObject.createImmutable("");Debug.locals.put("PrevChar", _prevchar);
 BA.debugLineNum = 575;BA.debugLine="Dim PrevGO As BCGlyphAndOffset";
Debug.JustUpdateDeviceLine();
_prevgo = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcglyphandoffset");Debug.locals.put("PrevGO", _prevgo);
 BA.debugLineNum = 576;BA.debugLine="For i = 0 To TextChars.Length - 1";
Debug.JustUpdateDeviceLine();
{
final int step8 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 577;BA.debugLine="Dim s As String = TextChars.Buffer(i + TextChars";
Debug.JustUpdateDeviceLine();
_s = _textchars.getField(false,"Buffer" /*RemoteObject*/ ).getArrayElement(true,RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_textchars.getField(true,"StartIndex" /*RemoteObject*/ )}, "+",1, 1));Debug.locals.put("s", _s);Debug.locals.put("s", _s);
 BA.debugLineNum = 578;BA.debugLine="Dim go As BCGlyphAndOffset";
Debug.JustUpdateDeviceLine();
_go = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcglyphandoffset");Debug.locals.put("go", _go);
 BA.debugLineNum = 579;BA.debugLine="Dim g As BCGlyph = CreateGlyph(s, FontMetrics, F";
Debug.JustUpdateDeviceLine();
_g = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_s),(Object)(_fontmetrics),(Object)(bctextengine.__c.getField(true,"False")));Debug.locals.put("g", _g);Debug.locals.put("g", _g);
 BA.debugLineNum = 580;BA.debugLine="If i > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 581;BA.debugLine="If KerningEnabled Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_kerningenabled" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 582;BA.debugLine="PrevGO.SpaceBetweenThisAndNext = GetKernSpaceB";
Debug.JustUpdateDeviceLine();
_prevgo.setField ("SpaceBetweenThisAndNext" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getkernspacebetweenchars" /*RemoteObject*/ ,(Object)(_fontmetrics),(Object)(_prevchar),(Object)(_s),(Object)(_prevgo.getField(false,"Glyph" /*RemoteObject*/ )),(Object)(_g)));
 }else {
 BA.debugLineNum = 584;BA.debugLine="PrevGO.SpaceBetweenThisAndNext = mSpaceBetween";
Debug.JustUpdateDeviceLine();
_prevgo.setField ("SpaceBetweenThisAndNext" /*RemoteObject*/ ,BA.numberCast(int.class, __ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 587;BA.debugLine="go.Glyph = g";
Debug.JustUpdateDeviceLine();
_go.setField ("Glyph" /*RemoteObject*/ ,_g);
 BA.debugLineNum = 588;BA.debugLine="single.GlyphsAndOffsets.Add(go)";
Debug.JustUpdateDeviceLine();
_single.getField(false,"GlyphsAndOffsets" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_go)));
 BA.debugLineNum = 589;BA.debugLine="If g.cbc.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (_g.getField(false,"cbc" /*RemoteObject*/ ).getField(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 590;BA.debugLine="single.MaxHeightAboveBaseLine = Max(single.MaxH";
Debug.JustUpdateDeviceLine();
_single.setField ("MaxHeightAboveBaseLine" /*RemoteObject*/ ,BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _single.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ ))),(Object)(RemoteObject.solve(new RemoteObject[] {_g.getField(true,"baseline" /*RemoteObject*/ ),_run.getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "-*",1, 0)))));
 BA.debugLineNum = 591;BA.debugLine="single.MaxHeightBelowBaseLine = Max(single.MaxH";
Debug.JustUpdateDeviceLine();
_single.setField ("MaxHeightBelowBaseLine" /*RemoteObject*/ ,BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _single.getField(true,"MaxHeightBelowBaseLine" /*RemoteObject*/ ))),(Object)(RemoteObject.solve(new RemoteObject[] {_g.getField(false,"cbc" /*RemoteObject*/ ).getField(true,"mHeight"),_g.getField(true,"baseline" /*RemoteObject*/ ),_run.getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "-+*",2, 0)))));
 ...
 BA.debugLineNum = 593;BA.debugLine="single.Width = single.Width + g.Width";
Debug.JustUpdateDeviceLine();
_single.setField ("Width" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {_single.getField(true,"Width" /*RemoteObject*/ ),_g.getField(true,"Width" /*RemoteObject*/ )}, "+",1, 1));
 BA.debugLineNum = 594;BA.debugLine="If i > 0 Then single.Width = single.Width + Prev";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0))) { 
_single.setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_single.getField(true,"Width" /*RemoteObject*/ ),_prevgo.getField(true,"SpaceBetweenThisAndNext" /*RemoteObject*/ ),_run.getField(true,"CharacterSpacingFactor" /*RemoteObject*/ )}, "+*",1, 0)));};
 BA.debugLineNum = 595;BA.debugLine="If Run.Underline Or Run.AutoUnderline Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_run.getField(true,"Underline" /*RemoteObject*/ )) || RemoteObject.solveBoolean(".",_run.getField(true,"AutoUnderline" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 596;BA.debugLine="Dim u As BCStyledUnderline = GetUnderlineStyle(";
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_run));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
 BA.debugLineNum = 597;BA.debugLine="single.MaxHeightBelowBaseLine = Max((u.Thicknes";
Debug.JustUpdateDeviceLine();
_single.setField ("MaxHeightBelowBaseLine" /*RemoteObject*/ ,BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Max",(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_u.getField(true,"Thickness" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "+",1, 0)),__ref.getField(true,"_mscale" /*RemoteObject*/ ),_run.getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*+*",1, 0)),(Object)(BA.numberCast(double.class, _single.getField(true,"MaxHeightBelowBaseLine" /*RemoteObject*/ ))))));
 ...
 BA.debugLineNum = 599;BA.debugLine="PrevGO = go";
Debug.JustUpdateDeviceLine();
_prevgo = _go;Debug.locals.put("PrevGO", _prevgo);
 BA.debugLineNum = 600;BA.debugLine="PrevChar = s";
Debug.JustUpdateDeviceLine();
_prevchar = _s;Debug.locals.put("PrevChar", _prevchar);
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 602;BA.debugLine="If i > 0 Then single.Width = single.Width + PrevG";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0))) { 
_single.setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_single.getField(true,"Width" /*RemoteObject*/ ),_prevgo.getField(true,"SpaceBetweenThisAndNext" /*RemoteObject*/ ),_run.getField(true,"CharacterSpacingFactor" /*RemoteObject*/ )}, "+*",1, 0)));};
 BA.debugLineNum = 603;BA.debugLine="If TextChars.Length = 0 And Run.View.IsInitialize";
Debug.JustUpdateDeviceLine();
...
_single.setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"getWidth"),__ref.getField(true,"_mscale" /*RemoteObject*/ ),__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*+*",1, 0)));
 BA.debugLineNum = 607;BA.debugLine="single.MaxHeightAboveBaseLine = (Run.View.Height";
Debug.JustUpdateDeviceLine();
_single.setField ("MaxHeightAboveBaseLine" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"getHeight"),_run.getField(true,"VerticalOffset" /*RemoteObject*/ )}, "-",1, 1)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0)));
 BA.debugLineNum = 608;BA.debugLine="single.MaxHeightBelowBaseLine = Run.View.Height";
Debug.JustUpdateDeviceLine();
_single.setField ("MaxHeightBelowBaseLine" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_run.getField(false,"View" /*RemoteObject*/ ).runMethod(true,"getHeight"),__ref.getField(true,"_mscale" /*RemoteObject*/ ),_single.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "*-",1, 0)));
 ...
 BA.debugLineNum = 611;BA.debugLine="Return single";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateStyle (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,136);
if (RapidSub.canDelegate("createstyle")) { return __ref.runUserSub(false, "bctextengine","createstyle", __ref);}
RemoteObject _s = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcparagraphstyle");
...
Debug.JustUpdateDeviceLine();
_s = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraphstyle");Debug.locals.put("s", _s);
...
try {
		Debug.PushSubsStack("CreateUnbreakable (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,477);
...
RemoteObject _unbreakable = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _single = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
Debug.locals.put("TextChars", _textchars);
Debug.locals.put("FontMetrics", _fontmetrics);
...
Debug.JustUpdateDeviceLine();
_unbreakable = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");Debug.locals.put("unbreakable", _unbreakable);
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(_textchars),(Object)(_fontmetrics));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
Debug.JustUpdateDeviceLine();
_unbreakable.setField ("RTL" /*RemoteObject*/ ,BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_run.getField(true,"TextDirection" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_textdirectionrtl" /*RemoteObject*/ ))) || RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",_run.getField(true,"TextDirection" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_textdirectionunknown" /*RemoteObject*/ ))) && RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_detectrtl" /*RemoteObject*/ ,(Object)(_unbreakable)),bctextengine.__c.getField(true,"True")))))));
 };
 BA.debugLineNum = 490;BA.debugLine="unbreakable.Anchor = GetRunAnchorIfCurrentNotSet(";
Debug.JustUpdateDeviceLine();
_unbreakable.setField ("Anchor" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getrunanchorifcurrentnotset" /*RemoteObject*/ ,(Object)(_run),(Object)(RemoteObject.createImmutable(""))));
 BA.debugLineNum = 491;BA.debugLine="Return unbreakable";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DetectRTL (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,494);
...
Debug.locals.put("un", _un);
 BA.debugLineNum = 494;BA.debugLine="Private Sub DetectRTL (un As BCUnbreakableText) As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 495;BA.debugLine="If un.NotFullTextChars.Length = 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(true,"Length" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 496;BA.debugLine="Return True";
Debug.JustUpdateDeviceLine();
if (true) return bctextengine.__c.getField(true,"True");
 };
 BA.debugLineNum = 498;BA.debugLine="If RTLChars.IsInitialized = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_rtlchars" /*RemoteObject*/ ).runMethod(true,"IsInitialized" /*RemoteObject*/ ),bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 499;BA.debugLine="LoadData(RTLChars, \"rtl-data.txt\")";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_loaddata" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_rtlchars" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("rtl-data.txt")));
 };
 BA.debugLineNum = 501;BA.debugLine="Dim firstChar As String = un.NotFullTextChars.Buf";
Debug.JustUpdateDeviceLine();
_firstchar = _un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(false,"Buffer" /*RemoteObject*/ ).getArrayElement(true,_un.getField(false,"NotFullTextChars" /*RemoteObject*/ ).getField(true,"StartIndex" /*RemoteObject*/ ));Debug.locals.put("firstChar", _firstchar);Debug.locals.put("firstChar", _firstchar);
 BA.debugLineNum = 502;BA.debugLine="Dim cp As Int = BytesToInt(firstChar.GetBytes(Cha";
Debug.JustUpdateDeviceLine();
_cp = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_bytestoint" /*RemoteObject*/ ,(Object)(_firstchar.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))),(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 503;BA.debugLine="Return RTLChars.Contains(cp)";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_rtlchars" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_cp)));
...
try {
		Debug.PushSubsStack("DrawLine (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,695);
...
Debug.locals.put("OffsetY", _offsety);
 BA.debugLineNum = 695;BA.debugLine="Private Sub DrawLine(line As BCTextLine, OffsetY A";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 696;BA.debugLine="For Each un As BCUnbreakableText In line.Unbreaka";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("un", _un);
 BA.debugLineNum = 697;BA.debugLine="DrawUnbreakable(un, OffsetY)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawunbreakable" /*RemoteObject*/ ,(Object)(_un),(Object)(_offsety));
 }
}Debug.locals.put("un", _un);
;
...
try {
		Debug.PushSubsStack("DrawParagraph (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,629);
...
Debug.locals.put("Paragraph", _paragraph);
 BA.debugLineNum = 629;BA.debugLine="Private Sub DrawParagraph (Paragraph As BCParagrap";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 630;BA.debugLine="For Each line As BCTextLine In Paragraph.TextLine";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("line", _line);
 BA.debugLineNum = 631;BA.debugLine="DrawLine(line, line.BaselineY)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"BaselineY" /*RemoteObject*/ )));
 }
}Debug.locals.put("line", _line);
;
...
try {
		Debug.PushSubsStack("DrawSingleLine (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,635);
...
Debug.locals.put("par", _par);
 BA.debugLineNum = 635;BA.debugLine="Public Sub DrawSingleLine (line As BCTextLine, iv";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 636;BA.debugLine="Dim r As B4XRect = DrawSingleLineShared(line, iv,";
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawsinglelineshared" /*RemoteObject*/ ,(Object)(_line),(Object)(_iv),(Object)(_par));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
...
if (RemoteObject.solveBoolean(">",_r.runMethod(true,"getWidth"),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",_r.runMethod(true,"getHeight"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 638;BA.debugLine="ForegroundBC.DrawRect2(r, GetBrush(xui.Color_Tra";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2",(Object)(_r),(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 639;BA.debugLine="DrawLine(line, line.MaxHeightAboveBaseLine)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )));
 BA.debugLineNum = 640;BA.debugLine="ForegroundBC.SetBitmapToImageView(ForegroundBC.B";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DrawSingleLineAsync (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,652);
...
Debug.locals.put("Target", _target);
 BA.debugLineNum = 652;BA.debugLine="Public Sub DrawSingleLineAsync (line As BCTextLine";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 653;BA.debugLine="Dim r As B4XRect = DrawSingleLineShared(line, iv,";
Debug.JustUpdateDeviceLine();
_r = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawsinglelineshared" /*RemoteObject*/ ,(Object)(_line),(Object)(_iv),(Object)(_par));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 654;BA.debugLine="If r.Width > 0 And r.Height > 0 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_r.runMethod(true,"getWidth"),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",_r.runMethod(true,"getHeight"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 655;BA.debugLine="AsyncMode = True";
Debug.JustUpdateDeviceLine();
__ref.setField ("_asyncmode" /*RemoteObject*/ ,bctextengine.__c.getField(true,"True"));
 BA.debugLineNum = 656;BA.debugLine="If AsyncBCs.IsInitialized = False Then AsyncBCs.";
Debug.JustUpdateDeviceLine();
...
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));};
 BA.debugLineNum = 657;BA.debugLine="Dim AsyncTasks As List";
Debug.JustUpdateDeviceLine();
bctextengine._asynctasks = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_asynctasks",bctextengine._asynctasks);
 BA.debugLineNum = 658;BA.debugLine="AsyncTasks.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 659;BA.debugLine="AsyncBC = FindAsyncBC (r.Width, r.Height)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_asyncbc" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_findasyncbc" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _r.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _r.runMethod(true,"getHeight")))));
 BA.debugLineNum = 660;BA.debugLine="AsyncTasks.Add(AsyncBC.AsyncDrawRect(r, GetBrush";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect",(Object)(_r),(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
 BA.debugLineNum = 661;BA.debugLine="DrawLine(line, line.MaxHeightAboveBaseLine)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawline" /*RemoteObject*/ ,(Object)(_line),(Object)(_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )));
 BA.debugLineNum = 662;BA.debugLine="AsyncBC.DrawBitmapCreatorsAsync(Target, \"BC\", As";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runVoidMethod ("_drawbitmapcreatorsasync",(Object)(_target),(Object)(BA.ObjectToString("BC")),(Object)(__ref.getField(false,"_asynctasks" /*RemoteObject*/ )));
 BA.debugLineNum = 663;BA.debugLine="AsyncMode = False";
Debug.JustUpdateDeviceLine();
__ref.setField ("_asyncmode" /*RemoteObject*/ ,bctextengine.__c.getField(true,"False"));
 BA.debugLineNum = 664;BA.debugLine="Return AsyncBC";
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_asyncbc" /*RemoteObject*/ );
 };
 BA.debugLineNum = 666;BA.debugLine="Return Null";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DrawSingleLineShared (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,644);
...
Debug.locals.put("iv", _iv);
Debug.locals.put("par", _par);
 BA.debugLineNum = 644;BA.debugLine="Private Sub DrawSingleLineShared (line As BCTextLi";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 645;BA.debugLine="Dim r As B4XRect";
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XCanvas.B4XRect");Debug.locals.put("r", _r);
 BA.debugLineNum = 646;BA.debugLine="r.Initialize(0, 0, ForegroundBC.mWidth, line.MaxH";
Debug.JustUpdateDeviceLine();
_r.runVoidMethod ("Initialize",(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, 0)),(Object)(BA.numberCast(float.class, __ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).getField(true,"_mwidth"))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ ),_line.getField(true,"MaxHeightBelowBaseLine" /*RemoteObject*/ )}, "+",1, 1))));
 BA.debugLineNum = 647;BA.debugLine="iv.SetLayoutAnimated(0,  par.Style.Padding.Left,";
Debug.JustUpdateDeviceLine();
_iv.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, _par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_par.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getTop"),(RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "-",1, 1)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "+/",1, 0))),(Object)(BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0))))),(Object)(BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0))))));
 BA.debugLineNum = 649;BA.debugLine="Return r";
Debug.JustUpdateDeviceLine();
if (true) return _r;
...
try {
		Debug.PushSubsStack("DrawSingleStyleSection (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,707);
...
Debug.locals.put("OffsetY", _offsety);
 BA.debugLineNum = 707;BA.debugLine="Private Sub DrawSingleStyleSection (single As BCSi";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 708;BA.debugLine="Dim OffsetX As Int = single.AbsoluteStartX";
Debug.JustUpdateDeviceLine();
_offsetx = _single.getField(true,"AbsoluteStartX" /*RemoteObject*/ );Debug.locals.put("OffsetX", _offsetx);Debug.locals.put("OffsetX", _offsetx);
 BA.debugLineNum = 709;BA.debugLine="Dim rtl As Boolean = single.ParentUN.RTL";
Debug.JustUpdateDeviceLine();
_rtl = _single.getField(false,"ParentUN" /*RemoteObject*/ ).getField(true,"RTL" /*RemoteObject*/ );Debug.locals.put("rtl", _rtl);Debug.locals.put("rtl", _rtl);
 BA.debugLineNum = 710;BA.debugLine="If rtl Then OffsetX = single.AbsoluteStartX + sin";
Debug.JustUpdateDeviceLine();
...
_offsetx = RemoteObject.solve(new RemoteObject[] {_single.getField(true,"AbsoluteStartX" /*RemoteObject*/ ),_single.getField(true,"Width" /*RemoteObject*/ )}, "+",1, 1);Debug.locals.put("OffsetX", _offsetx);};
 BA.debugLineNum = 711;BA.debugLine="For Each go As BCGlyphAndOffset In single.GlyphsA";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("go", _go);
 BA.debugLineNum = 712;BA.debugLine="Dim g As BCGlyph = go.Glyph";
Debug.JustUpdateDeviceLine();
_g = _go.getField(false,"Glyph" /*RemoteObject*/ );Debug.locals.put("g", _g);Debug.locals.put("g", _g);
 BA.debugLineNum = 714;BA.debugLine="If g = Null Then Continue";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("n",_g)) { 
if (true) continue;};
 BA.debugLineNum = 716;BA.debugLine="Dim x As Int = OffsetX";
Debug.JustUpdateDeviceLine();
_x = _offsetx;Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 717;BA.debugLine="If rtl Then x = x - g.cbc.mWidth";
Debug.JustUpdateDeviceLine();
if (_rtl.<Boolean>get().booleanValue()) { 
_x = RemoteObject.solve(new RemoteObject[] {_x,_g.getField(false,"cbc" /*RemoteObject*/ ).getField(true,"mWidth")}, "-",1, 1);Debug.locals.put("x", _x);};
 BA.debugLineNum = 718;BA.debugLine="If g.cbc.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (_g.getField(false,"cbc" /*RemoteObject*/ ).getField(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 719;BA.debugLine="If AsyncMode Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_asyncmode" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 720;BA.debugLine="Dim dt As DrawTask = AsyncBC.CreateDrawTask(g.";
Debug.JustUpdateDeviceLine();
_dt = __ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_createdrawtask",(Object)((_g.getField(false,"cbc" /*RemoteObject*/ ))),(Object)(_g.getField(false,"cbc" /*RemoteObject*/ ).getField(false,"TargetRect")),(Object)(_x),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_offsety,_g.getField(true,"baseline" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "-+*",2, 0))),(Object)(bctextengine.__c.getField(true,"True")));Debug.locals.put("dt", _dt);Debug.locals.put("dt", _dt);
 BA.debugLineNum = 721;BA.debugLine="dt.IsCompressedSource = True";
Debug.JustUpdateDeviceLine();
_dt.setField ("IsCompressedSource",bctextengine.__c.getField(true,"True"));
 BA.debugLineNum = 722;BA.debugLine="AsyncTasks.Add(dt)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_dt)));
 }else {
 BA.debugLineNum = 724;BA.debugLine="ForegroundBC.DrawCompressedBitmap(g.cbc, g.cbc";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawcompressedbitmap",(Object)(_g.getField(false,"cbc" /*RemoteObject*/ )),(Object)(_g.getField(false,"cbc" /*RemoteObject*/ ).getField(false,"TargetRect")),(Object)(_x),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_offsety,_g.getField(true,"baseline" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "-+*",2, 0))));
 ...
 BA.debugLineNum = 727;BA.debugLine="If single.Run.Underline Then";
Debug.JustUpdateDeviceLine();
if (_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"Underline" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 728;BA.debugLine="Dim u As BCStyledUnderline = GetUnderlineStyle(";
Debug.JustUpdateDeviceLine();
_u = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getunderlinestyle" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
 BA.debugLineNum = 729;BA.debugLine="Dim clr As Int = u.Clr";
Debug.JustUpdateDeviceLine();
_clr = _u.getField(true,"Clr" /*RemoteObject*/ );Debug.locals.put("clr", _clr);Debug.locals.put("clr", _clr);
 BA.debugLineNum = 730;BA.debugLine="If clr = 0 Then clr = single.Run.TextColor";
Debug.JustUpdateDeviceLine();
...
_clr = _single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"TextColor" /*RemoteObject*/ );Debug.locals.put("clr", _clr);};
 BA.debugLineNum = 731;BA.debugLine="Dim r As B4XRect";
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XCanvas.B4XRect");Debug.locals.put("r", _r);
 BA.debugLineNum = 732;BA.debugLine="r.Initialize(x, single.Run.VerticalOffset * mSc";
Debug.JustUpdateDeviceLine();
_r.runVoidMethod ("Initialize",(Object)(BA.numberCast(float.class, _x)),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ ),_offsety,__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*++",2, 0))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_x,_g.getField(true,"Width" /*RemoteObject*/ ),__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ ),_go.getField(true,"SpaceBetweenThisAndNext" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"CharacterSpacingFactor" /*RemoteObject*/ )}, "+++*",3, 0))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_offsety,__ref.getField(true,"_mscale" /*RemoteObject*/ ),_u.getField(true,"Thickness" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"VerticalOffset" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "++*+*",3, 0))));
 BA.debugLineNum = 734;BA.debugLine="If AsyncMode Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_asyncmode" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 735;BA.debugLine="AsyncTasks.Add(AsyncBC.AsyncDrawRect(r, GetBru";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asynctasks" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((__ref.getField(false,"_asyncbc" /*RemoteObject*/ ).runMethod(false,"_asyncdrawrect",(Object)(_r),(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(_clr))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0))))));
 }else {
 BA.debugLineNum = 737;BA.debugLine="ForegroundBC.DrawRect2(r, GetBrush(clr), True,";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runVoidMethod ("_drawrect2",(Object)(_r),(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getbrush" /*RemoteObject*/ ,(Object)(_clr))),(Object)(bctextengine.__c.getField(true,"True")),(Object)(BA.numberCast(int.class, 0)));
 };
 };
 BA.debugLineNum = 740;BA.debugLine="If rtl Then";
Debug.JustUpdateDeviceLine();
if (_rtl.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 741;BA.debugLine="OffsetX = OffsetX - g.Width - go.SpaceBetweenTh";
Debug.JustUpdateDeviceLine();
_offsetx = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_offsetx,_g.getField(true,"Width" /*RemoteObject*/ ),_go.getField(true,"SpaceBetweenThisAndNext" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"CharacterSpacingFactor" /*RemoteObject*/ )}, "--*",2, 0));Debug.locals.put("OffsetX", _offsetx);
 ...
 BA.debugLineNum = 743;BA.debugLine="OffsetX = OffsetX + g.Width + go.SpaceBetweenTh";
Debug.JustUpdateDeviceLine();
_offsetx = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_offsetx,_g.getField(true,"Width" /*RemoteObject*/ ),_go.getField(true,"SpaceBetweenThisAndNext" /*RemoteObject*/ ),_single.getField(false,"Run" /*RemoteObject*/ ).getField(true,"CharacterSpacingFactor" /*RemoteObject*/ )}, "++*",2, 0));Debug.locals.put("OffsetX", _offsetx);
 };
 }
...
try {
		Debug.PushSubsStack("DrawText (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,204);
...
RemoteObject _par = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcparagraph");
...
Debug.JustUpdateDeviceLine();
_par = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_prepare" /*RemoteObject*/ ,(Object)(_runs),(Object)(_style));Debug.locals.put("par", _par);Debug.locals.put("par", _par);
 BA.debugLineNum = 208;BA.debugLine="ResizeLayers(par.Width, par.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(_par.getField(true,"Width" /*RemoteObject*/ )),(Object)(_par.getField(true,"Height" /*RemoteObject*/ )));
 BA.debugLineNum = 209;BA.debugLine="DrawParagraph(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawparagraph" /*RemoteObject*/ ,(Object)(_par));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_resizeimageview" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_foregroundbc" /*RemoteObject*/ )),(Object)(_par),(Object)(_foregroundimageview),(Object)(_par.getField(false,"Style" /*RemoteObject*/ ).getField(true,"ResizeHeightAutomatically" /*RemoteObject*/ )));
 };
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_addparagraphviews" /*RemoteObject*/ ,(Object)(_par));
...
try {
		Debug.PushSubsStack("DrawUnbreakable (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,701);
if (RapidSub.canDelegate("drawunbreakable")) { return __ref.runUserSub(false, "bctextengine","drawunbreakable", __ref, _un, _offsety);}
RemoteObject _single = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
Debug.locals.put("un", _un);
Debug.locals.put("OffsetY", _offsety);
 BA.debugLineNum = 701;BA.debugLine="Private Sub DrawUnbreakable (un As BCUnbreakableTe";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 702;BA.debugLine="For Each single As BCSingleStyleSection In un.Sin";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("single", _single);
 BA.debugLineNum = 703;BA.debugLine="DrawSingleStyleSection(single, OffsetY)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_drawsinglestylesection" /*RemoteObject*/ ,(Object)(_single),(Object)(_offsety));
 }
}Debug.locals.put("single", _single);
;
...
try {
		Debug.PushSubsStack("FindAsyncBC (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,669);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 669;BA.debugLine="Private Sub FindAsyncBC (Width As Int, Height As I";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 670;BA.debugLine="For Each bc As BitmapCreator In AsyncBCs.Keys";
Debug.JustUpdateDeviceLine();
{
final RemoteObject group1 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
final int groupLen1 = group1.runMethod(true,"getSize").<Integer>get()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
...
Debug.locals.put("bc", _bc);
 BA.debugLineNum = 671;BA.debugLine="If bc.mWidth = Width And bc.mHeight = Height The";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_bc.getField(true,"_mwidth"),BA.numberCast(double.class, _width)) && RemoteObject.solveBoolean("=",_bc.getField(true,"_mheight"),BA.numberCast(double.class, _height))) { 
 BA.debugLineNum = 672;BA.debugLine="Dim Used As Boolean = AsyncBCs.Get(bc)";
Debug.JustUpdateDeviceLine();
_used = BA.ObjectToBoolean(__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_bc))));Debug.locals.put("Used", _used);Debug.locals.put("Used", _used);
 BA.debugLineNum = 673;BA.debugLine="If Used = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_used,bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 674;BA.debugLine="AsyncBCs.Put(bc, True)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"True"))));
 BA.debugLineNum = 675;BA.debugLine="Return bc";
Debug.JustUpdateDeviceLine();
if (true) return _bc;
 };
 };
...
;
 BA.debugLineNum = 679;BA.debugLine="Dim bc As BitmapCreator";
Debug.JustUpdateDeviceLine();
_bc = RemoteObject.createNew ("b4a.example.bitmapcreator");Debug.locals.put("bc", _bc);
 BA.debugLineNum = 680;BA.debugLine="bc.Initialize(Width, Height)";
Debug.JustUpdateDeviceLine();
_bc.runVoidMethod ("_initialize",__ref.getField(false, "ba"),(Object)(_width),(Object)(_height));
 BA.debugLineNum = 681;BA.debugLine="AsyncBCs.Put(bc, True)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"True"))));
 BA.debugLineNum = 682;BA.debugLine="Dim i As Int";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.createImmutable(0);Debug.locals.put("i", _i);
 BA.debugLineNum = 683;BA.debugLine="For Each b As Boolean In AsyncBCs.Values";
Debug.JustUpdateDeviceLine();
{
final RemoteObject group14 = __ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );
...
Debug.locals.put("b", _b);
 BA.debugLineNum = 684;BA.debugLine="If b Then i = i + 1";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 686;BA.debugLine="Return bc";
Debug.JustUpdateDeviceLine();
if (true) return _bc;
...
try {
		Debug.PushSubsStack("FindMinRect (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,983);
...
Debug.locals.put("width", _width);
Debug.locals.put("height", _height);
 BA.debugLineNum = 983;BA.debugLine="Private Sub FindMinRect (width As Int, height As I";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 984;BA.debugLine="Dim r As B4XRect";
Debug.JustUpdateDeviceLine();
_r = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XCanvas.B4XRect");Debug.locals.put("r", _r);
 BA.debugLineNum = 985;BA.debugLine="r.Initialize(width / 2, -1, -1, 0)";
Debug.JustUpdateDeviceLine();
_r.runVoidMethod ("Initialize",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_width,RemoteObject.createImmutable(2)}, "/",0, 0))),(Object)(BA.numberCast(float.class, -(double) (0 + 1))),(Object)(BA.numberCast(float.class, -(double) (0 + 1))),(Object)(BA.numberCast(float.class, 0)));
 BA.debugLineNum = 986;BA.debugLine="For y = 0 To height - 1";
Debug.JustUpdateDeviceLine();
{
final int step3 = 1;
...
Debug.locals.put("y", _y);
 BA.debugLineNum = 987;BA.debugLine="For x = 0 To width - 1";
Debug.JustUpdateDeviceLine();
{
final int step4 = 1;
...
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_charbc" /*RemoteObject*/ ).runMethod(true,"_istransparent",(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y))),bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 989;BA.debugLine="r.Left = Min(r.Left, x)";
Debug.JustUpdateDeviceLine();
...
_r.runMethod(true,"setBottom",BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_y),RemoteObject.createImmutable(1)}, "+",1, 1)));
 ...
 BA.debugLineNum = 999;BA.debugLine="For x = width - 1 To 0 Step -1";
Debug.JustUpdateDeviceLine();
{
final int step16 = -1;
final int limit16 = 0;
...
Debug.locals.put("x", _x);
 BA.debugLineNum = 1000;BA.debugLine="If CharBC.IsTransparent(x, y) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_charbc" /*RemoteObject*/ ).runMethod(true,"_istransparent",(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y))),bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 1001;BA.debugLine="r.Right = Max(r.Right, x + 1)";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setRight",BA.numberCast(float.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _r.runMethod(true,"getRight"))),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_x),RemoteObject.createImmutable(1)}, "+",1, 1))))));
 BA.debugLineNum = 1002;BA.debugLine="Exit";
Debug.JustUpdateDeviceLine();
if (true) break;
 };
 }
...
;
 BA.debugLineNum = 1007;BA.debugLine="r.Bottom = Max(r.Bottom, r.Top + 1)";
Debug.JustUpdateDeviceLine();
_r.runMethod(true,"setBottom",BA.numberCast(float.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _r.runMethod(true,"getBottom"))),(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getTop"),RemoteObject.createImmutable(1)}, "+",1, 0)))));
 BA.debugLineNum = 1008;BA.debugLine="Return r";
Debug.JustUpdateDeviceLine();
if (true) return _r;
...
try {
		Debug.PushSubsStack("FindSingleStyleSection (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,775);
...
RemoteObject _line = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextline");
RemoteObject _un = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _s = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
Debug.locals.put("Paragraph", _paragraph);
Debug.locals.put("X", _x);
Debug.locals.put("Y", _y);
 BA.debugLineNum = 775;BA.debugLine="Public Sub FindSingleStyleSection (Paragraph As BC";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 776;BA.debugLine="x = x * mScale";
Debug.JustUpdateDeviceLine();
_x = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_x,__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0));Debug.locals.put("X", _x);
 BA.debugLineNum = 777;BA.debugLine="y = y * mScale";
Debug.JustUpdateDeviceLine();
_y = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_y,__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0));Debug.locals.put("Y", _y);
 BA.debugLineNum = 778;BA.debugLine="For Each line As BCTextLine In Paragraph.TextLine";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("line", _line);
 BA.debugLineNum = 780;BA.debugLine="If line.BaseLineY - line.MaxHeightAboveBaseLine";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("k",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "-",1, 1),BA.numberCast(double.class, _y)) && RemoteObject.solveBoolean("g",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightBelowBaseLine" /*RemoteObject*/ )}, "+",1, 1),BA.numberCast(double.class, _y))) { 
 BA.debugLineNum = 781;BA.debugLine="For Each un As BCUnbreakableText In line.Unbrea";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("un", _un);
 BA.debugLineNum = 782;BA.debugLine="If (Paragraph.Style.RTL = False And line.Start";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean("=",_paragraph.getField(false,"Style" /*RemoteObject*/ ).getField(true,"RTL" /*RemoteObject*/ ),bctextengine.__c.getField(true,"False")) && RemoteObject.solveBoolean("k",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"StartX" /*RemoteObject*/ ),_un.getField(true,"StartX" /*RemoteObject*/ )}, "+",1, 1),BA.numberCast(double.class, _x)) && RemoteObject.solveBoolean("g",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"StartX" /*RemoteObject*/ ),_un.getField(true,"StartX" /*RemoteObject*/ ),_un.getField(true,"Width" /*RemoteObject*/ )}, "++",2, 1),BA.numberCast(double.class, _x))))) || RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",_paragraph.getField(false,"Style" /*RemoteObject*/ ).getField(true,"RTL" /*RemoteObject*/ )) && RemoteObject.solveBoolean("k",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightAboveBaseLine" /*RemoteObject*/ )}, "-",1, 1),BA.numberCast(double.class, _y)) && RemoteObject.solveBoolean("g",RemoteObject.solve(new RemoteObject[] {_line.getField(true,"BaselineY" /*RemoteObject*/ ),_line.getField(true,"MaxHeightBelowBaseLine" /*RemoteObject*/ )}, "+",1, 1),BA.numberCast(double.class, _y)))))) { 
 BA.debugLineNum = 784;BA.debugLine="For Each s As BCSingleStyleSection In un.Sing";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("s", _s);
 BA.debugLineNum = 785;BA.debugLine="If s.AbsoluteStartX <= x And s.AbsoluteStart";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 791;BA.debugLine="Return Null";
Debug.JustUpdateDeviceLine();
if (true) return (bctextengine.__c.getField(false,"Null"));
...
try {
		Debug.PushSubsStack("FontToKey (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1011);
...
Debug.locals.put("Clr", _clr);
 BA.debugLineNum = 1011;BA.debugLine="Private Sub FontToKey (fnt As B4XFont, Clr As Int)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1013;BA.debugLine="Dim jo As JavaObject = fnt.ToNativeFont";
Debug.JustUpdateDeviceLine();
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _fnt.runMethod(false,"ToNativeFont").getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 1014;BA.debugLine="Return Clr + jo.RunMethod(\"hashCode\", Null) + fnt";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetBrush (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,798);
...
Debug.locals.put("clr", _clr);
 BA.debugLineNum = 798;BA.debugLine="Private Sub GetBrush(clr As Int) As BCBrush";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 799;BA.debugLine="If Brushes.ContainsKey(clr) Then Return Brushes.G";
Debug.JustUpdateDeviceLine();
...
if (true) return (__ref.getField(false,"_brushes" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_clr))));};
 BA.debugLineNum = 800;BA.debugLine="Dim b As BCBrush = ForegroundBC.CreateBrushFromCo";
Debug.JustUpdateDeviceLine();
_b = __ref.getField(false,"_foregroundbc" /*RemoteObject*/ ).runMethod(false,"_createbrushfromcolor",(Object)(_clr));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
 BA.debugLineNum = 801;BA.debugLine="Brushes.Put(clr, b)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_brushes" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_clr)),(Object)((_b)));
 BA.debugLineNum = 802;BA.debugLine="Return b";
Debug.JustUpdateDeviceLine();
if (true) return _b;
...
try {
		Debug.PushSubsStack("GetFirstSingleStyle (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,394);
if (RapidSub.canDelegate("getfirstsinglestyle")) { return __ref.runUserSub(false, "bctextengine","getfirstsinglestyle", __ref, _line);}
RemoteObject _firstun = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
Debug.locals.put("Line", _line);
...
try {
		Debug.PushSubsStack("GetFontMetrics (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,806);
...
RemoteObject _fm = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcfontmetrics");
Debug.locals.put("Fnt", _fnt);
Debug.locals.put("clr", _clr);
 BA.debugLineNum = 806;BA.debugLine="Public Sub GetFontMetrics(Fnt As B4XFont, clr As I";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 807;BA.debugLine="Dim key As String = FontToKey(Fnt, clr)";
Debug.JustUpdateDeviceLine();
_key = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_fonttokey" /*RemoteObject*/ ,(Object)(_fnt),(Object)(_clr));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 808;BA.debugLine="If FontMetricsCache.ContainsKey(key) Then Return";
Debug.JustUpdateDeviceLine();
...
if (true) return (__ref.getField(false,"_fontmetricscache" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_key))));};
 BA.debugLineNum = 809;BA.debugLine="Dim fm As BCFontMetrics";
Debug.JustUpdateDeviceLine();
_fm = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcfontmetrics");Debug.locals.put("fm", _fm);
 BA.debugLineNum = 810;BA.debugLine="fm.Initialize";
Debug.JustUpdateDeviceLine();
_fm.runVoidMethod ("Initialize");
 BA.debugLineNum = 811;BA.debugLine="fm.Glyphs.Initialize";
Debug.JustUpdateDeviceLine();
_fm.getField(false,"Glyphs" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 812;BA.debugLine="fm.Clr = clr";
Debug.JustUpdateDeviceLine();
_fm.setField ("Clr" /*RemoteObject*/ ,_clr);
 BA.debugLineNum = 813;BA.debugLine="fm.Fnt = Fnt";
Debug.JustUpdateDeviceLine();
_fm.setField ("Fnt" /*RemoteObject*/ ,_fnt);
 BA.debugLineNum = 814;BA.debugLine="If clr = DefaultColor Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_clr,BA.numberCast(double.class, __ref.getField(true,"_defaultcolor" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 815;BA.debugLine="fm.KerningTable.Initialize";
Debug.JustUpdateDeviceLine();
_fm.getField(false,"KerningTable" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 816;BA.debugLine="fm.DefaultColorMetrics = fm";
Debug.JustUpdateDeviceLine();
_fm.setField ("DefaultColorMetrics" /*RemoteObject*/ ,_fm);
 BA.debugLineNum = 817;BA.debugLine="fm.xWidth = CreateGlyph(\"x\", fm, False).Width";
Debug.JustUpdateDeviceLine();
_fm.setField ("xWidth" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(BA.ObjectToString("x")),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False"))).getField(true,"Width" /*RemoteObject*/ ));
 }else {
 BA.debugLineNum = 819;BA.debugLine="fm.DefaultColorMetrics = GetFontMetrics(Fnt, Def";
Debug.JustUpdateDeviceLine();
_fm.setField ("DefaultColorMetrics" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_fnt),(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ ))));
 BA.debugLineNum = 820;BA.debugLine="fm.xWidth = fm.DefaultColorMetrics.xWidth";
Debug.JustUpdateDeviceLine();
_fm.setField ("xWidth" /*RemoteObject*/ ,_fm.getField(false,"DefaultColorMetrics" /*RemoteObject*/ ).getField(true,"xWidth" /*RemoteObject*/ ));
 BA.debugLineNum = 821;BA.debugLine="fm.KerningTable = fm.DefaultColorMetrics.Kerning";
Debug.JustUpdateDeviceLine();
_fm.setField ("KerningTable" /*RemoteObject*/ ,_fm.getField(false,"DefaultColorMetrics" /*RemoteObject*/ ).getField(false,"KerningTable" /*RemoteObject*/ ));
 ...
 BA.debugLineNum = 823;BA.debugLine="FontMetricsCache.Put(key, fm)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_fontmetricscache" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_key)),(Object)((_fm)));
 BA.debugLineNum = 824;BA.debugLine="Return fm";
Debug.JustUpdateDeviceLine();
if (true) return _fm;
...
try {
		Debug.PushSubsStack("GetKernSpaceBetweenChars (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,614);
...
Debug.locals.put("ThisGlyph", _thisglyph);
 BA.debugLineNum = 614;BA.debugLine="Private Sub GetKernSpaceBetweenChars (fm As BCFont";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 615;BA.debugLine="Dim together As String = PrevChar & ThisChar";
Debug.JustUpdateDeviceLine();
_together = RemoteObject.concat(_prevchar,_thischar);Debug.locals.put("together", _together);Debug.locals.put("together", _together);
 BA.debugLineNum = 616;BA.debugLine="Dim Space As Int = fm.KerningTable.GetDefault(tog";
Debug.JustUpdateDeviceLine();
_space = BA.numberCast(int.class, _fm.getField(false,"KerningTable" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)((_together)),(Object)(RemoteObject.createImmutable((-(double) (0 + 1000))))));Debug.locals.put("Space", _space);Debug.locals.put("Space", _space);
 BA.debugLineNum = 617;BA.debugLine="If Space > -1000 Then Return Space";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_space,BA.numberCast(double.class, -(double) (0 + 1000)))) { 
if (true) return _space;};
 BA.debugLineNum = 618;BA.debugLine="Dim res As Int";
Debug.JustUpdateDeviceLine();
_res = RemoteObject.createImmutable(0);Debug.locals.put("res", _res);
 BA.debugLineNum = 619;BA.debugLine="If ThisGlyph.Empty Or PrevGlyph.Empty Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_thisglyph.getField(true,"Empty" /*RemoteObject*/ )) || RemoteObject.solveBoolean(".",_prevglyph.getField(true,"Empty" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 620;BA.debugLine="res = mSpaceBetweenCharacters";
Debug.JustUpdateDeviceLine();
_res = BA.numberCast(int.class, __ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ ));Debug.locals.put("res", _res);
 }else {
 BA.debugLineNum = 622;BA.debugLine="Dim w As Int = CreateGlyph(together, fm, True).W";
Debug.JustUpdateDeviceLine();
_w = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createglyph" /*RemoteObject*/ ,(Object)(_together),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True"))).getField(true,"Width" /*RemoteObject*/ );Debug.locals.put("w", _w);Debug.locals.put("w", _w);
 BA.debugLineNum = 623;BA.debugLine="res = w - PrevGlyph.Width - ThisGlyph.Width";
Debug.JustUpdateDeviceLine();
_res = RemoteObject.solve(new RemoteObject[] {_w,_prevglyph.getField(true,"Width" /*RemoteObject*/ ),_thisglyph.getField(true,"Width" /*RemoteObject*/ )}, "--",2, 1);Debug.locals.put("res", _res);
 ...
 BA.debugLineNum = 625;BA.debugLine="fm.KerningTable.Put(together, res)";
Debug.JustUpdateDeviceLine();
_fm.getField(false,"KerningTable" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_together)),(Object)((_res)));
 BA.debugLineNum = 626;BA.debugLine="Return res";
Debug.JustUpdateDeviceLine();
if (true) return _res;
...
try {
		Debug.PushSubsStack("getMinGapBetweenLines (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1045);
if (RapidSub.canDelegate("getmingapbetweenlines")) { return __ref.runUserSub(false, "bctextengine","getmingapbetweenlines", __ref);}
 BA.debugLineNum = 1045;BA.debugLine="Public Sub getMinGapBetweenLines As Int";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1046;BA.debugLine="Return mMinGapBetweenLines";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetRunAnchorIfCurrentNotSet (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,560);
...
Debug.locals.put("Current", _current);
 BA.debugLineNum = 560;BA.debugLine="Private Sub GetRunAnchorIfCurrentNotSet(TextRun As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 561;BA.debugLine="If Current <> \"\" Then Return Current";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_current,BA.ObjectToString(""))) { 
if (true) return _current;};
 BA.debugLineNum = 562;BA.debugLine="If TextRun.Extra.IsInitialized = False Then Retur";
Debug.JustUpdateDeviceLine();
...
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 563;BA.debugLine="Return TextRun.Extra.GetDefault(\"a\", \"\")";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getSpaceBetweenCharacters (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1023);
if (RapidSub.canDelegate("getspacebetweencharacters")) { return __ref.runUserSub(false, "bctextengine","getspacebetweencharacters", __ref);}
 BA.debugLineNum = 1023;BA.debugLine="Public Sub getSpaceBetweenCharacters As Float";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1024;BA.debugLine="Return mSpaceBetweenCharacters / mScale";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getSpaceBetweenLines (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1032);
if (RapidSub.canDelegate("getspacebetweenlines")) { return __ref.runUserSub(false, "bctextengine","getspacebetweenlines", __ref);}
 BA.debugLineNum = 1032;BA.debugLine="Public Sub getSpaceBetweenLines As Float";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1033;BA.debugLine="Return mSpaceBetweenLines / mScale";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetUnderlineStyle (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,748);
if (RapidSub.canDelegate("getunderlinestyle")) { return __ref.runUserSub(false, "bctextengine","getunderlinestyle", __ref, _run);}
Debug.locals.put("run", _run);
 BA.debugLineNum = 748;BA.debugLine="Private Sub GetUnderlineStyle(run As BCTextRun) As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 749;BA.debugLine="If run.Extra.IsInitialized = False Then Return De";
Debug.JustUpdateDeviceLine();
...
if (true) return __ref.getField(false,"_defaultunderlinestyle" /*RemoteObject*/ );};
 BA.debugLineNum = 750;BA.debugLine="Return run.Extra.GetDefault(EXTRA_STYLEDUNDERLINE";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("HandleConnectedTextRuns (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,408);
...
RemoteObject _cr = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcconnectedruns");
RemoteObject _r = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextrun");
RemoteObject _width = RemoteObject.createImmutable(0);
RemoteObject _un = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _fm = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcfontmetrics");
RemoteObject _connectedwidth = RemoteObject.createImmutable(0);
RemoteObject _u = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
int _i = 0;
RemoteObject _leftoffset = RemoteObject.createImmutable(0);
RemoteObject _single = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
Debug.locals.put("Run", _run);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_r),(Object)(_children),(Object)(_style));
 }
}Debug.locals.put("r", _r);
;
...
Debug.JustUpdateDeviceLine();
_fm = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(_run.getField(false,"TextFont" /*RemoteObject*/ )),(Object)(_run.getField(true,"TextColor" /*RemoteObject*/ )));Debug.locals.put("fm", _fm);Debug.locals.put("fm", _fm);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_u),(Object)((_children.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))));
 }
}Debug.locals.put("i", _i);
;
...
Debug.JustUpdateDeviceLine();
_single = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createsinglesection" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm));Debug.locals.put("single", _single);Debug.locals.put("single", _single);
...
try {
		Debug.PushSubsStack("HandleTextRun (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,446);
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_textcharssubstring" /*RemoteObject*/ ,(Object)(_run.getField(false,"TextChars" /*RemoteObject*/ )),(Object)(_i1),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),_offset}, "+",1, 1)))),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True")),(Object)(_style)))));
 };
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"True")),(Object)(_style)))));
 };
...
{ BA.debugLineNum = 467;BA.debugLine="Else If c = Chr(13) Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("Add",(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createunbreakable" /*RemoteObject*/ ,(Object)(_run),(Object)(__ref.getField(false,"_emptytextchars" /*RemoteObject*/ )),(Object)(_fm),(Object)(bctextengine.__c.getField(true,"False")),(Object)(_style)))));
 };
...
try {
		Debug.PushSubsStack("Initialize (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,74);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 77;BA.debugLine="EmptyTextChars = CreateBCTextCharsFromString(\"\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_emptytextchars" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextcharsfromstring" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable(""))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_setspacebetweencharacters" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100))),RemoteObject.createImmutable(100)}, "/",0, 0))));
 BA.debugLineNum = 93;BA.debugLine="setSpaceBetweenLines(20dip)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_setspacebetweenlines" /*RemoteObject*/ ,(Object)(BA.numberCast(float.class, bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20))))));
...
__ref.getField(false,"_brushes" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 97;BA.debugLine="ResizeLayers(200dip * mScale, 100dip * mScale)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 200))),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {bctextengine.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100))),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0))));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_defaultstyle" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createstyle" /*RemoteObject*/ ));
 BA.debugLineNum = 105;BA.debugLine="TagParser.Initialize (Me)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_tagparser" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.bbcodeparser.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)((__ref)));
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("b4a.B4APagesNavBar.bbcodeview")) || RemoteObject.solveBoolean("i",_v.runMethod(false,"getTag"), RemoteObject.createImmutable("b4a.B4APagesNavBar.bblabel"))) { 
...
try {
		Debug.PushSubsStack("IsSpace (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,794);
if (RapidSub.canDelegate("isspace")) { return __ref.runUserSub(false, "bctextengine","isspace", __ref, _tc);}
Debug.locals.put("TC", _tc);
 BA.debugLineNum = 794;BA.debugLine="Private Sub IsSpace(TC As BCTextChars) As Boolean";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 795;BA.debugLine="Return TextCharEquals(TC, \" \")";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_tc),(Object)(RemoteObject.createImmutable(" ")));
...
try {
		Debug.PushSubsStack("IsUNSeparator (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,369);
...
try {
		Debug.PushSubsStack("LoadArabicData (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1125);
...
RemoteObject _split = null;
 BA.debugLineNum = 1125;BA.debugLine="Private Sub LoadArabicData";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1126;BA.debugLine="If ArabicMap.IsInitialized = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_arabicmap" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 1127;BA.debugLine="ArabicMap.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicmap" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 1128;BA.debugLine="ArabicNonLinkedLetters.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1129;BA.debugLine="ArabicCharsConnectedPrev.Initialize";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1130;BA.debugLine="Dim a As ARGBColor";
Debug.JustUpdateDeviceLine();
_a = RemoteObject.createNew ("b4a.example.bitmapcreator._argbcolor");Debug.locals.put("a", _a);
 BA.debugLineNum = 1131;BA.debugLine="CharBC.ColorToARGB(DefaultColor, a)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_charbc" /*RemoteObject*/ ).runVoidMethod ("_colortoargb",(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ )),(Object)(_a));
 BA.debugLineNum = 1132;BA.debugLine="CharBC.ARGBToPremultipliedColor(a, PMDefaultColo";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_charbc" /*RemoteObject*/ ).runVoidMethod ("_argbtopremultipliedcolor",(Object)(_a),(Object)(__ref.getField(false,"_pmdefaultcolor" /*RemoteObject*/ )));
 BA.debugLineNum = 1133;BA.debugLine="For Each line As String In File.ReadList(File.Di";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("line", _line);
 BA.debugLineNum = 1134;BA.debugLine="Dim split() As String = Regex.Split(\",\", line)";
Debug.JustUpdateDeviceLine();
_split = bctextengine.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(",")),(Object)(_line));Debug.locals.put("split", _split);Debug.locals.put("split", _split);
 BA.debugLineNum = 1135;BA.debugLine="If split.Length = 2 And split(1) = \"0\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_split.getField(true,"length"),BA.numberCast(double.class, 2)) && RemoteObject.solveBoolean("=",_split.getArrayElement(true,BA.numberCast(int.class, 1)),BA.ObjectToString("0"))) { 
 BA.debugLineNum = 1136;BA.debugLine="VowelsCodePoints.Add(Bit.ParseInt(split(0), 16";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_vowelscodepoints" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))));
 }else {
 BA.debugLineNum = 1138;BA.debugLine="ArabicMap.Put(Chr(Bit.ParseInt(split(0), 16)).";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicmap" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)(((BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))))))),(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 1))),(Object)(BA.numberCast(int.class, 16))))));
 BA.debugLineNum = 1139;BA.debugLine="If 2 = split(2) Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",RemoteObject.createImmutable(2),BA.numberCast(double.class, _split.getArrayElement(true,BA.numberCast(int.class, 2))))) { 
 BA.debugLineNum = 1140;BA.debugLine="ArabicNonLinkedLetters.Add(Chr(Bit.ParseInt(s";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(((BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_split.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(BA.numberCast(int.class, 16))))))))));
 };
 };
 }
}Debug.locals.put("line", _line);
...
try {
		Debug.PushSubsStack("LoadData (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1199);
...
Debug.locals.put("FileName", _filename);
 BA.debugLineNum = 1199;BA.debugLine="Private Sub LoadData(Set As B4XSet, FileName As St";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1200;BA.debugLine="Set.Initialize";
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
 BA.debugLineNum = 1201;BA.debugLine="For Each line As String In File.ReadList(File.Dir";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("line", _line);
 BA.debugLineNum = 1202;BA.debugLine="line = line.Trim";
Debug.JustUpdateDeviceLine();
_line = _line.runMethod(true,"trim");Debug.locals.put("line", _line);
 BA.debugLineNum = 1203;BA.debugLine="Dim i As Int = line.IndexOf(\".\")";
Debug.JustUpdateDeviceLine();
_i = _line.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable(".")));Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 1204;BA.debugLine="If i = -1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_i,BA.numberCast(double.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 1205;BA.debugLine="Set.Add(Bit.ParseInt(line, 16))";
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((bctextengine.__c.getField(false,"Bit").runMethod(true,"ParseInt",(Object)(_line),(Object)(BA.numberCast(int.class, 16))))));
 }else {
 BA.debugLineNum = 1207;BA.debugLine="For a = Bit.ParseInt(line.SubString2(0, i), 16)";
Debug.JustUpdateDeviceLine();
{
final int step8 = 1;
...
Debug.locals.put("a", _a);
 BA.debugLineNum = 1208;BA.debugLine="Set.Add(a)";
Debug.JustUpdateDeviceLine();
_set.runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_add" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable((_a))));
 }
}Debug.locals.put("a", _a);
;
 };
...
try {
		Debug.PushSubsStack("MergeUnbreakables (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,550);
...
Debug.locals.put("un2", _un2);
 BA.debugLineNum = 550;BA.debugLine="Private Sub MergeUnbreakables (un1 As BCUnbreakabl";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 551;BA.debugLine="un1.Width = un1.Width + un2.Width + mSpaceBetween";
Debug.JustUpdateDeviceLine();
_un1.setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_un1.getField(true,"Width" /*RemoteObject*/ ),_un2.getField(true,"Width" /*RemoteObject*/ ),__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ )}, "++",2, 0)));
 BA.debugLineNum = 552;BA.debugLine="For Each single As BCSingleStyleSection In un2.Si";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("single", _single);
 BA.debugLineNum = 553;BA.debugLine="single.ParentUN = un1";
Debug.JustUpdateDeviceLine();
_single.setField ("ParentUN" /*RemoteObject*/ ,_un1);
 BA.debugLineNum = 554;BA.debugLine="un1.Anchor = GetRunAnchorIfCurrentNotSet(single.";
Debug.JustUpdateDeviceLine();
_un1.setField ("Anchor" /*RemoteObject*/ ,__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getrunanchorifcurrentnotset" /*RemoteObject*/ ,(Object)(_single.getField(false,"Run" /*RemoteObject*/ )),(Object)(_un1.getField(true,"Anchor" /*RemoteObject*/ ))));
 }
}Debug.locals.put("single", _single);
;
 BA.debugLineNum = 556;BA.debugLine="un1.SingleStyleSections.AddAll(un2.SingleStyleSec";
Debug.JustUpdateDeviceLine();
_un1.getField(false,"SingleStyleSections" /*RemoteObject*/ ).runVoidMethod ("AddAll",(Object)(_un2.getField(false,"SingleStyleSections" /*RemoteObject*/ )));
 BA.debugLineNum = 557;BA.debugLine="If un1.NotFullTextChars.Length = 0 Then un1.NotFu";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("MightBeAnEmoji (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,927);
if (RapidSub.canDelegate("mightbeanemoji")) { return __ref.runUserSub(false, "bctextengine","mightbeanemoji", __ref, _c);}
RemoteObject _cp = RemoteObject.createImmutable(0);
Debug.locals.put("c", _c);
 BA.debugLineNum = 927;BA.debugLine="Private Sub MightBeAnEmoji(c As String) As Boolean";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 928;BA.debugLine="Dim cp As Int = Asc(c)";
Debug.JustUpdateDeviceLine();
_cp = bctextengine.__c.runMethod(true,"Asc",(Object)(BA.ObjectToChar(_c)));Debug.locals.put("cp", _cp);Debug.locals.put("cp", _cp);
 BA.debugLineNum = 929;BA.debugLine="Return cp >= 0x231A Or c.Length > 1";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("OrganizeLines (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,237);
...
RemoteObject _linestyle = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
RemoteObject _last = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
...
Debug.JustUpdateDeviceLine();
_linestyle = __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getfirstsinglestyle" /*RemoteObject*/ ,(Object)(_line));Debug.locals.put("linestyle", _linestyle);Debug.locals.put("linestyle", _linestyle);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_isspace" /*RemoteObject*/ ,(Object)(_last.getField(false,"NotFullTextChars" /*RemoteObject*/ ))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("OrganizeRTLParagraph (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,301);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_addltritems" /*RemoteObject*/ ,(Object)(_ltrlist),(Object)(_newlist));
...
try {
		Debug.PushSubsStack("OrganizeSingleStyles (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,374);
...
try {
		Debug.PushSubsStack("OrganizeUnbreakables (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,506);
...
RemoteObject _un = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _i = RemoteObject.createImmutable(0);
RemoteObject _nextun = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcunbreakabletext");
RemoteObject _singlestyle = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bcsinglestylesection");
RemoteObject _indent = RemoteObject.createImmutable(0);
Debug.locals.put("p", _p);
Debug.locals.put("unbreakables", _unbreakables);
 BA.debugLineNum = 506;BA.debugLine="Private Sub OrganizeUnbreakables (p As BCParagraph";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 507;BA.debugLine="If unbreakables.Size = 0 Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_unbreakables.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 508;BA.debugLine="Dim un As BCUnbreakableText = unbreakables.Get(0)";
Debug.JustUpdateDeviceLine();
_un = (_unbreakables.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("un", _un);Debug.locals.put("un", _un);
 BA.debugLineNum = 509;BA.debugLine="Dim i As Int = 1";
Debug.JustUpdateDeviceLine();
_i = BA.numberCast(int.class, 1);Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 510;BA.debugLine="Do While i < unbreakables.Size";
Debug.JustUpdateDeviceLine();
while (RemoteObject.solveBoolean("<",_i,BA.numberCast(double.class, _unbreakables.runMethod(true,"getSize")))) {
 BA.debugLineNum = 511;BA.debugLine="Dim NextUn As BCUnbreakableText = unbreakables.G";
Debug.JustUpdateDeviceLine();
_nextun = (_unbreakables.runMethod(false,"Get",(Object)(_i)));Debug.locals.put("NextUn", _nextun);Debug.locals.put("NextUn", _nextun);
 BA.debugLineNum = 512;BA.debugLine="If un.IsMergable = True And NextUn.IsMergable =";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_un.getField(true,"IsMergable" /*RemoteObject*/ ),bctextengine.__c.getField(true,"True")) && RemoteObject.solveBoolean("=",_nextun.getField(true,"IsMergable" /*RemoteObject*/ ),bctextengine.__c.getField(true,"True")) && RemoteObject.solveBoolean("=",_un.getField(true,"RTL" /*RemoteObject*/ ),_nextun.getField(true,"RTL" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 513;BA.debugLine="MergeUnbreakables(un, NextUn)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_mergeunbreakables" /*RemoteObject*/ ,(Object)(_un),(Object)(_nextun));
 BA.debugLineNum = 514;BA.debugLine="unbreakables.RemoveAt(i)";
Debug.JustUpdateDeviceLine();
_unbreakables.runVoidMethod ("RemoveAt",(Object)(_i));
 BA.debugLineNum = 515;BA.debugLine="i = i - 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "-",1, 1);Debug.locals.put("i", _i);
 }else {
 BA.debugLineNum = 517;BA.debugLine="un = NextUn";
Debug.JustUpdateDeviceLine();
_un = _nextun;Debug.locals.put("un", _un);
 };
 BA.debugLineNum = 519;BA.debugLine="i = i + 1";
Debug.JustUpdateDeviceLine();
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("i", _i);
 }
;
 BA.debugLineNum = 521;BA.debugLine="For Each un As BCUnbreakableText In unbreakables";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("un", _un);
 BA.debugLineNum = 522;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(13))";
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 13)))))).<Boolean>get().booleanValue()) { 
if (true) continue;};
 BA.debugLineNum = 523;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(10))";
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_textcharequals" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )),(Object)(BA.ObjectToString(bctextengine.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 10)))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 524;BA.debugLine="CreateLine(p)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_p));
 BA.debugLineNum = 525;BA.debugLine="Continue";
Debug.JustUpdateDeviceLine();
if (true) continue;
 };
 BA.debugLineNum = 527;BA.debugLine="If p.CurrentLine.Unbreakables.Size > 0 And p.Sty";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(false,"Unbreakables" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",_p.getField(false,"Style" /*RemoteObject*/ ).getField(true,"WordWrap" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 528;BA.debugLine="Dim SingleStyle As BCSingleStyleSection = un.Si";
Debug.JustUpdateDeviceLine();
_singlestyle = (_un.getField(false,"SingleStyleSections" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("SingleStyle", _singlestyle);Debug.locals.put("SingleStyle", _singlestyle);
 BA.debugLineNum = 529;BA.debugLine="Dim indent As Int = IndentWidth * SingleStyle.R";
Debug.JustUpdateDeviceLine();
_indent = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_indentwidth" /*RemoteObject*/ ),_singlestyle.getField(false,"Run" /*RemoteObject*/ ).getField(true,"IndentLevel" /*RemoteObject*/ )}, "*",0, 1);Debug.locals.put("indent", _indent);Debug.locals.put("indent", _indent);
 BA.debugLineNum = 530;BA.debugLine="If p.CurrentLine.Width + mSpaceBetweenCharacter";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(true,"Width" /*RemoteObject*/ ),__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ ),_un.getField(true,"Width" /*RemoteObject*/ ),_indent}, "+++",3, 0),RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_p.getField(false,"Style" /*RemoteObject*/ ).getField(true,"MaxWidth" /*RemoteObject*/ ),_p.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getLeft"),_p.getField(false,"Style" /*RemoteObject*/ ).getField(false,"Padding" /*RemoteObject*/ ).runMethod(true,"getRight")}, "--",2, 0)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0))) { 
 BA.debugLineNum = 531;BA.debugLine="p.CurrentLine.EndsWithSoftLineBreak = True";
Debug.JustUpdateDeviceLine();
_p.getField(false,"CurrentLine" /*RemoteObject*/ ).setField ("EndsWithSoftLineBreak" /*RemoteObject*/ ,bctextengine.__c.getField(true,"True"));
 BA.debugLineNum = 532;BA.debugLine="CreateLine(p)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_p));
 };
 };
 BA.debugLineNum = 535;BA.debugLine="p.CurrentLine.Unbreakables.Add(un)";
Debug.JustUpdateDeviceLine();
_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(false,"Unbreakables" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_un)));
 BA.debugLineNum = 536;BA.debugLine="un.ParentLine = p.CurrentLine";
Debug.JustUpdateDeviceLine();
_un.setField ("ParentLine" /*RemoteObject*/ ,_p.getField(false,"CurrentLine" /*RemoteObject*/ ));
 BA.debugLineNum = 537;BA.debugLine="If un.Anchor <> \"\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_un.getField(true,"Anchor" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 538;BA.debugLine="If p.Anchors.IsInitialized = False Then p.Ancho";
Debug.JustUpdateDeviceLine();
...
_p.getField(false,"Anchors" /*RemoteObject*/ ).runVoidMethod ("Initialize");};
 BA.debugLineNum = 539;BA.debugLine="p.Anchors.Put(un.Anchor, p.CurrentLine)";
Debug.JustUpdateDeviceLine();
_p.getField(false,"Anchors" /*RemoteObject*/ ).runVoidMethod ("Put",(Object)((_un.getField(true,"Anchor" /*RemoteObject*/ ))),(Object)((_p.getField(false,"CurrentLine" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 541;BA.debugLine="If IsSpace(un.NotFullTextChars) And p.CurrentLin";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_isspace" /*RemoteObject*/ ,(Object)(_un.getField(false,"NotFullTextChars" /*RemoteObject*/ )))) && RemoteObject.solveBoolean("=",_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(false,"Unbreakables" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 542;BA.debugLine="un.Width = 0";
Debug.JustUpdateDeviceLine();
_un.setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 };
 BA.debugLineNum = 544;BA.debugLine="If p.CurrentLine.Unbreakables.Size > 0 Then p.Cu";
Debug.JustUpdateDeviceLine();
...
_p.getField(false,"CurrentLine" /*RemoteObject*/ ).setField ("Width" /*RemoteObject*/ ,BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(true,"Width" /*RemoteObject*/ ),__ref.getField(true,"_mspacebetweencharacters" /*RemoteObject*/ )}, "+",1, 0)));};
 BA.debugLineNum = 545;BA.debugLine="un.StartX = p.CurrentLine.Width";
Debug.JustUpdateDeviceLine();
_un.setField ("StartX" /*RemoteObject*/ ,_p.getField(false,"CurrentLine" /*RemoteObject*/ ).getField(true,"Width" /*RemoteObject*/ ));
 BA.debugLineNum = 546;BA.debugLine="p.CurrentLine.Width = p.CurrentLine.Width + un.W";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Prepare (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,169);
...
RemoteObject _run = RemoteObject.declareNull("b4a.B4APagesNavBar.bctextengine._bctextrun");
Debug.locals.put("Runs", _runs);
Debug.locals.put("Style", _style);
...
Debug.JustUpdateDeviceLine();
_par = RemoteObject.createNew ("b4a.B4APagesNavBar.bctextengine._bcparagraph");Debug.locals.put("par", _par);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_indentwidth" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_getfontmetrics" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_defaultfont" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_defaultcolor" /*RemoteObject*/ ))).getField(true,"xWidth" /*RemoteObject*/ ),__ref.getField(true,"_tabwidthmeasuredinx" /*RemoteObject*/ )}, "*",0, 1));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_handleconnectedtextruns" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 }else {
 BA.debugLineNum = 181;BA.debugLine="HandleTextRun(run, unbreakeables, Style)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_handletextrun" /*RemoteObject*/ ,(Object)(_run),(Object)(_unbreakeables),(Object)(_style));
 };
 }
}Debug.locals.put("run", _run);
;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createline" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 185;BA.debugLine="OrganizeUnbreakables(par, unbreakeables)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_organizeunbreakables" /*RemoteObject*/ ,(Object)(_par),(Object)(_unbreakeables));
 BA.debugLineNum = 186;BA.debugLine="OrganizeLines(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_organizelines" /*RemoteObject*/ ,(Object)(_par));
 BA.debugLineNum = 187;BA.debugLine="OrganizeSingleStyles(par)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_organizesinglestyles" /*RemoteObject*/ ,(Object)(_par));
...
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_organizertlparagraph" /*RemoteObject*/ ,(Object)(_par));};
...
try {
		Debug.PushSubsStack("PrepareForLazyDrawing (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,192);
...
;
 BA.debugLineNum = 199;BA.debugLine="ResizeLayers(par.Width, MaxHeight)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_resizelayers" /*RemoteObject*/ ,(Object)(_par.getField(true,"Width" /*RemoteObject*/ )),(Object)(_maxheight));
...
try {
		Debug.PushSubsStack("PreprocessArabic (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1147);
...
RemoteObject _arabicchars = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xbitset");
RemoteObject _arabicnonlinked = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xbitset");
...
Debug.locals.put("Length", _length);
 BA.debugLineNum = 1147;BA.debugLine="Public Sub PreprocessArabic(chars() As String, Len";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1148;BA.debugLine="LoadArabicData";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_loadarabicdata" /*RemoteObject*/ );
 BA.debugLineNum = 1149;BA.debugLine="Dim ArabicChars, ArabicNonLinked As B4XBitSet";
Debug.JustUpdateDeviceLine();
_arabicchars = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xbitset");Debug.locals.put("ArabicChars", _arabicchars);
_arabicnonlinked = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xbitset");Debug.locals.put("ArabicNonLinked", _arabicnonlinked);
 BA.debugLineNum = 1150;BA.debugLine="Dim FullChars(Length) As String";
Debug.JustUpdateDeviceLine();
_fullchars = RemoteObject.createNewArray ("String", new int[] {_length.<Integer>get().intValue()}, new Object[]{});Debug.locals.put("FullChars", _fullchars);
 BA.debugLineNum = 1151;BA.debugLine="Dim Found As Boolean";
Debug.JustUpdateDeviceLine();
_found = RemoteObject.createImmutable(false);Debug.locals.put("Found", _found);
 BA.debugLineNum = 1152;BA.debugLine="For i = 0 To Length - 1";
Debug.JustUpdateDeviceLine();
{
final int step5 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1153;BA.debugLine="If ArabicMap.ContainsKey(chars(i).CharAt(0).As(S";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabicmap" /*RemoteObject*/ ).runMethod(true,"ContainsKey",(Object)(((BA.ObjectToString(_chars.getArrayElement(true,BA.numberCast(int.class, _i)).runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 0)))))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1154;BA.debugLine="If chars(i).Length > 1 Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_chars.getArrayElement(true,BA.numberCast(int.class, _i)).runMethod(true,"length"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 1155;BA.debugLine="FullChars(i) = chars(i).SubString(1)";
Debug.JustUpdateDeviceLine();
_fullchars.setArrayElement (_chars.getArrayElement(true,BA.numberCast(int.class, _i)).runMethod(true,"substring",(Object)(BA.numberCast(int.class, 1))),BA.numberCast(int.class, _i));
 BA.debugLineNum = 1156;BA.debugLine="chars(i) = chars(i).CharAt(0).As(String)";
Debug.JustUpdateDeviceLine();
_chars.setArrayElement ((BA.ObjectToString(_chars.getArrayElement(true,BA.numberCast(int.class, _i)).runMethod(true,"charAt",(Object)(BA.numberCast(int.class, 0))))),BA.numberCast(int.class, _i));
 ...
 BA.debugLineNum = 1158;BA.debugLine="If Found = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_found,bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 1159;BA.debugLine="Found = True";
Debug.JustUpdateDeviceLine();
_found = bctextengine.__c.getField(true,"True");Debug.locals.put("Found", _found);
 BA.debugLineNum = 1160;BA.debugLine="ArabicChars.Initialize(Length)";
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 BA.debugLineNum = 1161;BA.debugLine="ArabicNonLinked.Initialize(Length)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_length));
 };
 BA.debugLineNum = 1163;BA.debugLine="ArabicChars.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicchars.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 BA.debugLineNum = 1164;BA.debugLine="If ArabicNonLinkedLetters.Contains(chars(i)) Th";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabicnonlinkedletters" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1165;BA.debugLine="ArabicNonLinked.Set(i, True)";
Debug.JustUpdateDeviceLine();
_arabicnonlinked.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_set" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i)),(Object)(bctextengine.__c.getField(true,"True")));
 };
 };
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 1169;BA.debugLine="If Found = False Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_found,bctextengine.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 1170;BA.debugLine="For i = 0 To Length - 1";
Debug.JustUpdateDeviceLine();
{
final int step23 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1171;BA.debugLine="If ArabicChars.Get(i) Then";
Debug.JustUpdateDeviceLine();
if (_arabicchars.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_get" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1172;BA.debugLine="Dim ConnectToPrev As Boolean = i > 0 And Arabic";
Debug.JustUpdateDeviceLine();
_connecttoprev = BA.ObjectToBoolean(RemoteObject.solveBoolean(">",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(".",_arabicchars.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_get" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "-",1, 1)))) && RemoteObject.solveBoolean("=",_arabicnonlinked.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_get" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "-",1, 1))),bctextengine.__c.getField(true,"False")));Debug.locals.put("ConnectToPrev", _connecttoprev);Debug.locals.put("ConnectToPrev", _connecttoprev);
 BA.debugLineNum = 1173;BA.debugLine="Dim ConnectToNext As Boolean = i < Length - 1 A";
Debug.JustUpdateDeviceLine();
_connecttonext = BA.ObjectToBoolean(RemoteObject.solveBoolean("<",RemoteObject.createImmutable(_i),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_length,RemoteObject.createImmutable(1)}, "-",1, 1))) && RemoteObject.solveBoolean(".",_arabicchars.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_get" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i),RemoteObject.createImmutable(1)}, "+",1, 1)))) && RemoteObject.solveBoolean("=",_arabicnonlinked.runClassMethod (b4a.B4APagesNavBar.b4xbitset.class, "_get" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _i))),bctextengine.__c.getField(true,"False")));Debug.locals.put("ConnectToNext", _connecttonext);Debug.locals.put("ConnectToNext", _connecttonext);
 BA.debugLineNum = 1174;BA.debugLine="If ConnectToNext = False And ConnectToPrev = Fa";
Debug.JustUpdateDeviceLine();
...
if (true) continue;};
 BA.debugLineNum = 1175;BA.debugLine="Dim offset As Int = IIf(ConnectToPrev And Conne";
Debug.JustUpdateDeviceLine();
_offset = BA.numberCast(int.class, ((RemoteObject.solveBoolean(".",_connecttoprev) && RemoteObject.solveBoolean(".",_connecttonext)) ? (RemoteObject.createImmutable((3))) : (((_connecttoprev.<Boolean>get().booleanValue()) ? (RemoteObject.createImmutable((1))) : (RemoteObject.createImmutable((2)))))));Debug.locals.put("offset", _offset);Debug.locals.put("offset", _offset);
 BA.debugLineNum = 1176;BA.debugLine="Dim TargetCP As Int = ArabicMap.Get(chars(i))";
Debug.JustUpdateDeviceLine();
_targetcp = BA.numberCast(int.class, __ref.getField(false,"_arabicmap" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i))))));Debug.locals.put("TargetCP", _targetcp);Debug.locals.put("TargetCP", _targetcp);
 BA.debugLineNum = 1177;BA.debugLine="If TargetCP = Asc(chars(i)) Then";
Debug.JustUpdateDeviceLine();
...
_chars.setArrayElement (RemoteObject.concat(_chars.getArrayElement(true,BA.numberCast(int.class, _i)),_fullchars.getArrayElement(true,BA.numberCast(int.class, _i))),BA.numberCast(int.class, _i));};
 BA.debugLineNum = 1183;BA.debugLine="If ConnectToPrev Then ArabicCharsConnectedPrev.";
Debug.JustUpdateDeviceLine();
if (_connecttoprev.<Boolean>get().booleanValue()) { 
__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_chars.getArrayElement(true,BA.numberCast(int.class, _i)))));};
 };
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("PrintTextChars (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1190);
...
int _i = 0;
Debug.locals.put("TC", _tc);
 BA.debugLineNum = 1190;BA.debugLine="Public Sub PrintTextChars(TC As BCTextChars)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1191;BA.debugLine="Dim sb As StringBuilder";
Debug.JustUpdateDeviceLine();
_sb = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("sb", _sb);
 BA.debugLineNum = 1192;BA.debugLine="sb.Initialize";
Debug.JustUpdateDeviceLine();
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 1193;BA.debugLine="For i = TC.StartIndex To TC.StartIndex + TC.Lengt";
Debug.JustUpdateDeviceLine();
{
final int step3 = 1;
...
for (;(step3 > 0 && _i <= limit3) || (step3 < 0 && _i >= limit3) ;_i = ((int)(0 + _i + step3))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 1194;BA.debugLine="sb.Append(TC.Buffer(i))";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
bctextengine.__c.runVoidMethod ("LogImpl","919070982",_sb.runMethod(true,"ToString"),0);
...
try {
		Debug.PushSubsStack("RecolorEdgesOfConnectedCharacters (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,901);
...
Debug.locals.put("r2", _r2);
 BA.debugLineNum = 901;BA.debugLine="Private Sub RecolorEdgesOfConnectedCharacters(c As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 902;BA.debugLine="If ArabicCharsConnectedPrev.Contains(c) Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_arabiccharsconnectedprev" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xset.class, "_contains" /*RemoteObject*/ ,(Object)((_c))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 903;BA.debugLine="Dim First As Boolean = True";
Debug.JustUpdateDeviceLine();
_first = bctextengine.__c.getField(true,"True");Debug.locals.put("First", _first);Debug.locals.put("First", _first);
 BA.debugLineNum = 904;BA.debugLine="For y = r2.Top To r2.Bottom - 1";
Debug.JustUpdateDeviceLine();
{
final int step3 = 1;
...
for (;(step3 > 0 && _y <= limit3) || (step3 < 0 && _y >= limit3) ;_y = ((int)(0 + _y + step3))  ) {
Debug.locals.put("y", _y);
 BA.debugLineNum = 905;BA.debugLine="For x = r2.Right - 1 To Max(r2.Left, r2.Right -";
Debug.JustUpdateDeviceLine();
{
final int step4 = -1;
...
for (;(step4 > 0 && _x <= limit4) || (step4 < 0 && _x >= limit4) ;_x = ((int)(0 + _x + step4))  ) {
Debug.locals.put("x", _x);
 BA.debugLineNum = 906;BA.debugLine="If CharBC.IsTransparent(x, y) = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_charbc" /*RemoteObject*/ ).runMethod(true,"_istransparent",(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y))),bctextengine.__c.getField(true,"False"))) { 
 BA.debugLineNum = 907;BA.debugLine="If First Then";
Debug.JustUpdateDeviceLine();
if (_first.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 908;BA.debugLine="First = False";
Debug.JustUpdateDeviceLine();
_first = bctextengine.__c.getField(true,"False");Debug.locals.put("First", _first);
 }else {
 BA.debugLineNum = 910;BA.debugLine="CharBC.SetPremultipliedColor(x, y, PMDefault";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_charbc" /*RemoteObject*/ ).runVoidMethod ("_setpremultipliedcolor",(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)),(Object)(__ref.getField(false,"_pmdefaultcolor" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 912;BA.debugLine="Exit";
Debug.JustUpdateDeviceLine();
if (true) break;
 };
 }
...
try {
		Debug.PushSubsStack("ReleaseAsyncBC (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,689);
if (RapidSub.canDelegate("releaseasyncbc")) { return __ref.runUserSub(false, "bctextengine","releaseasyncbc", __ref, _bc);}
Debug.locals.put("bc", _bc);
 BA.debugLineNum = 689;BA.debugLine="Public Sub ReleaseAsyncBC(bc As BitmapCreator)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 690;BA.debugLine="AsyncBCs.Put(bc, False)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_asyncbcs" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_bc)),(Object)((bctextengine.__c.getField(true,"False"))));
...
try {
		Debug.PushSubsStack("ResizeCharBC (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,753);
...
Debug.locals.put("width", _width);
Debug.locals.put("height", _height);
 BA.debugLineNum = 753;BA.debugLine="Private Sub ResizeCharBC(width As Int, height As I";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 754;BA.debugLine="Dim ScaledWidth As Int = (width + 5) / mScale";
Debug.JustUpdateDeviceLine();
_scaledwidth = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_width,RemoteObject.createImmutable(5)}, "+",1, 1)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0));Debug.locals.put("ScaledWidth", _scaledwidth);Debug.locals.put("ScaledWidth", _scaledwidth);
 BA.debugLineNum = 755;BA.debugLine="Dim ScaledHeight As Int = (height + 5) / mScale";
Debug.JustUpdateDeviceLine();
_scaledheight = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_height,RemoteObject.createImmutable(5)}, "+",1, 1)),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0));Debug.locals.put("ScaledHeight", _scaledheight);Debug.locals.put("ScaledHeight", _scaledheight);
 BA.debugLineNum = 756;BA.debugLine="CharBC.Initialize(ScaledWidth * mScale, ScaledHei";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ResizeImageView (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,228);
...
_bmp = _bc.runMethod(false,"_getbitmap");Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 230;BA.debugLine="Dim ivHeight As Int = Ceil(par.Height / mScale)";
Debug.JustUpdateDeviceLine();
_ivheight = BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_par.getField(true,"Height" /*RemoteObject*/ ),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "/",0, 0))));Debug.locals.put("ivHeight", _ivheight);Debug.locals.put("ivHeight", _ivheight);
...
try {
		Debug.PushSubsStack("ResizeLayers (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,118);
...
Debug.JustUpdateDeviceLine();
_width = BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _width)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(2),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0))));Debug.locals.put("Width", _width);
 BA.debugLineNum = 120;BA.debugLine="Height = Max(Height, 2 * mScale)";
Debug.JustUpdateDeviceLine();
_height = BA.numberCast(int.class, bctextengine.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _height)),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(2),__ref.getField(true,"_mscale" /*RemoteObject*/ )}, "*",0, 0))));Debug.locals.put("Height", _height);
...
try {
		Debug.PushSubsStack("setMinGapBetweenLines (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1041);
if (RapidSub.canDelegate("setmingapbetweenlines")) { return __ref.runUserSub(false, "bctextengine","setmingapbetweenlines", __ref, _i);}
Debug.locals.put("i", _i);
 BA.debugLineNum = 1041;BA.debugLine="Public Sub setMinGapBetweenLines(i As Int)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1042;BA.debugLine="mMinGapBetweenLines = i";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("setSpaceBetweenCharacters (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1027);
...
Debug.locals.put("f", _f);
 BA.debugLineNum = 1027;BA.debugLine="Public Sub setSpaceBetweenCharacters(f As Float)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1028;BA.debugLine="mSpaceBetweenCharacters = f * mScale";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("setSpaceBetweenLines (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1036);
if (RapidSub.canDelegate("setspacebetweenlines")) { return __ref.runUserSub(false, "bctextengine","setspacebetweenlines", __ref, _f);}
Debug.locals.put("f", _f);
 BA.debugLineNum = 1036;BA.debugLine="Public Sub setSpaceBetweenLines(f As Float)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1037;BA.debugLine="mSpaceBetweenLines = f * mScale";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("TextCharEquals (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1117);
if (RapidSub.canDelegate("textcharequals")) { return __ref.runUserSub(false, "bctextengine","textcharequals", __ref, _tc, _s);}
int _i = 0;
Debug.locals.put("TC", _tc);
Debug.locals.put("s", _s);
 BA.debugLineNum = 1117;BA.debugLine="Private Sub TextCharEquals (TC As BCTextChars, s A";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1118;BA.debugLine="If TC.Length <> s.Length Then Return False";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_tc.getField(true,"Length" /*RemoteObject*/ ),BA.numberCast(double.class, _s.runMethod(true,"length")))) { 
if (true) return bctextengine.__c.getField(true,"False");};
 BA.debugLineNum = 1119;BA.debugLine="For i = 0 To TC.Length - 1";
Debug.JustUpdateDeviceLine();
{
final int step2 = 1;
...
for (;(step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2) ;_i = ((int)(0 + _i + step2))  ) {
Debug.locals.put("i", _i);
 BA.debugLineNum = 1120;BA.debugLine="If TC.Buffer(i + TC.StartIndex) <> s.CharAt(i) T";
Debug.JustUpdateDeviceLine();
...
;
 BA.debugLineNum = 1122;BA.debugLine="Return True";
Debug.JustUpdateDeviceLine();
if (true) return bctextengine.__c.getField(true,"True");
...
try {
		Debug.PushSubsStack("TextCharsSubstring (bctextengine) ","bctextengine",21,__ref.getField(false, "ba"),__ref,1113);
...
Debug.locals.put("EndIndex", _endindex);
 BA.debugLineNum = 1113;BA.debugLine="Private Sub TextCharsSubstring(TC As BCTextChars,";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 1114;BA.debugLine="Return CreateBCTextChars(TC.Buffer, StartIndex +";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.B4APagesNavBar.bctextengine.class, "_createbctextchars" /*RemoteObject*/ ,(Object)(_tc.getField(false,"Buffer" /*RemoteObject*/ )),(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,_tc.getField(true,"StartIndex" /*RemoteObject*/ )}, "+",1, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_endindex,_startindex}, "-",1, 1)));
