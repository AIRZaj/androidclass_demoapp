...
b4xcache._data = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xorderedmap");__ref.setField("_data",b4xcache._data);
...
try {
		Debug.PushSubsStack("ContainsKey (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,66);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_containskey" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("CreateB4XCacheItem (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,102);
if (RapidSub.canDelegate("createb4xcacheitem")) { return __ref.runUserSub(false, "b4xcache","createb4xcacheitem", __ref, _value, _key);}
RemoteObject _t1 = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xcache._b4xcacheitem");
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.B4APagesNavBar.b4xcache._b4xcacheitem");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("Get (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,24);
if (RapidSub.canDelegate("get")) { return __ref.runUserSub(false, "b4xcache","get", __ref, _key);}
RemoteObject _ci = RemoteObject.declareNull("b4a.B4APagesNavBar.b4xcache._b4xcacheitem");
Debug.locals.put("Key", _key);
...
Debug.JustUpdateDeviceLine();
_ci = (__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_get" /*RemoteObject*/ ,(Object)((_key))));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
try {
		Debug.PushSubsStack("getMaxSize (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Initialize (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,9);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("IsEternal (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Keys (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,98);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Put (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,35);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.B4APagesNavBar.b4xcache.class, "_iseternal" /*RemoteObject*/ ,(Object)(_key)).<Boolean>get().booleanValue()) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((__ref.runClassMethod (b4a.B4APagesNavBar.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key)))));
 BA.debugLineNum = 38;BA.debugLine="TrimIfOversize";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.B4APagesNavBar.b4xcache.class, "_trimifoversize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("PutEternal (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,44);
...
Debug.JustUpdateDeviceLine();
_ci = __ref.runClassMethod (b4a.B4APagesNavBar.b4xcache.class, "_createb4xcacheitem" /*RemoteObject*/ ,(Object)(_value),(Object)(_key));Debug.locals.put("ci", _ci);Debug.locals.put("ci", _ci);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_put" /*RemoteObject*/ ,(Object)((_key)),(Object)((_ci)));
...
try {
		Debug.PushSubsStack("Remove (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,55);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_key)));
...
try {
		Debug.PushSubsStack("RemoveOldItems (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,82);
...
_values = __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getvalues" /*RemoteObject*/ );Debug.locals.put("values", _values);Debug.locals.put("values", _values);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((_ci.getField(true,"Key" /*RemoteObject*/ ))));
 };
 }
}Debug.locals.put("ci", _ci);
;
...
try {
		Debug.PushSubsStack("setMaxSize (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Size (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,93);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TrimIfOversize (b4xcache) ","b4xcache",10,__ref.getField(false, "ba"),__ref,70);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_getsize" /*RemoteObject*/ ),__ref.getField(true,"_eternalcounts" /*RemoteObject*/ )}, "-",1, 1),BA.numberCast(double.class, __ref.getField(true,"_mmaxsize" /*RemoteObject*/ )))) { 
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_data" /*RemoteObject*/ ).runClassMethod (b4a.B4APagesNavBar.b4xorderedmap.class, "_remove" /*RemoteObject*/ ,(Object)((((_values.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))).getField(true,"Key" /*RemoteObject*/ ))));
 }
}Debug.locals.put("i", _i);
;
 };
