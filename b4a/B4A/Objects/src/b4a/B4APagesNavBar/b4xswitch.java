...
RDebugUtils.currentLine=38141970;
 //BA.debugLineNum = 38141970;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=38273027;
 //BA.debugLineNum = 38273027;BA.debugLine="mBase.SetLayoutAnimated(0, mBase.Left, mBase.Top,";
...
RDebugUtils.currentLine=38273028;
 //BA.debugLineNum = 38273028;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,(int) (0),(int) (0),(int) (0));
RDebugUtils.currentLine=38273029;
 //BA.debugLineNum = 38273029;BA.debugLine="Dim pnl As B4XView = xui.CreatePanel(\"pnl\")";
...
RDebugUtils.currentLine=38273030;
 //BA.debugLineNum = 38273030;BA.debugLine="pnl.Color = xui.Color_Transparent";
...
RDebugUtils.currentLine=38273031;
 //BA.debugLineNum = 38273031;BA.debugLine="iv.Initialize(\"\")";
__ref._iv /*anywheresoftware.b4a.objects.ImageViewWrapper*/ .Initialize(ba,"");
RDebugUtils.currentLine=38273032;
 //BA.debugLineNum = 38273032;BA.debugLine="mBase.AddView(iv, 0, 0, Width, Height)";
...
RDebugUtils.currentLine=38273033;
 //BA.debugLineNum = 38273033;BA.debugLine="mBase.AddView(pnl, 0, 0, Width, Height)";
...
RDebugUtils.currentLine=38273035;
 //BA.debugLineNum = 38273035;BA.debugLine="bc.Initialize(Width, Height)";
__ref._bc /*b4a.example.bitmapcreator*/ ._initialize(ba,__ref._width /*int*/ ,__ref._height /*int*/ );
RDebugUtils.currentLine=38273036;
 //BA.debugLineNum = 38273036;BA.debugLine="Scale = xui.Scale";
__ref._scale /*float*/  = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getScale();
RDebugUtils.currentLine=38273041;
 //BA.debugLineNum = 38273041;BA.debugLine="OnColor = bc.CreateBrushFromColor(xui.PaintOrColo";
...
RDebugUtils.currentLine=38273042;
 //BA.debugLineNum = 38273042;BA.debugLine="OffColor = bc.CreateBrushFromColor(xui.PaintOrCol";
...
RDebugUtils.currentLine=38273043;
 //BA.debugLineNum = 38273043;BA.debugLine="ThumbColor = bc.CreateBrushFromColor(xui.PaintOrC";
...
RDebugUtils.currentLine=38273044;
 //BA.debugLineNum = 38273044;BA.debugLine="mHaptic = Props.GetDefault(\"HapticFeedback\", Fals";
__ref._mhaptic /*boolean*/  = BA.ObjectToBoolean(_props.GetDefault((Object)("HapticFeedback"),(Object)(__c.False)));
RDebugUtils.currentLine=38273045;
 //BA.debugLineNum = 38273045;BA.debugLine="transparent = bc.CreateBrushFromColor(xui.Color_T";
__ref._transparent /*b4a.example.bcpath._bcbrush*/  = __ref._bc /*b4a.example.bitmapcreator*/ ._createbrushfromcolor(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent);
RDebugUtils.currentLine=38273046;
 //BA.debugLineNum = 38273046;BA.debugLine="mEnabled = mBase.Enabled";
__ref._menabled /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getEnabled();
RDebugUtils.currentLine=38273047;
 //BA.debugLineNum = 38273047;BA.debugLine="mBase.Enabled = True";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setEnabled(__c.True);
RDebugUtils.currentLine=38273048;
 //BA.debugLineNum = 38273048;BA.debugLine="SetValueImpl(Props.Get(\"Value\"), True)";
...
RDebugUtils.currentLine=38404116;
 //BA.debugLineNum = 38404116;BA.debugLine="If mEnabled Then";
...
RDebugUtils.currentLine=38404117;
 //BA.debugLineNum = 38404117;BA.debugLine="XUIViewsUtils.SetAlpha(mBase, 1)";
...
RDebugUtils.currentLine=38404119;
 //BA.debugLineNum = 38404119;BA.debugLine="XUIViewsUtils.SetAlpha(mBase, 0.6)";
...
RDebugUtils.currentLine=38404121;
 //BA.debugLineNum = 38404121;BA.debugLine="End Sub";
if (true) break;
...
RDebugUtils.currentLine=38731777;
 //BA.debugLineNum = 38731777;BA.debugLine="bc.DrawRect2(bc.TargetRect, transparent, True, 0)";
__ref._bc /*b4a.example.bitmapcreator*/ ._drawrect2(__ref._bc /*b4a.example.bitmapcreator*/ ._targetrect,__ref._transparent /*b4a.example.bcpath._bcbrush*/ ,__c.True,(int) (0));
RDebugUtils.currentLine=38731778;
 //BA.debugLineNum = 38731778;BA.debugLine="Dim r As Float = Round(bc.mHeight / 2)";
_r = (float) (__c.Round(__ref._bc /*b4a.example.bitmapcreator*/ ._mheight/(double)2));
RDebugUtils.currentLine=38731779;
 //BA.debugLineNum = 38731779;BA.debugLine="Dim cx As Float = r - 1 * Scale + (bc.mWidth - 2";
...
RDebugUtils.currentLine=38731790;
 //BA.debugLineNum = 38731790;BA.debugLine="smallrect.Initialize(bc.mWidth / 2 - w / 2, cy -";
...
RDebugUtils.currentLine=38731791;
 //BA.debugLineNum = 38731791;BA.debugLine="If State > 0 Then bc.DrawRectRounded2(smallrect,";
if (_state>0) { 
...
RDebugUtils.currentLine=38731792;
 //BA.debugLineNum = 38731792;BA.debugLine="If mEnabled Then";
if (__ref._menabled /*boolean*/ ) { 
RDebugUtils.currentLine=38731793;
 //BA.debugLineNum = 38731793;BA.debugLine="bc.DrawCircle2(cx, cy, r - 2 * Scale, ThumbColor";
...
RDebugUtils.currentLine=38731795;
 //BA.debugLineNum = 38731795;BA.debugLine="bc.SetBitmapToImageView(bc.Bitmap, iv)";
...
RDebugUtils.currentLine=38731796;
 //BA.debugLineNum = 38731796;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=38338560;
 //BA.debugLineNum = 38338560;BA.debugLine="Private Sub pnl_Click";
RDebugUtils.currentLine=38338562;
 //BA.debugLineNum = 38338562;BA.debugLine="If mEnabled Then";
if (__ref._menabled /*boolean*/ ) { 
RDebugUtils.currentLine=38338563;
 //BA.debugLineNum = 38338563;BA.debugLine="If mHaptic Then XUIViewsUtils.PerformHapticFeedb";
if (__ref._mhaptic /*boolean*/ ) { 
_xuiviewsutils._performhapticfeedback /*String*/ (ba,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );};
RDebugUtils.currentLine=38338564;
 //BA.debugLineNum = 38338564;BA.debugLine="SetValueImpl(Not(mValue), False)";
__ref._setvalueimpl /*void*/ (null,__c.Not(__ref._mvalue /*boolean*/ ),__c.False);
RDebugUtils.currentLine=38338565;
 //BA.debugLineNum = 38338565;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Value";
if (__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .SubExists(ba,__ref._mcallback /*Object*/ ,__ref._meventname /*String*/ +"_ValueChanged",(int) (1))) { 
RDebugUtils.currentLine=38338566;
 //BA.debugLineNum = 38338566;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Value";
