...
RDebugUtils.currentLine=14745600;
 //BA.debugLineNum = 14745600;BA.debugLine="Public Sub setText(t As String)";
RDebugUtils.currentLine=14745601;
 //BA.debugLineNum = 14745601;BA.debugLine="mText = t";
__ref._mtext /*String*/  = _t;
RDebugUtils.currentLine=14745602;
 //BA.debugLineNum = 14745602;BA.debugLine="ParseAndDraw";
...
RDebugUtils.currentLine=14548992;
 //BA.debugLineNum = 14548992;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
RDebugUtils.currentLine=14548993;
 //BA.debugLineNum = 14548993;BA.debugLine="If DisableResizeEvent Then Return";
if (__ref._disableresizeevent /*boolean*/ ) { 
if (true) return "";};
RDebugUtils.currentLine=14548994;
 //BA.debugLineNum = 14548994;BA.debugLine="If Runs.IsInitialized Then";
if (__ref._runs /*anywheresoftware.b4a.objects.collections.List*/ .IsInitialized()) { 
RDebugUtils.currentLine=14548995;
 //BA.debugLineNum = 14548995;BA.debugLine="If ParseData.NeedToReparseWhenResize Then";
...
RDebugUtils.currentLine=14548996;
 //BA.debugLineNum = 14548996;BA.debugLine="ParseAndDraw";
__ref._parseanddraw /*String*/ (null);
 }else {
RDebugUtils.currentLine=14548998;
 //BA.debugLineNum = 14548998;BA.debugLine="Redraw";
...
RDebugUtils.currentLine=14876672;
 //BA.debugLineNum = 14876672;BA.debugLine="Public Sub ParseAndDraw";
RDebugUtils.currentLine=14876673;
 //BA.debugLineNum = 14876673;BA.debugLine="For i = mBase.NumberOfViews - 1 To 1 Step -1";
{
final int step1 = -1;
...
RDebugUtils.currentLine=14876674;
 //BA.debugLineNum = 14876674;BA.debugLine="mBase.GetView(i).RemoveViewFromParent";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .GetView(_i).RemoveViewFromParent();
 }
};
RDebugUtils.currentLine=14876676;
 //BA.debugLineNum = 14876676;BA.debugLine="ParseData.NeedToReparseWhenResize = False";
...
RDebugUtils.currentLine=14876677;
 //BA.debugLineNum = 14876677;BA.debugLine="ParseData.Text = mText";
...
RDebugUtils.currentLine=14876678;
 //BA.debugLineNum = 14876678;BA.debugLine="ParseData.Width = (mBase.Width - Padding.Left - P";
...
RDebugUtils.currentLine=14876679;
 //BA.debugLineNum = 14876679;BA.debugLine="If RTL Then mTextEngine.RTLAware = True";
...
RDebugUtils.currentLine=14876680;
 //BA.debugLineNum = 14876680;BA.debugLine="Dim pe As List = mTextEngine.TagParser.Parse(Pars";
...
RDebugUtils.currentLine=14876681;
 //BA.debugLineNum = 14876681;BA.debugLine="Runs = mTextEngine.TagParser.CreateRuns(pe, Parse";
...
RDebugUtils.currentLine=14876682;
 //BA.debugLineNum = 14876682;BA.debugLine="Redraw";
__ref._redraw /*String*/ (null);
...
RDebugUtils.currentLine=14942208;
 //BA.debugLineNum = 14942208;BA.debugLine="Public Sub Redraw";
RDebugUtils.currentLine=14942209;
 //BA.debugLineNum = 14942209;BA.debugLine="Dim Style As BCParagraphStyle = mTextEngine.Creat";
...
RDebugUtils.currentLine=14942210;
 //BA.debugLineNum = 14942210;BA.debugLine="Style.Padding = Padding";
...
RDebugUtils.currentLine=14942211;
 //BA.debugLineNum = 14942211;BA.debugLine="Style.MaxWidth = mBase.Width";
...
RDebugUtils.currentLine=14942212;
 //BA.debugLineNum = 14942212;BA.debugLine="Style.HorizontalAlignment = \"left\"";
...
RDebugUtils.currentLine=14942213;
 //BA.debugLineNum = 14942213;BA.debugLine="Style.WordWrap = WordWrap";
...
RDebugUtils.currentLine=14942214;
 //BA.debugLineNum = 14942214;BA.debugLine="Style.RTL = RTL";
...
RDebugUtils.currentLine=14942215;
 //BA.debugLineNum = 14942215;BA.debugLine="Paragraph = mTextEngine.DrawText(Runs, Style, For";
...
RDebugUtils.currentLine=14942216;
 //BA.debugLineNum = 14942216;BA.debugLine="Dim dx As Int = mBase.Width / 2 - ForegroundImage";
...
RDebugUtils.currentLine=14942217;
 //BA.debugLineNum = 14942217;BA.debugLine="Dim dy As Int = mBase.Height / 2 - ForegroundImag";
...
RDebugUtils.currentLine=14942218;
 //BA.debugLineNum = 14942218;BA.debugLine="For Each v As B4XView In mBase.GetAllViewsRecursi";
...
RDebugUtils.currentLine=14942219;
 //BA.debugLineNum = 14942219;BA.debugLine="v.Left = v.Left + dx";
_v.setLeft((int) (_v.getLeft()+_dx));
RDebugUtils.currentLine=14942220;
 //BA.debugLineNum = 14942220;BA.debugLine="v.Top = v.Top + dy";
_v.setTop((int) (_v.getTop()+_dy));
 }
};
RDebugUtils.currentLine=14942222;
 //BA.debugLineNum = 14942222;BA.debugLine="ForegroundImageView.Visible = Paragraph.Height >";
...
RDebugUtils.currentLine=14352385;
 //BA.debugLineNum = 14352385;BA.debugLine="Private mEventName As String 'ignore";
_meventname = "";
RDebugUtils.currentLine=14352386;
 //BA.debugLineNum = 14352386;BA.debugLine="Private mCallBack As Object 'ignore";
_mcallback = new Object();
RDebugUtils.currentLine=14352387;
 //BA.debugLineNum = 14352387;BA.debugLine="Public mBase As B4XView 'ignore";
_mbase = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=14352388;
 //BA.debugLineNum = 14352388;BA.debugLine="Private xui As XUI 'ignore";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
RDebugUtils.currentLine=14352389;
 //BA.debugLineNum = 14352389;BA.debugLine="Private Runs As List";
_runs = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=14352390;
 //BA.debugLineNum = 14352390;BA.debugLine="Public Style As BCParagraphStyle";
_style = new b4a.B4APagesNavBar.bctextengine._bcparagraphstyle();
RDebugUtils.currentLine=14352391;
 //BA.debugLineNum = 14352391;BA.debugLine="Private mTextEngine As BCTextEngine";
_mtextengine = new b4a.B4APagesNavBar.bctextengine();
RDebugUtils.currentLine=14352392;
 //BA.debugLineNum = 14352392;BA.debugLine="Private mText As String";
_mtext = "";
RDebugUtils.currentLine=14352393;
 //BA.debugLineNum = 14352393;BA.debugLine="Public ForegroundImageView As B4XView";
_foregroundimageview = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=14352394;
 //BA.debugLineNum = 14352394;BA.debugLine="Public Paragraph As BCParagraph";
_paragraph = new b4a.B4APagesNavBar.bctextengine._bcparagraph();
RDebugUtils.currentLine=14352395;
 //BA.debugLineNum = 14352395;BA.debugLine="Public Padding As B4XRect";
_padding = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
RDebugUtils.currentLine=14352396;
 //BA.debugLineNum = 14352396;BA.debugLine="Public ParseData As BBCodeParseData";
_parsedata = new b4a.B4APagesNavBar.bbcodeparser._bbcodeparsedata();
RDebugUtils.currentLine=14352397;
 //BA.debugLineNum = 14352397;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=14352398;
 //BA.debugLineNum = 14352398;BA.debugLine="Public DisableResizeEvent As Boolean";
_disableresizeevent = false;
RDebugUtils.currentLine=14352399;
 //BA.debugLineNum = 14352399;BA.debugLine="Public WordWrap As Boolean = True";
_wordwrap = __c.True;
RDebugUtils.currentLine=14352400;
 //BA.debugLineNum = 14352400;BA.debugLine="Public RTL As Boolean";
_rtl = false;
...
RDebugUtils.currentLine=14483456;
 //BA.debugLineNum = 14483456;BA.debugLine="Public Sub DesignerCreateView (Base As Object, Lbl";
RDebugUtils.currentLine=14483457;
 //BA.debugLineNum = 14483457;BA.debugLine="mBase = Base";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
RDebugUtils.currentLine=14483458;
 //BA.debugLineNum = 14483458;BA.debugLine="Tag = mBase.Tag";
__ref._tag /*Object*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTag();
RDebugUtils.currentLine=14483459;
 //BA.debugLineNum = 14483459;BA.debugLine="mBase.Tag = Me";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setTag(this);
RDebugUtils.currentLine=14483460;
 //BA.debugLineNum = 14483460;BA.debugLine="mBase.AddView(ForegroundImageView, 0, 0, mBase.Wi";
...
RDebugUtils.currentLine=14483461;
 //BA.debugLineNum = 14483461;BA.debugLine="Dim xlbl As B4XView = Lbl";
_xlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
RDebugUtils.currentLine=14483462;
 //BA.debugLineNum = 14483462;BA.debugLine="ParseData.DefaultColor = xlbl.TextColor";
...
RDebugUtils.currentLine=14483463;
 //BA.debugLineNum = 14483463;BA.debugLine="ParseData.DefaultFont = xlbl.Font";
...
RDebugUtils.currentLine=14483464;
 //BA.debugLineNum = 14483464;BA.debugLine="ParseData.ViewsPanel = mBase";
...
RDebugUtils.currentLine=14483465;
 //BA.debugLineNum = 14483465;BA.debugLine="mText = xlbl.Text";
__ref._mtext /*String*/  = _xlbl.getText();
RDebugUtils.currentLine=14483470;
 //BA.debugLineNum = 14483470;BA.debugLine="ParseData.DefaultBoldFont = xui.CreateFont(Typefa";
...
RDebugUtils.currentLine=14483474;
 //BA.debugLineNum = 14483474;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=14811136;
 //BA.debugLineNum = 14811136;BA.debugLine="Public Sub getText As String";
RDebugUtils.currentLine=14811137;
 //BA.debugLineNum = 14811137;BA.debugLine="Return mText";
...
RDebugUtils.currentLine=14680064;
 //BA.debugLineNum = 14680064;BA.debugLine="Public Sub getTextEngine As BCTextEngine";
RDebugUtils.currentLine=14680065;
 //BA.debugLineNum = 14680065;BA.debugLine="Return mTextEngine";
...
RDebugUtils.currentLine=14417920;
 //BA.debugLineNum = 14417920;BA.debugLine="Public Sub Initialize (Callback As Object, EventNa";
RDebugUtils.currentLine=14417921;
 //BA.debugLineNum = 14417921;BA.debugLine="mEventName = EventName";
__ref._meventname /*String*/  = _eventname;
RDebugUtils.currentLine=14417922;
 //BA.debugLineNum = 14417922;BA.debugLine="mCallBack = Callback";
__ref._mcallback /*Object*/  = _callback;
RDebugUtils.currentLine=14417923;
 //BA.debugLineNum = 14417923;BA.debugLine="Dim iv As ImageView";
_iv = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=14417924;
 //BA.debugLineNum = 14417924;BA.debugLine="iv.Initialize(\"\")";
_iv.Initialize(ba,"");
RDebugUtils.currentLine=14417925;
 //BA.debugLineNum = 14417925;BA.debugLine="ForegroundImageView = iv";
...
RDebugUtils.currentLine=14417926;
 //BA.debugLineNum = 14417926;BA.debugLine="ParseData.Initialize";
__ref._parsedata /*b4a.B4APagesNavBar.bbcodeparser._bbcodeparsedata*/ .Initialize();
RDebugUtils.currentLine=14417927;
 //BA.debugLineNum = 14417927;BA.debugLine="Padding.Initialize(2dip, 2dip, 2dip, 2dip)";
...
RDebugUtils.currentLine=14614528;
 //BA.debugLineNum = 14614528;BA.debugLine="Public Sub setTextEngine (b As BCTextEngine)";
RDebugUtils.currentLine=14614529;
 //BA.debugLineNum = 14614529;BA.debugLine="mTextEngine = b";
__ref._mtextengine /*b4a.B4APagesNavBar.bctextengine*/  = _b;
RDebugUtils.currentLine=14614533;
 //BA.debugLineNum = 14614533;BA.debugLine="If mText <> \"\" Then";
if ((__ref._mtext /*String*/ ).equals("") == false) { 
RDebugUtils.currentLine=14614534;
 //BA.debugLineNum = 14614534;BA.debugLine="setText(mText)";
