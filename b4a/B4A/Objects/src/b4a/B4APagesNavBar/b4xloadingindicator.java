...
RDebugUtils.currentLine=32833538;
 //BA.debugLineNum = 32833538;BA.debugLine="MainLoop";
...
RDebugUtils.currentLine=32899073;
 //BA.debugLineNum = 32899073;BA.debugLine="index = index + 1";
__ref._index /*int*/  = (int) (__ref._index /*int*/ +1);
RDebugUtils.currentLine=32899074;
 //BA.debugLineNum = 32899074;BA.debugLine="Dim MyIndex As Int = index";
_myindex = __ref._index /*int*/ ;
RDebugUtils.currentLine=32899075;
 //BA.debugLineNum = 32899075;BA.debugLine="Dim n As Long = DateTime.Now";
_n = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=32899076;
 //BA.debugLineNum = 32899076;BA.debugLine="Do While MyIndex = index";
if (true) break;
...
RDebugUtils.currentLine=32636933;
 //BA.debugLineNum = 32636933;BA.debugLine="Private clr As Int";
_clr = 0;
RDebugUtils.currentLine=32636934;
 //BA.debugLineNum = 32636934;BA.debugLine="Private index As Int";
_index = 0;
RDebugUtils.currentLine=32636935;
 //BA.debugLineNum = 32636935;BA.debugLine="Private cvs As B4XCanvas";
_cvs = new anywheresoftware.b4a.objects.B4XCanvas();
RDebugUtils.currentLine=32636936;
 //BA.debugLineNum = 32636936;BA.debugLine="Private duration As Int";
_duration = 0;
RDebugUtils.currentLine=32636937;
 //BA.debugLineNum = 32636937;BA.debugLine="Private DrawingSubName As String";
_drawingsubname = "";
RDebugUtils.currentLine=32636938;
 //BA.debugLineNum = 32636938;BA.debugLine="Public Tag As Object";
_tag = new Object();
...
RDebugUtils.currentLine=32768003;
 //BA.debugLineNum = 32768003;BA.debugLine="clr = xui.PaintOrColorToColor(Props.Get(\"Color\"";
...
RDebugUtils.currentLine=32768004;
 //BA.debugLineNum = 32768004;BA.debugLine="Dim style As String= Props.Get(\"IndicatorStyle\")";
_style = BA.ObjectToString(_props.Get((Object)("IndicatorStyle")));
RDebugUtils.currentLine=32768005;
 //BA.debugLineNum = 32768005;BA.debugLine="Dim duration As Int = Props.Get(\"Duration\")";
_duration = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
RDebugUtils.currentLine=32768006;
 //BA.debugLineNum = 32768006;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
__ref._drawingsubname /*String*/  = "Draw_"+_style.replace(" ","");
RDebugUtils.currentLine=32768007;
 //BA.debugLineNum = 32768007;BA.debugLine="cvs.Initialize(mBase)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .Initialize(__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
RDebugUtils.currentLine=32768008;
 //BA.debugLineNum = 32768008;BA.debugLine="MainLoop";
__ref._mainloop /*void*/ (null);
...
RDebugUtils.currentLine=33423360;
 //BA.debugLineNum = 33423360;BA.debugLine="Private Sub Draw_Arc1 (Progress As Float)";
RDebugUtils.currentLine=33423361;
 //BA.debugLineNum = 33423361;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
RDebugUtils.currentLine=33423362;
 //BA.debugLineNum = 33423362;BA.debugLine="Dim r As Float = cvs.TargetRect.CenterX - 5dip";
...
RDebugUtils.currentLine=33423363;
 //BA.debugLineNum = 33423363;BA.debugLine="If Progress < 0.5 Then";
if (_progress<0.5) { 
RDebugUtils.currentLine=33423364;
 //BA.debugLineNum = 33423364;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
...
RDebugUtils.currentLine=33423366;
 //BA.debugLineNum = 33423366;BA.debugLine="p.InitializeArc(cvs.TargetRect.CenterX, cvs.Targ";
...
RDebugUtils.currentLine=33423368;
 //BA.debugLineNum = 33423368;BA.debugLine="cvs.ClipPath(p)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClipPath(_p);
RDebugUtils.currentLine=33423369;
 //BA.debugLineNum = 33423369;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
...
RDebugUtils.currentLine=33423370;
 //BA.debugLineNum = 33423370;BA.debugLine="cvs.RemoveClip";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .RemoveClip();
RDebugUtils.currentLine=33423371;
 //BA.debugLineNum = 33423371;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=33488896;
 //BA.debugLineNum = 33488896;BA.debugLine="Private Sub Draw_Arc2 (Progress As Float)";
...
RDebugUtils.currentLine=33357824;
 //BA.debugLineNum = 33357824;BA.debugLine="Private Sub Draw_FiveLines1(Progress As Float)";
RDebugUtils.currentLine=33357825;
 //BA.debugLineNum = 33357825;BA.debugLine="Dim MinR As Int = 10dip";
_minr = __c.DipToCurrent((int) (10));
RDebugUtils.currentLine=33357826;
 //BA.debugLineNum = 33357826;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Height / 2";
...
RDebugUtils.currentLine=33357827;
 //BA.debugLineNum = 33357827;BA.debugLine="Dim dx As Int = (cvs.TargetRect.Width - 2dip) / 5";
...
RDebugUtils.currentLine=33357828;
 //BA.debugLineNum = 33357828;BA.debugLine="For i = 0 To 4";
{
final int step4 = 1;
...
RDebugUtils.currentLine=33357829;
 //BA.debugLineNum = 33357829;BA.debugLine="Dim r As Float = MinR + MaxR / 2 + MaxR / 2 * Si";
_r = (float) (_minr+_maxr/(double)2+_maxr/(double)2*__c.SinD(_progress*360-30*_i));
RDebugUtils.currentLine=33357830;
 //BA.debugLineNum = 33357830;BA.debugLine="cvs.DrawLine(2dip + i * dx, cvs.TargetRect.Cente";
...
RDebugUtils.currentLine=33357832;
 //BA.debugLineNum = 33357832;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=33554432;
 //BA.debugLineNum = 33554432;BA.debugLine="Private Sub Draw_PacMan(Progress As Float)";
RDebugUtils.currentLine=33554433;
 //BA.debugLineNum = 33554433;BA.debugLine="Dim DotR As Int = 5dip";
_dotr = __c.DipToCurrent((int) (5));
RDebugUtils.currentLine=33554434;
 //BA.debugLineNum = 33554434;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.Width - DotR - Prog";
...
RDebugUtils.currentLine=33554435;
 //BA.debugLineNum = 33554435;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
RDebugUtils.currentLine=33554436;
 //BA.debugLineNum = 33554436;BA.debugLine="Dim angle As Int = 70 * SinD(Progress * 180)";
_angle = (int) (70*__c.SinD(_progress*180));
RDebugUtils.currentLine=33554437;
 //BA.debugLineNum = 33554437;BA.debugLine="Dim cx As Int = cvs.TargetRect.CenterX - 5dip";
...
RDebugUtils.currentLine=33554439;
 //BA.debugLineNum = 33554439;BA.debugLine="Dim r As Int = cvs.TargetRect.CenterY - 5dip";
...
RDebugUtils.currentLine=33554440;
 //BA.debugLineNum = 33554440;BA.debugLine="If angle = 0 Then";
if (_angle==0) { 
RDebugUtils.currentLine=33554441;
 //BA.debugLineNum = 33554441;BA.debugLine="cvs.DrawCircle(cx, cy, r, clr, True, 0)";
...
RDebugUtils.currentLine=33554443;
 //BA.debugLineNum = 33554443;BA.debugLine="p.InitializeArc(cx, cy , r, -angle / 2, -(360-an";
_p.InitializeArc((float) (_cx),(float) (_cy),(float) (_r),(float) (-_angle/(double)2),(float) (-(360-_angle)));
RDebugUtils.currentLine=33554444;
 //BA.debugLineNum = 33554444;BA.debugLine="cvs.ClipPath(p)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .ClipPath(_p);
RDebugUtils.currentLine=33554445;
 //BA.debugLineNum = 33554445;BA.debugLine="cvs.DrawRect(cvs.TargetRect, clr, True, 0)";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .DrawRect(__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .getTargetRect(),__ref._clr /*int*/ ,__c.True,(float) (0));
RDebugUtils.currentLine=33554446;
 //BA.debugLineNum = 33554446;BA.debugLine="cvs.RemoveClip";
__ref._cvs /*anywheresoftware.b4a.objects.B4XCanvas*/ .RemoveClip();
 };
...
RDebugUtils.currentLine=33292288;
 //BA.debugLineNum = 33292288;BA.debugLine="Private Sub SetAlpha (c As Int, alpha As Int) As I";
RDebugUtils.currentLine=33292289;
 //BA.debugLineNum = 33292289;BA.debugLine="Return Bit.And(0xffffff, c) + Bit.ShiftLeft(alpha";
...
RDebugUtils.currentLine=33226752;
 //BA.debugLineNum = 33226752;BA.debugLine="Private Sub Draw_SingleCircle(Progress As Float)";
RDebugUtils.currentLine=33226753;
 //BA.debugLineNum = 33226753;BA.debugLine="For i = 0 To 2";
{
final int step1 = 1;
...
RDebugUtils.currentLine=33226754;
 //BA.debugLineNum = 33226754;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.CenterX, cvs.Targe";
...
RDebugUtils.currentLine=33095680;
 //BA.debugLineNum = 33095680;BA.debugLine="Private Sub Draw_ThreeCircles1 (Progress As Float)";
RDebugUtils.currentLine=33095681;
 //BA.debugLineNum = 33095681;BA.debugLine="Dim MaxR As Float = (cvs.TargetRect.Width / 2 - 2";
...
RDebugUtils.currentLine=33095682;
 //BA.debugLineNum = 33095682;BA.debugLine="Dim r As Float = 10dip + MaxR + MaxR * Sin(Progre";
_r = (float) (__c.DipToCurrent((int) (10))+_maxr+_maxr*__c.Sin(_progress*2*__c.cPI));
RDebugUtils.currentLine=33095683;
 //BA.debugLineNum = 33095683;BA.debugLine="For i = 0 To 2";
{
final int step3 = 1;
...
RDebugUtils.currentLine=33095684;
 //BA.debugLineNum = 33095684;BA.debugLine="Dim alpha As Int = i * 120 + Progress * 360";
_alpha = (int) (_i*120+_progress*360);
RDebugUtils.currentLine=33095686;
 //BA.debugLineNum = 33095686;BA.debugLine="cvs.DrawCircle(cvs.TargetRect.CenterX + r * SinD";
...
RDebugUtils.currentLine=33161216;
 //BA.debugLineNum = 33161216;BA.debugLine="Private Sub Draw_ThreeCircles2 (Progress As Float)";
RDebugUtils.currentLine=33161217;
 //BA.debugLineNum = 33161217;BA.debugLine="Dim MinR As Int = 5dip";
_minr = __c.DipToCurrent((int) (5));
RDebugUtils.currentLine=33161218;
 //BA.debugLineNum = 33161218;BA.debugLine="Dim MaxR As Int = cvs.TargetRect.Width / 2 / 3 -";
...
RDebugUtils.currentLine=33161220;
 //BA.debugLineNum = 33161220;BA.debugLine="Dim r As Float = MinR + MaxR / 2 + MaxR / 2 * Si";
_r = (float) (_minr+_maxr/(double)2+_maxr/(double)2*__c.SinD(_progress*360-60*_i));
RDebugUtils.currentLine=33161221;
 //BA.debugLineNum = 33161221;BA.debugLine="cvs.DrawCircle(MaxR + MinR + (MinR + MaxR + 2dip";
...
RDebugUtils.currentLine=33030144;
 //BA.debugLineNum = 33030144;BA.debugLine="Public Sub Hide";
RDebugUtils.currentLine=33030145;
 //BA.debugLineNum = 33030145;BA.debugLine="mBase.Visible = False";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setVisible(__c.False);
RDebugUtils.currentLine=33030146;
 //BA.debugLineNum = 33030146;BA.debugLine="index = index + 1";
__ref._index /*int*/  = (int) (__ref._index /*int*/ +1);
...
RDebugUtils.currentLine=32964608;
 //BA.debugLineNum = 32964608;BA.debugLine="Public Sub Show";
RDebugUtils.currentLine=32964609;
 //BA.debugLineNum = 32964609;BA.debugLine="mBase.Visible = True";
